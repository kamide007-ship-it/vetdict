...
ENRICHMENTS["dog_cholangitis_cholangiohepatitis"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["dog_small_intestinal_bacterial_overgrowth_sibo"] = {
    "diagnosis_ja": (
        ...
        "慢性下痢・体重減少・ガス貯留の臨床症状。抗生剤（メトロニダゾール/タイロシン）反応性で支持的診断。"
    )
}

ENRICHMENTS["dog_antibiotic-responsive_diarrhea"] = {
    "diagnosis_ja": (
        "抗生剤（タイロシン25 mg/kg BID or メトロニダゾール15 mg/kg BID）への反応性で診断。"
...
ENRICHMENTS["dog_pulmonary_thromboembolism_pte"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["dog_uterine_stump_pyometra"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["dog_resource_guarding"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["dog_territorial_aggression"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["dog_canine_respiratory_coronavirus"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["dog_splenic_torsion"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["dog_diaphragmatic_hernia"] = {
    "diagnosis_ja": (
