...
_TRANSMISSION_TEMPLATES: dict[str, tuple[str, str]] = {
    ...
    "metabolic": (
        ...
        "age-related changes.",
        "伝播性はない。代謝・内分泌疾患は内因性の生理的機能障害、"
        "遺伝的素因、食事因子、加齢変化により発生する。"
    ),
    "nutritional": (
    ...
    "toxic": (
        ...
        "poisonous organisms.",
        "動物間で伝播しない。中毒は環境毒素への曝露、有毒物質の摂取、"
        "有毒生物との接触により発生する。"
    ),
    "traumatic": (
        "Not transmissible. Traumatic conditions result from physical injury, "
    ...
    "autoimmune": (
        ...
        "伝播性はない。免疫介在性疾患は遺伝的素因と免疫系の調節障害を"
        "引き起こす環境トリガーにより発生する。"
    ),
    "cardiovascular": (
    ...
    "reproductive": (
        ...
        "are not transmissible.",
        "一部の生殖器感染症は交配、直接接触、母子垂直感染で伝播しうる。"
        "非感染性の生殖器疾患は伝播性がない。"
    ),
    "neurological": (
    ...
    "dermatological": (
        ...
        "are not transmissible.",
        "一部の皮膚疾患（真菌性、寄生虫性）は直接接触や汚染環境を介して"
        "伝播する。非感染性の皮膚疾患は伝播性がない。"
    ),
    "ophthalmic": (
...
_CLINICAL_SIGNS_TEMPLATES: dict[str, tuple[str, str]] = {
    ...
    "cardiovascular": (
        ...
        "運動不耐性、咳嗽、呼吸困難、失神、腹水、チアノーゼ、"
        "脈拍微弱、聴診での心雑音・不整脈、頸静脈怒張。"
    ),
    "respiratory": (
    ...
    "neurological": (
        ...
        "痙攣、運動失調、斜頸、旋回、麻痺・不全麻痺、振戦、"
        "意識状態の変化、異常反射、眼振、行動変化。"
    ),
    "dermatological": (
    ...
    "congenital": (
        ...
        "出生時または幼少期からの徴候：発育不良、解剖学的異常、"
        "発達遅延、臓器機能障害、CNS関与時の痙攣。"
    ),
    "behavioral": (
        ...
        "異常反復行動、自傷、羽毛・毛引き、攻撃性、過度の発声、"
        "常同歩行、活動量低下、食欲変化、回避行動。"
    ),
    "hematological": (
