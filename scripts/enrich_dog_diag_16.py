...
ENRICHMENTS["dog_ethylene_glycol_toxicosis"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_metaldehyde_toxicosis"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_esophageal_foreign_body"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_gastric_ulceration"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_intestinal_lymphangiectasia"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_prostatic_abscess"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_benign_prostatic_hyperplasia"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_nictitans_gland_prolapse_cherry_eye"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_canine_brucellosis"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_canine_leptospirosis"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_canine_herpesvirus"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_salmon_poisoning_disease"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_leishmaniosis"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_primary_ciliary_dyskinesia"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_compulsive_disorder"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_portosystemic_shunt_pss"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_uroabdomen"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_bile_peritonitis"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_salivary_mucocele"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_immune-mediated_polyarthritis"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_extraocular_myositis"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_immune-mediated_thrombocytopenia_itp"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_immune-mediated_hemolytic_anemia_imha"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_canine_chronic_hepatitis"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_copper_storage_hepatopathy"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_perianal_fistula"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_idiopathic_epilepsy"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_ventricular_premature_complexes"] = {"diagnosis_ja": (
