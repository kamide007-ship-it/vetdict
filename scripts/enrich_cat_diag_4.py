...
ENRICHMENTS["cat_dermatophytosis_ringworm"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["cat_eosinophilic_granuloma_complex_-_eosinophilic_ulcer"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["cat_eosinophilic_granuloma_complex_-_eosinophilic_plaque"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["cat_eosinophilic_granuloma_complex_-_linear_granuloma"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["cat_psychogenic_alopecia"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["cat_solar_dermatitis___squamous_cell_carcinoma_in_situ"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["cat_fip_neurological_form"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["cat_thiamine_deficiency_vitamin_b1"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["cat_polyneuropathy"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["cat_spinal_cord_lymphoma"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["cat_intervertebral_disc_disease_ivdd"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["cat_cerebral_ischemic_encephalopathy_stroke"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["cat_osteoarthritis_degenerative_joint_disease"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["cat_luxating_patella"] = {
    "diagnosis_ja": (
