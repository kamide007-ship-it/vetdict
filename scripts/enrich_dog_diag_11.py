...
ENRICHMENTS["dog_iliopsoas_muscle_strain"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_gracilis_semitendinosus_myopathy"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_sesamoid_disease"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_necrotizing_meningoencephalitis_nme"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_necrotizing_leukoencephalitis_nle"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_spinal_arachnoid_diverticulum"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_steroid-responsive_meningitis-arteritis_srma"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_canine_spinal_muscular_atrophy"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_lissencephaly"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_peripheral_nerve_sheath_tumor"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_spongiform_leukoencephalomyelopathy"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_tricuspid_valve_dysplasia"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_subaortic_stenosis_sas"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_cardiac_tamponade"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_cor_pulmonale"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_ventricular_tachycardia"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_third-degree_atrioventricular_block"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_hyperaldosteronism_conn's_syndrome"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_acromegaly_growth_hormone_excess"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_hypoparathyroidism"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_diabetic_ketoacidosis_dka"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_hyperadrenocorticism_-_iatrogenic"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_canine_atopic_dermatitis"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_zinc-responsive_dermatosis_-_syndrome_i"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_dermatomyositis"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_canine_pattern_baldness"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_cutaneous_vasculitis"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_nasal_hyperkeratosis"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_calcinosis_cutis"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_vitiligo"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_iris_atrophy"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_anterior_lens_luxation"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_eyelid_mass_meibomian_gland_adenoma"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_optic_neuritis"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_hyphema"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_canine_chronic_ulcerative_stomatitis_ccus"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_mandibular_fracture"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_oral_papillomatosis"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_enamel_hypoplasia"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_dentigerous_cyst"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_thyroid_adenoma_benign"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_hepatic_lymphoma"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_anal_gland_carcinoma"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_chondrosarcoma"] = {"diagnosis_ja": (
...
ENRICHMENTS["dog_pulmonary_adenocarcinoma"] = {"diagnosis_ja": (
