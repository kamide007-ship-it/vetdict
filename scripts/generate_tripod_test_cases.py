...
TEST_SCENARIOS = {
    "dog": [
        ...
        {
            "symptoms": ["abdominal_distension", "vomiting", "lethargy"],
            "expected_disease": "Bloat",
        ...
        {
            "symptoms": ["cough", "nasal_discharge"],
            "expected_disease": "Kennel Cough",
        ...
        {
            "symptoms": ["itching", "skin_lesions"],
            "expected_disease": "Mange",
            "confidence_threshold": 0.65,
            "notes": "Parasitic skin disease",
        },
        # Metabolic
        {
        ...
        # Cardiac
        {
            "symptoms": ["lethargy", "cough", "exercise_intolerance"],
            "expected_disease": "Heart Failure",
            "confidence_threshold": 0.68,
            "notes": "Cardiac dysfunction",
        },
        # Neurological
        {
            "symptoms": ["seizures"],
        ...
        {
            "symptoms": ["head_tilt", "nystagmus"],
            "expected_disease": "Vestibular Disease",
            "confidence_threshold": 0.65,
            "notes": "Neurological disorder",
        },
        # Urinary
        {
            "symptoms": ["dysuria", "urinary_straining"],
    ...
    "cat": [
        ...
        {
            "symptoms": ["cough", "respiratory_distress"],
        ...
        # Endocrine
        {
            ...
            "confidence_threshold": 0.70,
            "notes": "Thyroid dysfunction",
        },
        {
            "symptoms": ["lethargy", "weight_gain"],
        ...
        {
            "symptoms": ["polydipsia", "polyuria", "weight_loss"],
            "expected_disease": "Chronic Kidney Disease",
            "confidence_threshold": 0.70,
            "notes": "CKD",
        },
    ],
    "rabbit": [
        ...
        {
            "symptoms": ["head_tilt", "circling"],
            "expected_disease": "Encephalitozoon cuniculi",
            "confidence_threshold": 0.62,
            "notes": "Parasitic neurological",
        },
        {
            "symptoms": ["drooling", "anorexia"],
            "expected_disease": "Dental Disease",
            "confidence_threshold": 0.65,
            "notes": "Malocclusion",
        },
        {
            "symptoms": ["lethargy", "fever"],
            "expected_disease": "Bacterial Infection",
            "confidence_threshold": 0.60,
            "notes": "Systemic infection",
        },
    ],
    "guinea_pig": [
        {
            "symptoms": ["lethargy", "bleeding_gums"],
            "expected_disease": "Scurvy",
            "confidence_threshold": 0.68,
            "notes": "Vitamin C deficiency",
        },
        {
            "symptoms": ["respiratory_distress", "lethargy"],
            "expected_disease": "Respiratory Infection",
            "confidence_threshold": 0.65,
            "notes": "Bacterial pneumonia",
        },
    ],
    "hamster": [
        {
            "symptoms": ["facial_swelling", "drooling"],
            "expected_disease": "Cheek Pouch Impaction",
            "confidence_threshold": 0.65,
            "notes": "Hamster-specific",
        },
        {
            "symptoms": ["diarrhea", "lethargy"],
            "expected_disease": "Wet Tail",
            "confidence_threshold": 0.62,
            "notes": "Diarrheal disease",
        },
    ],
    "ferret": [
        {
            "symptoms": ["lethargy", "ataxia"],
            "expected_disease": "Insulinoma",
            "confidence_threshold": 0.65,
            "notes": "Hypoglycemia",
        },
        {
            "symptoms": ["lethargy", "hair_loss"],
            "expected_disease": "Adrenal Disease",
            "confidence_threshold": 0.62,
            "notes": "Endocrine disorder",
        },
    ],
    "bird": [
        {
            ...
            "expected_disease": "Respiratory Infection",
            "confidence_threshold": 0.65,
            "notes": "Avian respiratory",
        },
        {
            "symptoms": ["regurgitation", "lethargy"],
            "expected_disease": "Crop Stasis",
            "confidence_threshold": 0.62,
            "notes": "GI disorder",
        },
    ],
    "fish": [
        {
            "symptoms": ["white_spots", "lethargy"],
            "expected_disease": "Ichthyophthirius",
            "confidence_threshold": 0.68,
            "notes": "White spot disease",
        },
        {
        ...
        {
            "symptoms": ["abdominal_distension", "lethargy"],
            "expected_disease": "Dropsy",
            "confidence_threshold": 0.62,
            "notes": "Systemic infection",
        },
    ],
    "reptile": [
        {
            ...
            "expected_disease": "Respiratory Infection",
            "confidence_threshold": 0.60,
            "notes": "Respiratory disease",
        },
        {
            "symptoms": ["lameness", "jaw_swelling"],
            "expected_disease": "Metabolic Bone Disease",
            "confidence_threshold": 0.65,
            "notes": "Nutritional disorder",
        },
    ],
    "parakeet": [
        {
    ...
    "parrot": [
        {
            "symptoms": ["feather_plucking", "lethargy"],
            "expected_disease": "Behavioral Disorder",
            "confidence_threshold": 0.60,
            "notes": "Psychological stress",
        },
    ],
}
