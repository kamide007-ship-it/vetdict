...
ENRICHMENTS["cat_renal_lymphoma"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["cat_hyperaldosteronism_conn's_syndrome"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["cat_feline_infectious_peritonitis_fip_-_dry_form"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["cat_feline_calicivirus_infection"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["cat_feline_panleukopenia_feline_distemper"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["cat_bartonellosis_cat_scratch_disease_agent"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["cat_feline_coronavirus_enteritis"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["cat_cryptococcosis"] = {
    "diagnosis_ja": (
