...
ENRICHMENTS["dog_sinonasal_aspergillosis"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["dog_pancreatic_adenocarcinoma"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["dog_megacolon_acquired"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["dog_apocrine_gland_adenocarcinoma"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["dog_bone_cyst_aneurysmal"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["dog_myxomatous_mitral_valve_degeneration_early_stage"] = {
    "diagnosis_ja": (
...
ENRICHMENTS["dog_canine_brucellosis_reproductive"] = {
    "diagnosis_ja": (
