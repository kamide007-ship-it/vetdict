...
class ClinicalDetailsGenerator:
    ...
    TEMPLATES = {
        'infectious_viral': {
            'keywords': [
                'virus', 'viral', 'infection', 'influenza', 'distemper', 'feline', 'felv', 'fiv',
            ],
            'clinical_signs': [
        ...
        'infectious_bacterial': {
            'keywords': [
                'bacteria', 'bacterial', 'infection', 'streptococcus', 'staphylococcus', 'leptospirosis',
            ],
            'clinical_signs': [
        ...
        'parasitic': {
            'keywords': [
                'parasite', 'parasitic', 'worm', 'helminth', 'mite', 'lice', 'tick', 'flea', 'coccidia',
            ],
            'clinical_signs': [
