...
class UrgencyScoringEngine:
    ...
    def _build_cost_keywords(self) -> Dict[str, Dict]:
        ...
        return {
            'high_cost': {
                'keywords': ['surgery', 'chemotherapy', 'radiation', 'hospitalization',
                           'intensive', 'cancer', 'neoplastic', 'cardiac', 'multiple medications'],
                'cost_level': 'high',
                'monitoring': 'weekly',
            },
            'moderate_cost': {
                'keywords': ['infection', 'antibiotic', 'treatment', 'therapy',
                           'management', 'medication', 'dietary'],
                'cost_level': 'moderate',
                'monitoring': 'bi-weekly',
            },
            'low_cost': {
                'keywords': ['prevention', 'supportive', 'monitoring', 'observation',
                           'dietary management', 'preventive'],
                'cost_level': 'low',
                'monitoring': 'monthly',
            },
        }
    ...
    def _estimate_treatment_cost(self, treatment: str, disease_name: str) -> str:
        ...
        high_cost_keywords = [
            'surgery', 'chemotherapy', 'radiation', 'intensive care',
            'hospitalization', 'multiple', 'prolonged', 'specialized',
            'oncology', 'cardiologist', 'neurologist'
        ]

        moderate_cost_keywords = [
            'antibiotic', 'antifungal', 'medication', 'therapy',
            'medication', 'treatment', 'management', 'dietary',
            'monitoring', '2-4 weeks', '3-8 weeks'
        ]
