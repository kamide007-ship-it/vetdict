...
class DescriptionEnricher:
        ...
        return {
            'infectious_viral': {
                'keywords': ['virus', 'viral', 'infection', 'influenza', 'distemper', 'parvovirus',
                            'coronavirus', 'feline', 'felv', 'fiv', 'herpes', 'calicivirus', 'herpesvirus',
                            'rotavirus', 'reovirus', 'paramyxovirus', 'togavirus', 'encephalitis'],
            ...
            'infectious_bacterial': {
                'keywords': ['bacteria', 'bacterial', 'infection', 'streptococcus', 'staphylococcus',
                            'leptospirosis', 'brucellosis', 'pyoderma', 'otitis', 'enteritis', 'coli',
                            'bordetella', 'chlamydia', 'mycobacter', 'corynebacter'],
            ...
            'parasitic': {
                'keywords': ['parasite', 'parasitic', 'worm', 'helminth', 'mite', 'lice', 'tick',
                            'flea', 'coccidia', 'giardia', 'toxoplasma', 'heartworm', 'hookworm',
                            'tapeworm', 'roundworm', 'nematode'],
            ...
            'inflammatory': {
                'keywords': ['inflammation', 'inflammatory', 'dermatitis', 'colitis', 'gastritis',
                            'pancreatitis', 'enteritis', 'hepatitis', 'nephritis', 'myositis',
                            'arthritis', 'stomatitis', 'gingivitis', 'esophagitis'],
            ...
            'neoplastic': {
                'keywords': ['cancer', 'carcinoma', 'lymphoma', 'sarcoma', 'tumor', 'malignant',
                            'metastasis', 'neoplastic', 'leukemia', 'myeloma'],
            ...
            'metabolic': {
                'keywords': ['diabetes', 'obesity', 'thyroid', 'metabolism', 'hyperthyroid',
                            ...
                            'hyperparathyroid', 'hypoparathyroid', 'adrenal'],
            ...
            'cardiovascular': {
                'keywords': ['heart', 'cardiac', 'hypertension', 'arrhythmia', 'myocarditis',
                            'valve', 'cardiomyopathy', 'edema', 'chf', 'thrombosis', 'pericarditis',
            ...
            'neurological': {
                'keywords': ['seizure', 'epilepsy', 'neurological', 'encephalitis', 'myelitis',
                            'stroke', 'paralysis', 'tremor', 'ataxia', 'neuropathy', 'meningitis',
                            'vestibular', 'brain', 'spinal'],
            ...
            'respiratory': {
                'keywords': ['asthma', 'bronchitis', 'pneumonia', 'respiratory', 'pulmonary',
                            'cough', 'dyspnea', 'laryngitis', 'tracheitis', 'rhinitis', 'sinusitis',
            ...
            'gastrointestinal': {
                'keywords': ['diarrhea', 'vomiting', 'gastroenteritis', 'bowel', 'intestinal',
                            'esophageal', 'gastric', 'ulcer', 'obstruction', 'colitis', 'enteritis',
                            'ileitis', 'cecitis', 'ileo-cecocolic'],
            ...
            'urogenital': {
                'keywords': ['urinary', 'kidney', 'renal', 'cystitis', 'pyelonephritis', 'uti',
                            'bladder', 'prostate', 'reproductive', 'urolithiasis', 'nephritis',
            ...
            'dermatological': {
                'keywords': ['skin', 'dermat', 'alopecia', 'pruritus', 'mange', 'ringworm',
                            'seborrhea', 'otitis', 'erythema', 'eczema', 'pustule', 'folliculitis',
                            'pyoderma', 'lichenoid', 'acanthosis'],
            ...
            'traumatic': {
                'keywords': ['trauma', 'traumatic', 'injury', 'fracture', 'laceration', 'wound',
                            'contusion', 'sprain', 'strain', 'heat stroke', 'burn'],
            ...
            'genetic': {
                'keywords': ['genetic', 'hereditary', 'inherited', 'congenital', 'dysplasia',
                            'polycystic', 'lysosomial', 'storage', 'degeneration'],
    ...
    def _extract_condition_type(self, disease_name: str, pathophysiology: str = '') -> str:
        ...
        if any(word in name_lower or word in pathophysiology_lower
               for word in ['infection', 'infectious']):
            return 'infection'
        elif any(word in name_lower or word in pathophysiology_lower
                 for word in ['inflammation', 'inflammatory', 'itis']):
            ...
            return 'dermatological condition'
                 ...
                 for word in ['arthritis', 'osteoarthritis', 'bone']):
    ...
    def _assess_severity(self, disease_name: str) -> str:
        ...
        if any(word in name_lower for word in ['severe', 'advanced', 'acute', 'hemorrhagic',
                                                 'septic', 'acute respiratory', 'fulminant']):
            return 'severe'
        elif any(word in name_lower for word in ['chronic', 'progressive', 'resistant',
                                                   'complicated', 'idiopathic']):
            return 'chronic'
        else:
            return 'common'
    ...
    def generate_description(self, disease: Dict) -> str:
        ...
        if clinical_signs:
            ...
            if 'respiratory' in signs_preview.lower():
                ...
                clinical_importance = 'Owner observation of behavioral and dietary changes is essential for early diagnosis.'
            else:
...
def main():
    ...
    for disease in updated_diseases:
        ...
        if any(pattern in original for pattern in [
            'involves dysfunction of metabolic processes',
