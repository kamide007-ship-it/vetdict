...
SPECIES_INFO_PATCH: dict[str, dict[str, dict]] = {
    ...
    "praziquantel": {
        ...
        "snake": {"safe": True, "dosage": "5-8 mg/kg PO/IM/SC; repeat in 14 days", "dosage_ja": "5-8 mg/kg 経口/筋注/皮下; 14日後に再投与", "notes": "For cestodes and trematodes", "notes_ja": "条虫・吸虫に使用"},
        "tortoise": {"safe": True, "dosage": "5-8 mg/kg PO/IM; repeat in 14 days", "dosage_ja": "5-8 mg/kg 経口/筋注; 14日後に再投与", "notes": "For cestodes and trematodes", "notes_ja": "条虫・吸虫に使用"},
    },
    "fipronil": {
    ...
    "tramadol": {
        ...
        "snake": {"safe": True, "dosage": "5-10 mg/kg PO q48-72h", "dosage_ja": "5-10 mg/kg 経口 48-72時間毎", "notes": "Analgesic; effectiveness debated in reptiles", "notes_ja": "鎮痛薬。爬虫類での有効性は議論中"},
        "tortoise": {"safe": True, "dosage": "5-10 mg/kg PO q48-72h", "dosage_ja": "5-10 mg/kg 経口 48-72時間毎", "notes": "Analgesic; slow metabolism in chelonians", "notes_ja": "鎮痛薬。カメ類では代謝が遅い"},
    },
    "gabapentin": {
    ...
    "buprenorphine": {
        ...
        "snake": {"safe": True, "dosage": "0.02-0.1 mg/kg IM q24-48h", "dosage_ja": "0.02-0.1 mg/kg 筋注 24-48時間毎", "notes": "Mu-opioid receptor agonist; more effective in some species", "notes_ja": "μオピオイド受容体作動薬。一部の種でより有効"},
        "tortoise": {"safe": True, "dosage": "0.02-0.1 mg/kg IM/SC q24-48h", "dosage_ja": "0.02-0.1 mg/kg 筋注/皮下 24-48時間毎", "notes": "Mu-opioid; variable efficacy in chelonians", "notes_ja": "μオピオイド。カメ類では有効性にばらつきがある"},
    },
    "butorphanol": {
        ...
        "snake": {"safe": True, "dosage": "0.4-2 mg/kg IM q24-48h", "dosage_ja": "0.4-2 mg/kg 筋注 24-48時間毎", "notes": "Kappa-opioid receptor preference in reptiles", "notes_ja": "爬虫類ではκオピオイド受容体選好性"},
        "tortoise": {"safe": True, "dosage": "0.4-2 mg/kg IM q24-48h", "dosage_ja": "0.4-2 mg/kg 筋注 24-48時間毎", "notes": "Kappa-opioid preference in reptiles", "notes_ja": "爬虫類ではκオピオイド選好性"},
    },
    "ketamine": {
        ...
        "snake": {"safe": True, "dosage": "20-80 mg/kg IM", "dosage_ja": "20-80 mg/kg 筋注", "notes": "Dissociative; muscle relaxation poor—combine with benzodiazepine", "notes_ja": "解離性麻酔。筋弛緩が不十分—ベンゾジアゼピンと併用"},
        "tortoise": {"safe": True, "dosage": "20-60 mg/kg IM", "dosage_ja": "20-60 mg/kg 筋注", "notes": "Combine with midazolam for better relaxation", "notes_ja": "ミダゾラムと併用でより良い筋弛緩"},
    },
    "propofol": {
    ...
    "midazolam": {
        ...
        "snake": {"safe": True, "dosage": "1-2 mg/kg IM", "dosage_ja": "1-2 mg/kg 筋注", "notes": "Sedation/premedication; good muscle relaxation", "notes_ja": "鎮静/前投薬。良好な筋弛緩"},
        "tortoise": {"safe": True, "dosage": "1-2 mg/kg IM", "dosage_ja": "1-2 mg/kg 筋注", "notes": "Premedication; facilitates intubation", "notes_ja": "前投薬。気管挿管を容易にする"},
    },
    "diazepam": {
    ...
    "vitamin_b12": {
        ...
        "snake": {"safe": True, "dosage": "0.05 mg/kg SC/IM q7d", "dosage_ja": "0.05 mg/kg 皮下/筋注 週1回", "notes": "Supportive care for anorexia", "notes_ja": "食欲不振の支持療法"},
        "tortoise": {"safe": True, "dosage": "0.05 mg/kg SC/IM q7d", "dosage_ja": "0.05 mg/kg 皮下/筋注 週1回", "notes": "Supportive care for anorexia", "notes_ja": "食欲不振の支持療法"},
    },
    "sucralfate": {
    ...
    "isoflurane": {
        ...
        "snake": {"safe": True, "dosage": "Induction 3-5%, maintenance 1-3%", "dosage_ja": "導入 3-5%, 維持 1-3%", "notes": "Intubate for maintenance; prolonged recovery normal in reptiles", "notes_ja": "維持は気管挿管で。爬虫類では回復に時間がかかるのが正常"},
        "tortoise": {"safe": True, "dosage": "Induction 3-5%, maintenance 1-3%", "dosage_ja": "導入 3-5%, 維持 1-3%", "notes": "Intubation essential for chelonians; breath-holding prolongs induction", "notes_ja": "カメ類には気管挿管が必須。息止めにより導入が延長する"},
    },
    "sevoflurane": {
        ...
        "snake": {"safe": True, "dosage": "Induction 5-8%, maintenance 3-5%", "dosage_ja": "導入 5-8%, 維持 3-5%", "notes": "Faster recovery than isoflurane", "notes_ja": "イソフルランより回復が速い"},
        "tortoise": {"safe": True, "dosage": "Induction 5-8%, maintenance 3-5%", "dosage_ja": "導入 5-8%, 維持 3-5%", "notes": "Slightly faster induction than isoflurane", "notes_ja": "イソフルランよりやや導入が速い"},
    },
    "moxidectin": {
    ...
    "atropine": {
        ...
        "snake": {"safe": True, "dosage": "0.01-0.04 mg/kg IM/SC", "dosage_ja": "0.01-0.04 mg/kg 筋注/皮下", "notes": "Preanesthetic; reduce secretions", "notes_ja": "麻酔前投薬。分泌物の減少"},
        "tortoise": {"safe": True, "dosage": "0.01-0.04 mg/kg IM/SC", "dosage_ja": "0.01-0.04 mg/kg 筋注/皮下", "notes": "Reduce oral/respiratory secretions before anesthesia", "notes_ja": "麻酔前の口腔/気道分泌物の減少"},
    },
    "glycopyrrolate": {
    ...
    "metronidazole": {
        ...
        "snake": {"safe": True, "dosage": "20-40 mg/kg PO once; repeat in 14 days", "dosage_ja": "20-40 mg/kg 経口 単回; 14日後に再投与", "notes": "For Entamoeba, flagellates; narrow margin of safety—CNS toxicity risk", "notes_ja": "赤痢アメーバ・鞭毛虫に使用。安全域が狭い—CNS毒性リスク"},
        "tortoise": {"safe": True, "dosage": "20-25 mg/kg PO once; repeat in 14 days", "dosage_ja": "20-25 mg/kg 経口 単回; 14日後に再投与", "notes": "For protozoal infections; narrow safety margin", "notes_ja": "原虫感染に使用。安全域が狭い"},
    },
    "azithromycin": {
    ...
    "fenbendazole": {
        ...
        "snake": {"safe": True, "dosage": "50-100 mg/kg PO once; repeat in 14 days", "dosage_ja": "50-100 mg/kg 経口 単回; 14日後に再投与", "notes": "For nematodes; higher doses needed in reptiles", "notes_ja": "線虫に使用。爬虫類では高用量が必要"},
        "tortoise": {"safe": True, "dosage": "50-100 mg/kg PO once; repeat in 14 days", "dosage_ja": "50-100 mg/kg 経口 単回; 14日後に再投与", "notes": "For nematodes (Oxyuris); effective and safe in chelonians", "notes_ja": "線虫（蟯虫）に使用。カメ類に有効で安全"},
    },
    "amoxicillin": {
        ...
        "snake": {"safe": True, "dosage": "10-22 mg/kg IM q24-72h", "dosage_ja": "10-22 mg/kg 筋注 24-72時間毎", "notes": "Injectable use; avoid oral in snakes due to poor absorption", "notes_ja": "注射で使用。経口は吸収不良のため避ける"},
    },
    "doxycycline": {
        ...
        "snake": {"safe": True, "dosage": "10 mg/kg PO q24-48h", "dosage_ja": "10 mg/kg 経口 24-48時間毎", "notes": "For respiratory infections; good oral bioavailability", "notes_ja": "呼吸器感染症に使用。経口バイオアベイラビリティ良好"},
        "tortoise": {"safe": True, "dosage": "10 mg/kg PO q24-48h", "dosage_ja": "10 mg/kg 経口 24-48時間毎", "notes": "For respiratory infections (Mycoplasma)", "notes_ja": "呼吸器感染症（マイコプラズマ）に使用"},
    },
    "clindamycin": {
    ...
    "ivermectin": {
        ...
        "snake": {"safe": True, "dosage": "0.2 mg/kg PO/SC/IM once; repeat in 14 days", "dosage_ja": "0.2 mg/kg 経口/皮下/筋注 単回; 14日後に再投与", "notes": "For nematodes and mites; avoid in chelonians", "notes_ja": "線虫・ダニに使用。カメ類には避ける"},
    },
    "enrofloxacin": {
        "snake": {"safe": True, "dosage": "5-10 mg/kg PO/IM q24-48h", "dosage_ja": "5-10 mg/kg 経口/筋注 24-48時間毎", "notes": "First-line antibiotic; adjust interval by temperature", "notes_ja": "第一選択抗菌薬。環境温度により投与間隔を調整"},
        "tortoise": {"safe": True, "dosage": "5-10 mg/kg PO/IM q24-48h", "dosage_ja": "5-10 mg/kg 経口/筋注 24-48時間毎", "notes": "First-line antibiotic; adjust for temperature", "notes_ja": "第一選択抗菌薬。環境温度に応じて調整"},
    },
    "voriconazole": {
    ...
    "meloxicam": {
        ...
        "tortoise": {"safe": True, "dosage": "0.2-0.5 mg/kg PO/IM q24-48h", "dosage_ja": "0.2-0.5 mg/kg 経口/筋注 24-48時間毎", "notes": "NSAID; best studied NSAID in chelonians", "notes_ja": "NSAID。カメ類で最も研究されたNSAID"},
    },
    "amikacin": {
