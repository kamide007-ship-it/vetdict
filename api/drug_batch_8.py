...
DRUGS_BATCH_8: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "side_effects": ["Excessive uterine contraction", "Uterine rupture (overdose)", "Abdominal pain", "Systemic hypotension (IV use)"],
    ...
    },
    {
        ...
        "side_effects": ["Hemorrhage (rare, if aPTT excessive)", "Thrombocytopenia (rare)", "Heparin-induced thrombosis (very rare)"],
    ...
    },
    {
        ...
        "side_effects": ["Selenium toxicity (garlic odor breath, hair loss, hooves brittle) if overdosed", "Vitamin E: rare GI upset at high doses"],
        "side_effects_ja": ["セレニウム毒性（過剰投与時：ニンニク臭の呼気、脱毛、蹄ろう質化）", "ビタミンE：高用量時の稀なGI障害"],
    ...
    },
    {
        ...
        "side_effects": ["Initial flare-up (increased estrous signs for 24-48h)", "Injection site reaction (mild)", "Temporary behavior changes"],
