        ...
        possible_conditions.append(
            {
                ...
                "pathophysiology": getattr(dis, "pathophysiology_en", "") or dis.pathophysiology or "",
                "causes": getattr(dis, "etiology_en", "") or dis.etiology or "",
                "treatment": dis.treatment_protocol or dis.general_management or "",
                "prevention": getattr(dis, "prevention_en", "") or dis.prevention or "",
                "prognosis": getattr(dis, "prognosis_en", "") or dis.prognosis or "",
                "clinical_signs": getattr(dis, "clinical_signs_detail_en", "") or dis.clinical_signs_detail or "",
                ...
                "pathophysiology_ja": dis.pathophysiology or "",
                "causes_ja": dis.etiology or "",
                "treatment_ja": dis.treatment_protocol or dis.general_management or "",
                "prevention_ja": dis.prevention or "",
                "prognosis_ja": dis.prognosis or "",
                "clinical_signs_ja": dis.clinical_signs_detail or "",
                "diagnosis": _diag_en,
