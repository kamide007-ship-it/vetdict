...
DISEASES: List[Dict[str, Any]] = [
    # ── Endocrine / Metabolic ──────────────────────────────────────────────
    {
        ...
        "pathophysiology_ja": "デグー糖尿病病態生理—他の種の典型的なタイプ2と異なる：(1) 遺伝学的インスリン抵抗相（出生時から存在、無症候）—膵ベータ細胞は先天的に葡萄糖刺激への反応性低下。基礎空腹時インスリン値は他のげっ歯類の2-3倍に上昇（抵抗補償）。グルコース耐性は重症傷害：経口グルコース負荷で易感受性デグーで血糖250 mg/dL以上で30分ピーク対他のげっ歯類でほぼ180 mg/dL未満。(2) 食事炭水化物曝露相（糖摂取で日から週）—各糖曝露がβ細胞ストレス誘発；高血糖エピソード発生、繰り返しエピソードでβ細胞疲出。(3) 明白な糖尿病への進行（持続糖曝露で週から月）—空腹時血糖は140 mg/dL以上で持続上昇。(4) 慢性高血糖相（確立糖尿病、未治療で月から年）—持続血糖150-400+ mg/dL。(5) 食事が補正された場合の代償相。",
        ...
        "prevention_ja": "デグーの重大予防（積極的食事管理で遺伝学的易感受性動物の50-70%で糖尿病を防止可能）：(1) デグー特異的食事—離乳から厳密な炭水化物制限食を実装。(2) 体重管理。(3) ストレス低減。(4) 遺伝学的スクリーニング。(5) 日常的健康スクリーニング。(6) 砂糖摂取を毒性として扱う。(7) 水質。(8) 生殖管理。(9) 並発疾患予防。(10) 診断後予防。",
    ...
    },
    {
        ...
        "urgency": "high",
        "recommended_tests": ["abdominal_ultrasound", "vaginal_cytology", "blood_chemistry", "culture_sensitivity", "complete_blood_count"],
