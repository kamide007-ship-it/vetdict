...
DISEASES: List[Dict[str, Any]] = [
    # ── Endocrine / Metabolic ──────────────────────────────────────────────
    {
        ...
        "description_ja": "デグーの糖尿病は非常に高い有病率（デグーの30-50%が生涯中に臨床糖尿病発展）の深刻な代謝疾患。重大：デグーは食事糖に対する乏しい耐性—ほとんどげっ歯類と異なり、デグーは限定的な果糖吸収能と糖摂取応答における最小限のグルコース恒常性調節能。わずかな量の果物または高炭水化物食でも持続的高血糖を誘発。ほとんどの症例でtype 2糖尿病（インスリン抵抗、続発性ベータ細胞不全）として提示、遺伝的素因と食事炭水化物曝露による。早期検出を通じた検査と厳格食事管理は感受性が高い動物の発症を防止または遅延可能。",
        "urgency": "high",
        ...
        "prevention_ja": "デグーの重大予防（積極的食事管理で遺伝的に感受性が高い動物の50-70%で糖尿病を防止可能）：(1) デグー特異的食事—離乳から厳密な炭水化物制限食を実装。(2) 体重管理。(3) ストレス低減。(4) 遺伝学的スクリーニング。(5) 日常的健康スクリーニング。(6) 砂糖摂取を毒性として扱う。(7) 水質。(8) 生殖管理。(9) 併発疾患予防。(10) 診断後予防。",
    ...
    # ── Additional conditions ──────────────────────────────────────────────
    {
        ...
        "causes": "Multifactorial etiology including infectious, environmental, immune, and host-related factors. Specific risk factors and triggers vary by individual case.",
        "causes_ja": "デグーにおける耳感染症（外耳炎・中耳炎）の原因: 細菌感染が主体。歯科疾患（歯根尖膿瘍）の鼓室胞への波及、耳道の外傷・異物・過剰耳垢、不衛生・多湿な環境、免疫低下が誘因となる。",
        "pathophysiology": "The pathological process involves tissue injury, inflammatory response, and progressive functional impairment. Without intervention, compensatory mechanisms may be overwhelmed, leading to clinical deterioration.",
        "pathophysiology_ja": "耳感染症（外耳炎・中耳炎）はデグーにおける細菌感染症である。病原菌は付着因子を通じて組織にコロニーを形成し、毒素産生、酵素分泌、免疫回避戦略などの病原性メカニズムを介して侵入する。好中球浸潤、サイトカイン放出、補体活性化を含む炎症カスケードが生じる。歯根尖病変や鼓室胞への波及があると内耳・前庭に及び、斜頸や平衡障害を呈する。組織損傷は細菌の直接作用と宿主の炎症反応の両方に起因し、慢性例では膿瘍形成や肉芽腫性炎症を伴う。",
        "treatment": "Antimicrobial therapy based on culture and sensitivity, wound care or drainage as needed, pain management, and monitoring for resolution.",
        "treatment_ja": "デグーにおける耳感染症（外耳炎・中耳炎）の治療には、可能であれば培養感受性試験に基づく標的抗菌薬療法が必要である。結果待ちの間は経験的広域抗菌薬を開始する。抗菌薬治療期間は感染の排除と耐性予防に十分な期間とする。基礎疾患（歯科疾患・歯根尖病変）を検索・治療する。膿瘍や壊死組織には外科的排膿またはデブリードマンが必要な場合がある。支持療法として輸液、鎮痛薬、抗炎症薬、栄養サポートを行う。",
        "prevention": "Prevention includes maintaining proper hygiene, appropriate husbandry, stress reduction, quarantine of new animals, and prompt treatment of wounds or primary conditions.",
    ...
    },
    {
        ...
        "pathophysiology_ja": "子宮内膜炎はデグーにおける生殖器疾患で、細菌が子宮内膜にコロニー化して急性炎症カスケード発動。エンドトキシン（LPS）→好中球浸潤→サイトカイン放出（TNF-α、IL-6、IL-8）→子宮内膜浮腫/充血。筋層収縮が排液を試みるがエンドトキシム血症で障害。デグーでは産後子宮内膜が特に脆弱（早成性新仔負荷：大型胎児で広範な胎盤着床部位）。無治療で>48-96時間、子宮内膜炎が閉鎖型子宮蓄膿症に進行→爆発的敗血症。デグーは産科ショックへの高い感受性を示す（難産でも治療時20-30%死亡率）—子宮内膜炎リスクがこの脆弱性を反映。",
    ...
    },
    {
        ...
        "description_ja": "デグーの妊娠毒血症は妊娠後期（85日以上）または産後初期の代謝緊急事態で、負のエネルギーバランスが原因。デグーは糖尿病易発性があり（飼育下デグーの20-30%が糖尿病易発）、妊娠毒血症が不顕性糖尿病を顕性化させたり感受性が高い個体で顕性高血糖を誘発しうる。",
        "urgency": "emergency",
    ...
    {
        "name": "Elodontoma (Dental Tumor)",
        "name_ja": "エロドントーマ（歯牙腫瘍）",
        "symptoms": {
            "labored_breathing",
            "nasal_discharge",
            "difficulty_eating",
        ...
        "description": "Elodontoma is a proliferative, tumor-like mass of disorganized odontogenic (tooth-forming) tissue at the apex of continuously growing (elodont) cheek teeth or incisors, well documented in degus and prairie dogs. Because the apices of the upper incisors and cheek teeth lie directly beneath the nasal passages, apical proliferation obstructs airflow and typically presents as progressive upper airway obstruction (stertor, open-mouth or labored breathing) with difficulty eating and weight loss. It is considered a reactive/hamartomatous proliferation secondary to chronic apical trauma or malocclusion rather than a true malignant neoplasm, but the space-occupying effect in an obligate nasal breather makes it clinically serious.",
        "description_ja": "エロドントーマは、常生歯（生涯伸び続ける歯）の歯根尖部に生じる無秩序な歯原性組織の増殖性腫瘤で、デグーとプレーリードッグでよく報告される。上顎切歯・臼歯の歯根尖は鼻腔直下にあるため、尖部の増殖が気道を閉塞し、進行性の上部気道閉塞（いびき様呼吸・開口呼吸・努力性呼吸）、摂食困難、体重減少として発現する。真の悪性腫瘍ではなく慢性的な歯根尖への外傷や不正咬合に続発する反応性・過誤腫性増殖と考えられるが、鼻呼吸に依存するげっ歯類では占拠性病変として臨床的に重大である。",
        "urgency": "high",
        "recommended_tests": [
            "skull_radiographs",
            "ct_scan",
        ...
        "clinical_signs": "Progressive stertorous or labored breathing (worse at rest, open-mouth breathing is a critical sign in obligate nasal breathers), nasal discharge, difficulty prehending or chewing food, selective eating, weight loss, drooling; incisor malocclusion or discoloration may coexist.",
        "clinical_signs_ja": "進行性のいびき様・努力性呼吸（安静時に悪化、鼻呼吸動物での開口呼吸は危険徴候）、鼻汁、食物の把持・咀嚼困難、えり好み、体重減少、流涎。切歯の不正咬合や変色を伴うことがある。",
        "diagnosis": "Skull radiographs (lateral, DV, oblique) show club-shaped apical enlargement of affected teeth with loss of normal apical architecture; CT is the gold standard for defining nasal cavity involvement and airway compromise. Differentiate from tooth root abscess (lysis, soft-tissue swelling) and neoplasia (rare true odontogenic tumors).",
        "diagnosis_ja": "頭部X線（側方・腹背・斜位）で罹患歯の歯根尖部の棍棒状肥大と正常尖部構造の消失を認める。鼻腔浸潤と気道圧迫の評価にはCTがゴールドスタンダード。歯根膿瘍（骨融解・軟部組織腫脹）や真の歯原性腫瘍（稀）との鑑別を要する。",
        "treatment": "No curative medical therapy; management is palliative and staged to the degree of airway obstruction. (1) Address underlying malocclusion: routine coronal reduction of cheek teeth under anesthesia to reduce apical loading. (2) Analgesia: meloxicam 0.5-1.0 mg/kg PO q24h; buprenorphine 0.03-0.05 mg/kg SC q8-12h for flare-ups. (3) Secondary bacterial rhinitis: culture-guided antibiotics (e.g., trimethoprim-sulfamethoxazole 30 mg/kg PO q12h or enrofloxacin 10 mg/kg PO q24h). (4) Nutritional support: syringe feeding with critical-care herbivore formula during crises. (5) Surgical options are limited: extraction of affected teeth is technically difficult due to the abnormal apex; rhinostomy (creation of a permanent nasal airway opening) has been described in prairie dogs with severe obstruction and can be considered in degus at referral level. (6) Euthanasia is appropriate when airway obstruction is severe and refractory. (References: Jekl in Quesenberry & Carpenter, Ferrets, Rabbits, and Rodents 4th ed; Boy & Steenkamp, odontoma management in prairie dogs; Legendre 2003)",
        "treatment_ja": "根治的内科療法はなく、気道閉塞の程度に応じた緩和的管理となる。(1)基礎の不正咬合への対処：麻酔下での臼歯歯冠整形を定期的に行い歯根尖への負荷を軽減。(2)鎮痛：メロキシカム 0.5-1.0 mg/kg PO q24h、増悪時ブプレノルフィン 0.03-0.05 mg/kg SC q8-12h。(3)二次性細菌性鼻炎：培養に基づく抗菌薬（例：ST合剤 30 mg/kg PO q12h、エンロフロキサシン 10 mg/kg PO q24h）。(4)栄養支持：増悪期は草食動物用クリティカルケアフードの強制給餌。(5)外科選択肢は限定的：罹患歯の抜歯は異常な歯根尖のため技術的に困難。重度閉塞例ではプレーリードッグで報告のある鼻孔形成術（恒久的鼻腔開口の造設）を専門施設で検討可。(6)重度・難治性の気道閉塞では安楽死も適応となる。（参考文献：Jekl in Quesenberry & Carpenter, Ferrets, Rabbits, and Rodents 4th ed；Boy & Steenkamp（プレーリードッグの歯牙腫管理）；Legendre 2003）",
        "prognosis": "Guarded. The proliferation is slowly progressive and irreversible; well-managed cases (coronal reduction, analgesia, nutritional support) can maintain acceptable quality of life for months to over a year, but progressive nasal obstruction ultimately limits survival in severe cases.",
        "prognosis_ja": "予後は要注意。増殖は緩徐進行性かつ不可逆で、適切な管理（歯冠整形・鎮痛・栄養支持）により数ヶ月〜1年以上のQOL維持が可能だが、重度例では進行性の鼻腔閉塞が最終的に生存を制限する。",
        "causes": "Chronic apical stress on continuously erupting (elodont) teeth: malocclusion, inadequate dietary abrasion (insufficient hay/gnawing), cage-bar chewing trauma, and possibly genetic predisposition. The apical germinal tissue responds to chronic trauma with disorganized proliferation of dentin, enamel and cementum.",
        "causes_ja": "常生歯の歯根尖への慢性ストレスが原因：不正咬合、食事性摩耗の不足（乾草・かじり材不足）、ケージ噛みによる外傷、遺伝的素因の可能性。歯根尖の胚組織が慢性外傷に反応し、象牙質・エナメル質・セメント質の無秩序な増殖を生じる。",
        "pathophysiology": "Repeated mechanical stress at the apex of elodont teeth stimulates the germinal center to produce disorganized odontogenic tissue (a pseudo-odontoma). In degus the maxillary incisor and cheek-tooth apices are separated from the ventral nasal meatus only by a thin bony plate; apical expansion therefore bulges into the nasal passages, narrowing the airway. As degus are obligate nasal breathers, progressive obstruction produces stertor, exercise intolerance and finally open-mouth breathing and hypoxia. Secondary rhinitis and difficulty eating compound the clinical decline.",
        "pathophysiology_ja": "常生歯の歯根尖への反復する機械的ストレスが胚中心を刺激し、無秩序な歯原性組織（偽性歯牙腫）を形成する。デグーでは上顎切歯・臼歯の歯根尖と腹側鼻道は薄い骨板で隔てられているのみで、尖部の膨隆が鼻腔内に突出して気道を狭窄する。デグーは鼻呼吸に依存するため、進行性閉塞によりいびき様呼吸・運動不耐性、最終的に開口呼吸と低酸素血症を生じる。二次性鼻炎と摂食困難が臨床的悪化を助長する。",
        "transmission": "Not transmissible; degenerative/reactive condition of individual animals.",
        "transmission_ja": "伝染性はない。個体の変性・反応性疾患である。",
        "prevention": "Provide unlimited grass hay and safe gnawing material from acquisition to ensure physiological dental wear; avoid wire-bar chewing (provide foraging enrichment); prompt correction of malocclusion at the first sign of selective eating or drooling; annual oral examination with skull radiographs in animals with prior dental disease. Early surveillance targets: stertor, selective eating, weight loss.",
        "prevention_ja": "入手時から無制限の牧草と安全なかじり材を与え、生理的な歯の摩耗を確保する。金網噛みを避ける（採食エンリッチメントを提供）。えり好みや流涎がみられたら早期に不正咬合を矯正する。歯科疾患の既往がある個体では年1回の口腔検査と頭部X線検査を行う。早期発見の監視対象：いびき様呼吸・えり好み・体重減少。",
        "onset_pattern": {"chronic"},
        "age_predisposition": {"adult", "senior"},
    },
]
