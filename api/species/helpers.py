...
def _find_enrichment(species: str, disease_name: str) -> Dict[str, Any] | None:
    ...
    if _ENRICHMENT_NORMALIZED is not None:
        ...
        species_entries = [(k[1], v) for k, v in _ENRICHMENT_NORMALIZED.items() if k[0] == species]
...
def _generate_fallback_content(disease: Dict[str, Any], species: str) -> Dict[str, str]:
    ...
    if not disease.get("prognosis_ja"):
        content["prognosis_ja"] = (
            f"{name_ja}の予後は重症度、診断の迅速さ、治療への反応に依存する。早期発見と適切な介入が転帰を改善する。"
        )
    return content
    ...
    for disease in diseases:
        ...
        if enrichment:
            for field in _ENRICHMENT_FIELDS:
                ...
                if (not current and replacement) or (
                    _is_template_text(current) and replacement and not _is_template_text(replacement)
                ):
...
SPECIES_BREEDS: Dict[str, List[Dict[str, Any]]] = {
    "cat": [
        ...
        },
        {
            ...
            "name_ja": "ペルシャ",
            "risk": {
                "Polycystic Kidney Disease (PKD)": 2.5,
                "Feline Hypertrophic Cardiomyopathy (HCM)": 1.5,
                "Feline Chronic Kidney Disease (CKD)": 1.8,
                "Brachycephalic Airway Syndrome": 2.0,
                "Saddle Nose Deformity (Brachycephalic Airway Syndrome)": 2.0,
        ...
        },
        {
            ...
            "risk": {
                "Scottish Fold Osteochondrodysplasia": 3.0,
                "Feline Hypertrophic Cardiomyopathy (HCM)": 1.8,
                "Polycystic Kidney Disease (PKD)": 1.5,
                "Osteoarthritis (Degenerative Joint Disease)": 2.0,
            },
            "ecology": {
        ...
        },
        {
            ...
            "name": "Munchkin",
            "name_ja": "マンチカン",
            "risk": {"Osteoarthritis": 2.0, "Intervertebral Disc Disease": 1.8, "Lordosis": 1.5},
            "ecology": {
                "temperature": {"min": 18, "max": 28, "unit": "°C"},
                "humidity": {"min": 30, "max": 65, "unit": "%"},
        ...
        },
        {
            ...
            "name_ja": "メインクーン",
            "risk": {
                "Feline Hypertrophic Cardiomyopathy (HCM)": 2.5,
                "Hip Dysplasia": 1.8,
                "Spinal Muscular Atrophy": 1.5,
                "Polycystic Kidney Disease (PKD)": 1.3,
            },
            "ecology": {
                "temperature": {"min": 10, "max": 28, "unit": "°C"},
                "humidity": {"min": 30, "max": 70, "unit": "%"},
        ...
        },
        {
            ...
            "risk": {
                ...
                "Feline Lower Urinary Tract Disease (FLUTD)": 1.5,
                "Bladder Stones": 1.3,
                "Urolithiasis (Bladder Stones)": 1.3,
            },
            "ecology": {
                "temperature": {"min": 18, "max": 28, "unit": "°C"},
                "humidity": {"min": 30, "max": 65, "unit": "%"},
        ...
        },
        {
            ...
            "risk": {
                "Feline Hypertrophic Cardiomyopathy (HCM)": 1.5,
                "Progressive Retinal Atrophy (PRA)": 2.0,
        ...
        },
        {
            ...
            "risk": {
                ...
                "Amyloidosis": 1.8,
                "Megaesophagus": 1.5,
                "Progressive Retinal Atrophy (PRA)": 1.5,
            },
            "ecology": {
    ...
    "rabbit": [
        ...
        },
        {
            ...
            "name_ja": "ホーランドロップ",
            "risk": {
                "Otitis Media / Interna": 2.0,
                "Malocclusion": 1.8,
                "Gastrointestinal Stasis": 1.3,
                "Head Tilt (Vestibular Disease)": 1.8,
                "Dental Malocclusion": 1.8,
            },
            "ecology": {
                "temperature": {"min": 15, "max": 24, "unit": "°C"},
                "humidity": {"min": 40, "max": 60, "unit": "%"},
        ...
        {
            "id": "rabbit_flemish_giant",
            "name": "Flemish Giant",
            "name_ja": "フレミッシュジャイアント",
            "risk": {
                "Pododermatitis (Sore Hocks)": 2.0,
                "Spondylosis": 1.8,
                "Heart Disease": 1.5,
        ...
        {
            "id": "rabbit_lop_eared",
            "name": "Lop Eared (General)",
            "name_ja": "ロップイヤー（一般）",
            "risk": {
                "Otitis Media / Interna": 2.5,
                "Ear Mites": 1.5,
                "Dental Disease": 1.3,
                "Dental Malocclusion": 1.3,
                "Head Tilt (Vestibular Disease)": 1.8,
            },
            "ecology": {
                "temperature": {"min": 15, "max": 24, "unit": "°C"},
        ...
        },
        {
            ...
            "name_ja": "アンゴラ",
            "risk": {
                "Wool Block/Trichobezoar": 2.5,
                "GI Stasis": 1.8,
                "Gastrointestinal Stasis": 1.8,
                "Flystrike (Myiasis)": 1.8,
                "Heat Stroke": 1.5,
            },
            "ecology": {
    ...
    "hamster": [
        {
            ...
            "name_ja": "ゴールデン（シリアン）",
            "risk": {
                "Wet Tail (Proliferative Ileitis)": 2.0,
                "Hamster Pyometra": 1.8,
                "Amyloidosis": 1.5,
                "Cardiomyopathy": 1.5,
                "Lymphoma": 1.5,
        ...
        {
            "id": "hamster_djungarian",
            "name": "Djungarian (Winter White)",
            "name_ja": "ジャンガリアン",
        ...
        },
        {
            ...
            "name_ja": "キャンベル",
            "risk": {"Diabetes Mellitus": 3.0, "Glaucoma": 1.5, "Cataracts": 1.5, "Tumors/Neoplasia": 1.5},
            "ecology": {
                "temperature": {"min": 18, "max": 24, "unit": "°C"},
                "humidity": {"min": 40, "max": 60, "unit": "%"},
                "lifespan": {"min": 1.5, "max": 2.5, "unit": "years"},
    ...
    "ferret": [
        ...
        },
        {
            ...
            "risk": {
                "Adrenal Disease": 1.5,
                "Hairball/GI Obstruction": 1.8,
                "Gastrointestinal Foreign Body / Obstruction": 1.8,
            },
            "ecology": {
                "temperature": {"min": 15, "max": 24, "unit": "°C"},
                "humidity": {"min": 40, "max": 65, "unit": "%"},
        ...
        {
            "id": "ferret_albino",
            "name": "Albino (Dark-eyed White)",
            "name_ja": "アルビノ（ダークアイドホワイト）",
    ...
    "guinea_pig": [
        ...
        {
            "id": "guinea_pig_peruvian",
            "name": "Peruvian",
            "name_ja": "ペルビアン",
            "risk": {
                "Dermatophytosis (Ringworm)": 1.8,
                "Ringworm (Trichophyton mentagrophytes)": 1.8,
                "Heat Stroke": 1.5,
                "Flystrike (Myiasis)": 1.8,
                "Pododermatitis (Bumblefoot)": 1.3,
            },
            "ecology": {
                "temperature": {"min": 18, "max": 23, "unit": "°C"},
                "humidity": {"min": 40, "max": 60, "unit": "%"},
                "lifespan": {"min": 5, "max": 7, "unit": "years"},
        ...
        },
        {
            ...
            "risk": {
                ...
                "Skin Infections": 1.8,
                "Sunburn": 2.0,
                "Ringworm (Trichophyton mentagrophytes)": 1.5,
            },
            "ecology": {
        ...
        },
        {
            ...
            "risk": {
                "Ear Wax Buildup": 1.5,
                "Dermatophytosis (Ringworm)": 1.3,
                "Ringworm (Trichophyton mentagrophytes)": 1.3,
            },
            "ecology": {
                "temperature": {"min": 18, "max": 24, "unit": "°C"},
                "humidity": {"min": 40, "max": 60, "unit": "%"},
    ...
    "chinchilla": [
        ...
        {
            "id": "chinchilla_white",
            "name": "White (Wilson White)",
            "name_ja": "ホワイト（ウィルソンホワイト）",
    ...
    "hedgehog": [
        {
            "id": "hedgehog_four_toed",
            "name": "Four-toed (African Pygmy)",
            "name_ja": "ヨツユビハリネズミ",
            "risk": {
                "Wobbly Hedgehog Syndrome (WHS)": 2.0,
                "Tumors/Neoplasia": 2.0,
                "Obesity": 1.5,
                "Mite Infestation": 1.3,
                "Fatty Liver Disease": 1.5,
                "Squamous Cell Carcinoma": 1.8,
                "Cardiomyopathy": 1.5,
            },
            "ecology": {
                "temperature": {"min": 24, "max": 29, "unit": "°C"},
                "humidity": {"min": 40, "max": 60, "unit": "%"},
        ...
        {
            "id": "hedgehog_european",
            "name": "European Hedgehog",
            "name_ja": "ヨーロッパハリネズミ",
            "risk": {"Lungworm Infection": 2.0, "Parasitic Infection": 1.8, "Ringworm (Dermatophytosis)": 1.5},
            "ecology": {
                "temperature": {"min": 15, "max": 25, "unit": "°C"},
    ...
    "bird": [
        ...
        },
        {
            ...
            "ecology": {
                "temperature": {"min": 16, "max": 26, "unit": "°C"},
                "humidity": {"min": 40, "max": 65, "unit": "%"},
        ...
        },
        {
            ...
            "name": "Finch",
            "name_ja": "フィンチ",
            "risk": {"Air Sac Mites": 2.0, "Coccidiosis": 1.5, "Scaly Leg Mites": 1.5, "Atoxoplasmosis": 1.8},
            "ecology": {
                "temperature": {"min": 18, "max": 27, "unit": "°C"},
                "humidity": {"min": 40, "max": 65, "unit": "%"},
        ...
        {
            "id": "bird_java_sparrow",
            "name": "Java Sparrow",
            "name_ja": "文鳥",
            "risk": {
                "Egg Binding": 1.8,
                "Obesity": 1.5,
                "Iron Storage Disease": 1.5,
                "Gout": 1.5,
                "Bumblefoot (Pododermatitis)": 1.3,
            },
            "ecology": {
        ...
        },
        {
            ...
            "name": "Dove/Pigeon",
            "name_ja": "ハト",
            "risk": {"Trichomoniasis": 2.5, "Paramyxovirus Infection": 2.0, "Coccidiosis": 1.8, "Candidiasis": 1.5},
            "ecology": {
    ...
    "parakeet": [
        {
            "id": "parakeet_budgerigar",
            "name": "Budgerigar",
            "name_ja": "セキセイインコ",
            "risk": {
                "Budgerigar Fledgling Disease (BFD)": 2.5,
                "Tumors/Neoplasia": 2.0,
                "Scaly Face Mites": 1.8,
                "Megabacteriosis (AGY)": 2.0,
                "Goiter": 1.5,
            },
            "ecology": {
                "temperature": {"min": 18, "max": 28, "unit": "°C"},
        ...
        {
            "id": "parakeet_cockatiel",
            "name": "Cockatiel",
            "name_ja": "オカメインコ",
            "risk": {
                "Fatty Liver Disease (Hepatic Lipidosis)": 2.0,
                "Night Frights": 1.5,
                "Egg Binding": 1.8,
                "Chronic Egg Laying": 2.0,
            },
            "ecology": {
                "temperature": {"min": 18, "max": 28, "unit": "°C"},
                "humidity": {"min": 40, "max": 65, "unit": "%"},
        ...
        {
            "id": "parakeet_lovebird",
            "name": "Lovebird",
            "name_ja": "コザクラインコ/ボタンインコ",
            "risk": {
                "Psittacine Beak and Feather Disease (PBFD)": 1.5,
                "Feather Plucking": 1.5,
    ...
    "parrot": [
        {
            "id": "parrot_african_grey",
            "name": "African Grey",
            "name_ja": "ヨウム",
            "risk": {
                "Feather Plucking": 2.5,
                "Hypocalcemia": 2.5,
                "Aspergillosis": 2.0,
                "Psittacine Beak and Feather Disease (PBFD)": 1.5,
            },
        ...
        },
        {
            ...
            "name_ja": "アマゾン",
            "risk": {
                "Fatty Liver Disease (Hepatic Lipidosis)": 2.5,
                "Obesity": 2.0,
                "Foot Necrosis (Bumblefoot)": 1.5,
                "Bumblefoot (Pododermatitis)": 1.5,
            },
            "ecology": {
                "temperature": {"min": 20, "max": 28, "unit": "°C"},
                "humidity": {"min": 50, "max": 70, "unit": "%"},
        ...
        },
        {
            ...
            "name_ja": "コンゴウインコ",
            "risk": {
                "Proventricular Dilatation Disease (PDD)": 2.0,
                "Feather Plucking": 1.8,
                "Psittacine Beak and Feather Disease (PBFD)": 1.5,
            },
            "ecology": {
                "temperature": {"min": 20, "max": 30, "unit": "°C"},
        ...
        },
        {
            ...
            "name_ja": "オウム科",
            "risk": {
                "Feather Plucking": 3.0,
                "Psittacine Beak and Feather Disease (PBFD)": 2.0,
    ...
    "reptile": [
        ...
        {
            "id": "reptile_ball_python",
            "name": "Ball Python",
            "name_ja": "ボールパイソン",
            "risk": {
                "Respiratory Infection": 1.8,
                "Inclusion Body Disease (IBD)": 2.0,
                "Mite Infestation": 1.5,
                "Anorexia/Feeding Refusal": 2.0,
            },
            "ecology": {
        ...
        },
        {
            ...
            "risk": {
                ...
                "Adenovirus Infection": 2.0,
                "Yellow Fungus Disease": 1.8,
                "Impaction": 1.5,
            },
            "ecology": {
                "temperature": {"min": 26, "max": 40, "unit": "°C"},
                "humidity": {"min": 30, "max": 50, "unit": "%"},
        ...
        },
        {
            ...
            "name": "Leopard Gecko",
            "name_ja": "ヒョウモントカゲモドキ",
            "risk": {"Metabolic Bone Disease": 1.5, "Cryptosporidiosis": 2.0, "Impaction": 1.8},
            "ecology": {
                "temperature": {"min": 24, "max": 32, "unit": "°C"},
                "humidity": {"min": 30, "max": 50, "unit": "%"},
                "lifespan": {"min": 15, "max": 25, "unit": "years"},
    ...
    "tortoise": [
        ...
        },
        {
            ...
            "risk": {
                "Respiratory Infection": 1.8,
                "Upper Respiratory Tract Infection (URTI)": 1.8,
                "Parasitic Infection": 1.5,
            },
            "ecology": {
                "temperature": {"min": 24, "max": 34, "unit": "°C"},
                "humidity": {"min": 40, "max": 60, "unit": "%"},
    ...
    "snake": [
        ...
        },
        {
            ...
            "name_ja": "ボアコンストリクター",
            "risk": {"Inclusion Body Disease (IBD)": 2.5, "Respiratory Infection": 1.5, "Mite Infestation": 1.5},
            "ecology": {
                "temperature": {"min": 26, "max": 33, "unit": "°C"},
    ...
    "lizard": [
        {
            "id": "lizard_leopard_gecko",
            "name": "Leopard Gecko",
            "name_ja": "ヒョウモントカゲモドキ",
            "risk": {
                "Metabolic Bone Disease": 1.5,
                "Cryptosporidiosis": 2.0,
                "Dysecdysis (Retained Shed)": 1.5,
                "Impaction": 1.8,
            },
            "ecology": {
                "temperature": {"min": 24, "max": 32, "unit": "°C"},
        ...
        },
        {
            ...
            "risk": {
                "Metabolic Bone Disease": 2.0,
                "Kidney Disease": 1.8,
                "Renal Failure (Chronic Kidney Disease)": 1.8,
                "Bladder Stones": 1.5,
            },
            "ecology": {
                "temperature": {"min": 26, "max": 35, "unit": "°C"},
                "humidity": {"min": 60, "max": 80, "unit": "%"},
                "lifespan": {"min": 15, "max": 20, "unit": "years"},
    ...
    "amphibian": [
        {
            "id": "amphibian_axolotl",
            "name": "Axolotl",
            "name_ja": "ウーパールーパー",
            "risk": {
                "Fungal Infection": 2.0,
                "Gill Damage": 1.8,
                "Gill Necrosis (Larval)": 1.8,
                "Impaction": 1.5,
                "Ammonia Poisoning": 1.5,
            },
            "ecology": {
                "temperature": {"min": 14, "max": 20, "unit": "°C"},
    ...
    "sugar_glider": [
        ...
        {
            "id": "sugar_glider_white_faced_blonde",
            "name": "White Faced Blonde",
            "name_ja": "ホワイトフェイスブロンド",
...
PAIN_LEVEL_DISEASE_BOOST: Dict[int, Dict[str, float]] = {
    2: {
        "Osteoarthritis": 1.3,
        "Intervertebral Disc Disease": 1.2,
        "Pancreatitis": 1.3,
        "Gastric Ulcer": 1.2,
    ...
    3: {
        ...
        "Pyelonephritis": 1.3,
        "Urolithiasis": 1.4,
        "Foreign Body Obstruction": 1.4,
        "Immune-Mediated Polyarthritis": 1.3,
        "Meningitis": 1.4,
        "Osteosarcoma": 1.3,
        "Acute Abdomen": 1.5,
    },
    4: {
        ...
        "Peritonitis": 1.8,
        "Meningitis": 1.6,
        "Intervertebral Disc Disease": 1.6,
        "Fracture": 1.6,
        "Urethral Obstruction": 1.6,
        "Spinal Fracture": 1.7,
        "Acute Abdomen": 1.8,
...
def _fuzzy_boost_lookup(
    ...
    for boost_name, multiplier in boost_dict.items():
        ...
        if base_name and boost_base and (base_name in boost_base or boost_base in base_name):
...
def analyze_symptoms_generic(
    ...
    *,
    ...
    for disease in diseases:
        ...
        # 臨床的重み付きカバー率（既存）
        matching_weight = sum(SYMPTOM_CLINICAL_WEIGHTS.get(s, _DEFAULT_SYMPTOM_WEIGHT) for s in matching)
        total_weight = sum(SYMPTOM_CLINICAL_WEIGHTS.get(s, _DEFAULT_SYMPTOM_WEIGHT) for s in disease_symptoms)
        ...
        match_percent = round(coverage * symptom_count_factor * combo_bonus * (1.0 - absence_penalty) * 100)
        ...
        pain_multiplier = (
            min(_fuzzy_boost_lookup(disease["name"], pain_boosts), 1.8) if pain_boosts else pain_urgency_modifier
        )
        ...
        suspected.append(
            {
                ...
                "scoring_detail": {
                    ...
                    "specificity_bonus": round(
                        sum(
                            0.06
                            if SYMPTOM_CLINICAL_WEIGHTS.get(s, _DEFAULT_SYMPTOM_WEIGHT) >= 2.0
                    ...
                    "confidence_level": (
                        "high" if adjusted_percent >= 50 else "medium" if adjusted_percent >= 30 else "low"
                    ),
                },
                ...
                "missing_key_symptoms": sorted(
                    s
                    for s in (disease_symptoms - symptom_set)
                ...
                "rule_out_note": (
                    ...
                    if absent_key_symptoms and absence_penalty > 0.05
                    else ""
                ),
