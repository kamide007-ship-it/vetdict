...
DISEASES: List[Dict[str, Any]] = [
    ...
    },
    {
        "name": "Epilepsy",
        "name_ja": "特発性てんかん",
        "symptoms": {"seizures", "circling", "anxiety", "lethargy", "collapse", "drooling"},
    ...
    },
    {
        ...
        "name_ja": "免疫介在性多発性関節炎",
        "symptoms": {"swollen_joints", "fever", "lethargy", "stiffness", "appetite_loss"},
    ...
    # ---- Digestive (expanded) ----
    {
        "name": "Gastric Ulcer",
        "name_ja": "胃潰瘍",
        "symptoms": {"vomiting", "appetite_loss", "bloody_stool", "lethargy", "abdominal_pain"},
    ...
    },
    {
        ...
        "name_ja": "強迫性障害",
        "symptoms": {"circling", "anxiety", "itching", "aggression_change"},
