...
DISEASES: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": "A life-threatening complication of diabetes mellitus characterized by hyperglycemia (>250 mg/dL), ketosis (β-hydroxybutyrate >3.0 mmol/L), and metabolic acidosis (pH <7.30 or HCO3 <15 mEq/L). Approximately 40% of newly diagnosed diabetic dogs present in DKA. Mortality 8-30% even with optimal ICU care; concurrent disease (pancreatitis, UTI, Cushing's, neoplasia) is present in >70% of cases and is the leading driver of mortality.",
        "description_ja": "糖尿病の致死的合併症。高血糖（>250 mg/dL）、ケトーシス（β-ヒドロキシ酪酸 >3.0 mmol/L）、代謝性アシドーシス（pH<7.30またはHCO3<15 mEq/L）を特徴とする。新規診断糖尿病犬の約40%がDKAで初診。最適ICUケアでも死亡率8-30%；併発疾患（膵炎・UTI・クッシング・腫瘍）が>70%の症例に存在し死亡率を規定する主要因子。",
        "pathophysiology": "Absolute or relative insulin deficiency → impaired glucose utilization → counter-regulatory hormone surge (glucagon, cortisol, catecholamines, GH) → unopposed lipolysis → free fatty acids to liver → β-oxidation overflow into ketogenesis (acetoacetate, β-hydroxybutyrate, acetone). Simultaneously: hyperglycemia → osmotic diuresis → dehydration + obligatory loss of Na, K, P, Mg, Cl. Ketone bodies are weak acids → high anion gap metabolic acidosis. Vomiting + osmotic diuresis → severe dehydration → hypovolemic shock + prerenal azotemia. Total body potassium is markedly depleted even when serum K+ appears normal/elevated (intracellular shift due to acidosis). Insulin therapy + fluid expansion + acidosis correction drive K+ back into cells → SEVERE hypokalemia within hours of treatment if not preempted. Phosphorus depletion can cause hemolysis (severe <1.5 mg/dL) and respiratory muscle weakness. Cerebral edema risk if osmolality is corrected too rapidly.",
        "pathophysiology_ja": "絶対的または相対的インスリン欠乏→グルコース利用障害→対抗調節ホルモン（グルカゴン・コルチゾール・カテコラミン・GH）の急上昇→脂肪分解の制御不能→遊離脂肪酸の肝臓流入→β酸化の溢流でケトン体産生（アセト酢酸・β-ヒドロキシ酪酸・アセトン）。同時に高血糖→浸透圧利尿→脱水＋Na・K・P・Mg・Cl必発喪失。ケトン体は弱酸→高アニオンギャップ代謝性アシドーシス。嘔吐＋浸透圧利尿→重度脱水→循環血液量減少性ショック＋腎前性高窒素血症。血清K+が正常/高値に見えても全身カリウムは著しく枯渇している（アシドーシスによる細胞内シフト）。インスリン投与＋輸液＋アシドーシス補正でK+が細胞内へ戻る→対策しないと治療後数時間で重度低K血症。リン枯渇は溶血（重度 <1.5 mg/dL）と呼吸筋脱力を引き起こす。浸透圧の急速補正は脳浮腫リスク。",
        "causes": "TRIGGER required to convert stable DM to DKA: untreated/newly-onset DM (40% of cases present without prior diagnosis), insulin discontinuation or underdosing, concurrent illness (pancreatitis 40-50%, UTI 20-30%, hyperadrenocorticism 5-15%, neoplasia, gastrointestinal disease, dental disease, pyometra), corticosteroid administration, progesterone/diestrus in intact bitches (insulin resistance), surgical/anesthetic stress. Pancreatitis is the single most common comorbidity in canine DKA and the leading cause of treatment failure.",
        "causes_ja": "誘因が必須：未治療・新規発症の糖尿病（40%が事前診断なしで来院）、インスリン投与中断または不足、併発疾患（膵炎40-50%、UTI 20-30%、副腎皮質機能亢進症5-15%、腫瘍、消化器疾患、歯科疾患、子宮蓄膿症）、ステロイド投与、未避妊雌の発情間期/プロゲステロン期（インスリン抵抗性）、手術・麻酔ストレス。膵炎は犬DKAの最多併発疾患であり治療失敗の主因。",
        "treatment": "INITIAL ASSESSMENT: (1) Confirm DKA — venous blood gas (pH, HCO3, base deficit), serum BUN/creat/electrolytes (Na, K, Cl, P, Mg, Ca), glucose, β-hydroxybutyrate (point-of-care or send-out), CBC, urinalysis with culture, ALT/ALP, lipase/SPEC-cPL, abdominal ultrasound. (2) Identify and treat concurrent disease (pancreatitis is highly prevalent — measure SPEC-cPL early). PHASE 1 - FLUID THERAPY (FIRST, BEFORE INSULIN — at least 1-4 hours of rehydration before starting insulin to avoid cerebral edema): (A) 0.9% NaCl IV at 60-90 mL/kg/hr × 1-2 hours for shock resuscitation, then taper to maintenance + dehydration replacement over 24-36 hours (typical maintenance + 5-10% deficit replacement = 4-6 mL/kg/hr). (B) Switch to LRS or Plasmalyte once hyperchloremic acidosis develops (after 12-24 hours of saline). (C) Add dextrose to fluids when blood glucose drops to 250 mg/dL: 2.5% dextrose in fluids (slow rate of glucose decline to <50 mg/dL/hr to prevent cerebral edema). PHASE 2 - POTASSIUM REPLACEMENT (BEFORE insulin if K<3.5 mEq/L; otherwise concurrently): KCl supplementation in fluids: K 3.5-5 mEq/L → add 20 mEq KCl/L; K 3-3.5 → 30 mEq/L; K 2.5-3 → 40 mEq/L; K <2.5 → 60-80 mEq/L (max 0.5 mEq/kg/hr infusion — cardiac monitoring required). DO NOT START INSULIN if K <3.0 until corrected. PHASE 3 - INSULIN THERAPY (only after fluid resuscitation initiated): regular insulin (R, novolin/humulin R) — TWO PROTOCOLS: (i) IV CRI (preferred): 2.2 IU/kg of regular insulin in 250 mL 0.9% NaCl, run first 50 mL through line to saturate (insulin binds plastic), then start at 0.05-0.1 IU/kg/hr; titrate to target glucose decline 50-100 mg/dL/hr. (ii) Intermittent IM: regular insulin 0.2 IU/kg IM initially, then 0.1 IU/kg IM q1-2h until glucose <250 mg/dL, then transition to maintenance SC. PHASE 4 - PHOSPHORUS REPLACEMENT (if PO4 <2 mg/dL or hemolysis present): potassium phosphate 0.01-0.06 mmol/kg/hr IV (replace ~50% of calculated K with phosphate; do not give in calcium-containing fluids — precipitates). PHASE 5 - BICARBONATE (rarely needed; only if pH <7.0 after fluid + insulin, severe hyperkalemia, or refractory acidosis): NaHCO3 deficit × 0.3 (calculated as: 0.5 × kg × [12 - patient HCO3]) given IV slow over 4-6 hours. Routine bicarbonate causes more harm than benefit (paradoxical CSF acidosis, hypokalemia worsening, sodium overload). PHASE 6 - MONITORING (q1-4 hours initially): glucose q1-2h, electrolytes (K, P, Mg) q4-6h, blood gas q6-12h, BUN/creat q12-24h, urine output (catheter), mentation (cerebral edema watch), ECG (hyperkalemia), body weight. TRANSITION TO MAINTENANCE: once eating without vomiting, ketones cleared, electrolytes stable → switch to long-acting SC insulin (NPH 0.25 IU/kg q12h or detemir 0.1 IU/kg q12h initially in dogs, glargine 0.25-0.5 IU/kg q12h in cats). Owner education on home glucose curves, recognition of DKA recurrence (Ketostix, BHB meter), strict insulin compliance.",
        "treatment_ja": "初期評価：(1)DKA確認—静脈血液ガス（pH・HCO3・base deficit）、血清BUN/クレアチニン/電解質（Na・K・Cl・P・Mg・Ca）、血糖、β-ヒドロキシ酪酸（POCまたは外注）、CBC、尿検査＋培養、ALT/ALP、リパーゼ/SPEC-cPL、腹部超音波。(2)併発疾患の同定と治療（膵炎が高頻度—SPEC-cPLを早期測定）。第1相—輸液療法（インスリンより先、脳浮腫予防のため少なくとも1-4時間の輸液後にインスリン開始）：(A)0.9% NaCl IV 60-90 mL/kg/hr ×1-2時間（ショック蘇生）、その後維持＋脱水補正を24-36時間で（通常 維持＋5-10%補正＝4-6 mL/kg/hr）。(B)高Cl血症性アシドーシス出現後はLRSまたはPlasmalyteへ切替（生食12-24時間後）。(C)血糖が250 mg/dLまで低下したら輸液に2.5%デキストロース追加（血糖低下速度<50 mg/dL/hrに維持—脳浮腫予防）。第2相—カリウム補充（K<3.5 mEq/Lならインスリンより先、それ以外は併行）：輸液へのKCl追加—K 3.5-5 mEq/L→20 mEq KCl/L；K 3-3.5→30 mEq/L；K 2.5-3→40 mEq/L；K<2.5→60-80 mEq/L（最大0.5 mEq/kg/hr—心電図モニタリング必須）。K<3.0なら補正までインスリン開始しない。第3相—インスリン療法（輸液開始後のみ）：レギュラーインスリン（R、ノボリン/ヒューマリン R）—2プロトコル：(i)IV CRI（推奨）：レギュラーインスリン2.2 IU/kgを250 mL 0.9% NaClに混和、最初の50 mLは廃棄（インスリンがプラスチックに吸着）、0.05-0.1 IU/kg/hrで開始；血糖低下速度50-100 mg/dL/hrに調整。(ii)間欠IM：レギュラーインスリン初回0.2 IU/kg IM、その後0.1 IU/kg IM q1-2h（血糖<250まで）、その後維持SCへ移行。第4相—リン補充（PO4<2 mg/dLまたは溶血あり）：リン酸カリウム0.01-0.06 mmol/kg/hr IV（計算Kの約50%をリン酸塩で置換；カルシウム含有輸液には混入禁忌—沈殿）。第5相—重炭酸（稀に必要；輸液＋インスリン後もpH<7.0、重度高K血症、難治性アシドーシスの場合のみ）：NaHCO3欠損×0.3（計算式：0.5×kg×[12-患者HCO3]）を4-6時間かけてIV緩徐投与。ルーチン重炭酸は有害（逆説的CSF酸性化、低K血症悪化、Na過剰）。第6相—モニタリング（初期q1-4h）：血糖q1-2h、電解質（K・P・Mg）q4-6h、血液ガスq6-12h、BUN/クレアチニンq12-24h、尿量（カテーテル）、意識（脳浮腫監視）、ECG（高K血症）、体重。維持療法への移行：嘔吐なく摂食可、ケトン消失、電解質安定後→長時間作用SCインスリンへ切替（犬：NPH 0.25 IU/kg q12hまたはdetemir 0.1 IU/kg q12h、猫：glargine 0.25-0.5 IU/kg q12h）。飼い主教育：自宅血糖カーブ、DKA再発の認識（ケトスティック、BHBメーター）、厳格なインスリン遵守。",
        "prognosis": "Mortality 8-30% in canine DKA. Predictors of poor outcome: severe acidosis (pH <7.0), hypoalbuminemia (<2.0 g/dL), hyperphosphatemia at presentation, severe pancreatitis, prolonged hospitalization (>5 days), multiple comorbidities. Mean hospitalization 5-7 days, average treatment cost USD 3,000-8,000. Recurrence rate 12% within 1 year. References: Hume DZ et al. JVIM 2006 (DKA prognosis n=127); Boysen SR. Vet Clin Small Anim 2008 (fluid therapy); Hess RS. Compend Contin Educ 2007 (DKA management); Behrend EN AAHA Diabetes Guidelines 2018; Gilor & Greco BSAVA Manual of Endocrinology 5th ed.",
        "prognosis_ja": "犬DKA死亡率8-30%。予後不良因子：重度アシドーシス（pH<7.0）、低アルブミン血症（<2.0 g/dL）、来院時の高リン血症、重度膵炎、長期入院（>5日）、複数併発疾患。平均入院期間5-7日、平均治療費USD 3,000-8,000。1年以内の再発率12%。参考文献：Hume DZ et al. JVIM 2006（DKA予後 n=127）；Boysen SR. Vet Clin Small Anim 2008（輸液療法）；Hess RS. Compend Contin Educ 2007（DKA管理）；Behrend EN AAHA Diabetes Guidelines 2018；Gilor & Greco BSAVA Manual of Endocrinology 第5版。",
        "prevention": "Prevention includes appropriate husbandry, balanced nutrition, regular veterinary examinations, stress reduction, and prompt treatment of early signs of illness.",
        "prevention_ja": "糖尿病の適切なインスリン管理・血糖モニタリング、併発疾患の早期治療、食欲低下時のインスリン用量調整（自己判断でインスリン中止しない）、定期的なフルクトサミン/HbA1c測定。BHBメーター（β-ヒドロキシ酪酸自宅測定）の使用で初期ケトーシスを早期検出。",
        "urgency": "emergency",
        "recommended_tests": ["blood_panel", "blood_glucose", "urinalysis", "blood_gas", "abdominal_ultrasound"],
        "onset_pattern": {"acute"},
        "age_predisposition": {"adult", "senior"},
    },
    {
        "name": "Hyperglycemic Hyperosmolar Syndrome (HHS)",
        "name_ja": "高血糖高浸透圧症候群（HHS）",
        "symptoms": {
            "lethargy",
            "dehydration",
            "excessive_thirst",
        ...
        "description": "A rare but lethal complication of diabetes mellitus distinct from DKA, characterized by extreme hyperglycemia (>600 mg/dL, often >1000 mg/dL), severe hyperosmolality (>350 mOsm/kg), profound dehydration, and altered mentation, but with minimal or absent ketosis (β-hydroxybutyrate <3.0 mmol/L) and only mild metabolic acidosis. Mortality 50-65% — substantially higher than DKA — due to delayed recognition, severe dehydration at presentation, and concurrent serious comorbidities (renal failure, heart disease, sepsis).",
        "description_ja": "DKAとは別の糖尿病稀少致死的合併症。極度の高血糖（>600 mg/dL、しばしば>1000 mg/dL）、重度高浸透圧（>350 mOsm/kg）、深刻な脱水、意識障害を特徴とするが、ケトーシスは最小限または無し（β-ヒドロキシ酪酸 <3.0 mmol/L）、代謝性アシドーシスは軽度のみ。死亡率50-65%—DKAよりはるかに高い—発見遅延、来院時の重度脱水、深刻な併発疾患（腎不全・心疾患・敗血症）が原因。",
        "pathophysiology": "Mechanism diverges from DKA: residual insulin secretion (or insulin therapy) is sufficient to suppress lipolysis and ketogenesis but inadequate to control hyperglycemia. Massive osmotic diuresis → severe dehydration (often 12-15% body weight loss) → reduced GFR → impaired glucose excretion → escalating hyperglycemia → vicious cycle. Absence of ketoacidosis means patients lack the warning symptoms (vomiting, Kussmaul respirations) that prompt earlier presentation, allowing dehydration and hyperosmolality to reach extreme levels. Calculated effective serum osmolality = 2(Na) + glucose/18: HHS criterion >350 mOsm/kg (severe >380). CNS effects from hyperosmolality: obtundation, stupor, coma, focal seizures, hemiparesis. Total body water deficit averages 100-150 mL/kg (vs 60-80 mL/kg in DKA). Concurrent disease present in nearly 100% of HHS cases; renal disease (CKD, AKI), heart failure, and infection are most common.",
        "pathophysiology_ja": "機序がDKAと異なる：残存インスリン分泌（またはインスリン療法）が脂肪分解・ケトン産生を抑制するには十分だが、高血糖制御には不十分。大規模浸透圧利尿→重度脱水（しばしば体重の12-15%減少）→GFR低下→グルコース排泄障害→さらなる高血糖→悪循環。ケトアシドーシスを欠くため警告症状（嘔吐・クスマウル呼吸）がなく、来院遅延で脱水・高浸透圧が極端なレベルに達する。実効血清浸透圧計算式 = 2(Na) + glucose/18：HHS基準 >350 mOsm/kg（重度 >380）。高浸透圧の中枢神経系影響：傾眠・昏迷・昏睡・限局性痙攣・片麻痺。全身水分欠乏は平均100-150 mL/kg（DKAの60-80 mL/kgに対し）。HHS症例のほぼ100%に併発疾患あり；腎疾患（CKD・AKI）、心不全、感染が最多。",
        "causes": "Underlying diabetes mellitus + precipitating factor + impaired water access/intake. Precipitating factors: severe concurrent illness (CKD/AKI, congestive heart failure, sepsis, pancreatitis, neoplasia, pneumonia), corticosteroid administration, dehydration from any cause (vomiting, diarrhea, no water access), diuretic use, parenteral nutrition with high glucose load. Older diabetic dogs with concurrent CKD or CHF at highest risk. May develop in cats with prior history of feline diabetes, especially during acromegaly-related insulin resistance.",
        "causes_ja": "基礎の糖尿病＋誘発因子＋水分摂取障害。誘発因子：重度併発疾患（CKD/AKI、うっ血性心不全、敗血症、膵炎、腫瘍、肺炎）、ステロイド投与、原因を問わない脱水（嘔吐・下痢・水不足）、利尿薬、高グルコース負荷の経静脈栄養。CKDまたはCHFを併発した高齢糖尿病犬が最高リスク。猫では既往の糖尿病、特に末端肥大症関連のインスリン抵抗性で発症しうる。",
        "treatment": "DIAGNOSTIC CRITERIA (must distinguish from DKA): glucose >600 mg/dL, effective osmolality >350 mOsm/kg, β-hydroxybutyrate <3.0 mmol/L (or urine ketones absent/trace), pH >7.30, HCO3 >15 mEq/L. Calculate corrected Na for hyperglycemia: corrected Na = measured Na + 1.6 × (glucose - 100)/100. INITIAL ASSESSMENT: venous blood gas, serum BUN/creat (often markedly elevated due to prerenal + concurrent CKD), Na, K, Cl, P, Mg, Ca, glucose, BHB, lactate, CBC, urinalysis with culture, ALT/ALP, lipase/SPEC-cPL, abdominal ultrasound, thoracic radiographs, ECG. PHASE 1 - FLUID THERAPY (slower than DKA — risk of cerebral edema is HIGHER): (A) 0.9% NaCl IV at 10-20 mL/kg/hr × 1 hour for initial volume expansion (NOT the aggressive 60-90 mL/kg/hr used for DKA shock — these patients are hyperosmotic and rapid correction causes cerebral edema). (B) Calculate total fluid deficit (typically 12-15% of body weight = 120-150 mL/kg) and replace SLOWLY over 36-48 hours (not 24 hours like DKA). (C) Target maximum osmolality decline 3-5 mOsm/kg/hr (NOT faster — cerebral edema risk dramatically increased). (D) Switch to 0.45% NaCl once initial volume expansion achieved if corrected Na is high. (E) Add 2.5% dextrose when glucose drops to 250-300 mg/dL. PHASE 2 - INSULIN THERAPY (DELAY 4-6 HOURS after starting fluids — many patients normalize glucose substantially with rehydration alone, and starting insulin too early causes rapid osmolality shift and cerebral edema): regular insulin CRI 0.025-0.05 IU/kg/hr (HALF the DKA dose) — titrate to target glucose decline <50 mg/dL/hr (NOT 50-100 like DKA). PHASE 3 - ELECTROLYTE REPLACEMENT: same K supplementation as DKA but more conservative; PO4 replacement if <2 mg/dL. PHASE 4 - TREAT UNDERLYING CAUSE (more critical than in DKA): aggressive workup and treatment of CKD, CHF, sepsis, pancreatitis. PHASE 5 - MONITORING (more intensive than DKA): glucose q1h, electrolytes q4-6h, calculated osmolality q4h (target decline <3-5 mOsm/kg/hr), mentation continuously (cerebral edema watch — herniation can occur within hours of rapid correction), urine output (catheter), ECG. CEREBRAL EDEMA TREATMENT (if mentation deteriorates after initial improvement): mannitol 0.5-1 g/kg IV slow over 20-30 minutes, hypertonic saline 3% 4-5 mL/kg, head elevation, slow further fluid correction.",
        "treatment_ja": "診断基準（DKAとの鑑別必須）：血糖>600 mg/dL、実効浸透圧>350 mOsm/kg、β-ヒドロキシ酪酸<3.0 mmol/L（または尿ケトン陰性/痕跡）、pH>7.30、HCO3>15 mEq/L。高血糖補正Na計算：補正Na = 実測Na + 1.6 × (glucose - 100)/100。初期評価：静脈血液ガス、血清BUN/クレアチニン（腎前性＋併発CKDで著明上昇が多い）、Na・K・Cl・P・Mg・Ca、血糖、BHB、乳酸、CBC、尿検査＋培養、ALT/ALP、リパーゼ/SPEC-cPL、腹部超音波、胸部X線、ECG。第1相—輸液療法（DKAより緩徐—脳浮腫リスクが高い）：(A)0.9% NaCl IV 10-20 mL/kg/hr ×1時間（DKAショック蘇生の60-90 mL/kg/hrは使わない—HHS患者は高浸透圧で急速補正は脳浮腫を起こす）。(B)総水分欠乏（通常体重の12-15%＝120-150 mL/kg）を計算、36-48時間かけてゆっくり補充（DKAの24時間ではない）。(C)最大浸透圧低下速度3-5 mOsm/kg/hrを目標（これより速いと脳浮腫リスク劇的増加）。(D)初期容量拡張後、補正Naが高ければ0.45% NaClに変更。(E)血糖が250-300 mg/dLまで低下したら2.5%デキストロース追加。第2相—インスリン療法（輸液開始から4-6時間遅らせる—多くの症例で輸液のみで血糖がかなり低下、早期インスリンは急速浸透圧シフトと脳浮腫を起こす）：レギュラーインスリンCRI 0.025-0.05 IU/kg/hr（DKAの半量）—血糖低下速度<50 mg/dL/hr目標（DKAの50-100ではない）。第3相—電解質補正：DKAと同じKサプリメントだがより慎重；PO4<2 mg/dLでリン補充。第4相—基礎原因の治療（DKAより重要）：CKD・CHF・敗血症・膵炎の積極的精査・治療。第5相—モニタリング（DKAより集中的）：血糖q1h、電解質q4-6h、計算浸透圧q4h（低下速度<3-5 mOsm/kg/hr目標）、意識を連続観察（脳浮腫監視—急速補正で数時間以内にヘルニア起こりうる）、尿量（カテーテル）、ECG。脳浮腫治療（初期改善後の意識悪化）：マンニトール0.5-1 g/kg IV緩徐 20-30分、3%高張食塩水4-5 mL/kg、頭部挙上、輸液補正をさらに緩徐に。",
        "prevention": "Prevention focuses on avoiding the perfect storm: (1) Strict diabetic control with regular monitoring (glucose curves, fructosamine q3 months) to detect insulin resistance early. (2) Early identification and treatment of comorbidities — annual senior diabetic screening for CKD (creat, SDMA, urinalysis), cardiac disease (echo if murmur or breed-predisposed), thyroid status. (3) Owner education on adequate water access for diabetic dogs (multiple bowls, monitor intake). (4) Conservative use of corticosteroids in diabetic patients. (5) Recognition of early HHS warning signs: progressive lethargy + extreme polyuria/polydipsia + minimal-to-no vomiting (in contrast to DKA which usually has vomiting). (6) Home BHB testing to differentiate DKA (BHB elevated) from HHS (BHB normal/low) when considering urgent presentation.",
        "prevention_ja": "予防は完璧な嵐の回避に焦点：(1)定期モニタリングによる厳格な糖尿病管理（血糖曲線、フルクトサミン3ヶ月毎）でインスリン抵抗性を早期検出。(2)併発疾患の早期同定・治療—高齢糖尿病犬の年次スクリーニング：CKD（クレアチニン・SDMA・尿検査）、心疾患（雑音または犬種素因あれば心エコー）、甲状腺状態。(3)糖尿病犬への適切な水分摂取教育（複数の水入れ、摂取量確認）。(4)糖尿病患者へのステロイド使用は慎重に。(5)早期HHS警告徴候の認識：進行性無気力＋極度の多飲多尿＋嘔吐がほぼないか軽度（嘔吐が普通あるDKAと対照的）。(6)緊急来院判断時のBHB自宅検査でDKA（BHB高値）とHHS（BHB正常/低値）を鑑別。",
        "prognosis": "Mortality 50-65% in canine HHS — substantially worse than DKA (8-30%). Predictors of poor outcome: severe acidosis (rare in HHS but indicates worse pathology), AKI on presentation, advanced age (>12 years), multiple comorbidities, severe dehydration (>15% body weight loss), CHF, malignant neoplasia. Even survivors often have prolonged hospitalization (7-14 days), high cost, and reduced long-term survival due to underlying comorbidities. References: Trotman TK et al. JVIM 2013 (canine HHS retrospective n=17, mortality 65%); Koenig A. Compend Contin Educ 2008 (HHS pathophysiology and management); Nichols R. JVECC 2008 (HHS in dogs vs cats); Greco DS in BSAVA Manual of Endocrinology 5th ed.; Stojanovic V & Ihle S. JVIM 1995 (early HHS report in dogs).",
        "prognosis_ja": "犬HHS死亡率50-65%—DKA（8-30%）より著しく悪い。予後不良因子：重度アシドーシス（HHSでは稀だが病態悪化を示唆）、来院時のAKI、高齢（>12歳）、複数併発疾患、重度脱水（体重>15%減少）、CHF、悪性腫瘍。生存例でも長期入院（7-14日）、高額治療費、基礎併発疾患のため長期生存率低下。参考文献：Trotman TK et al. JVIM 2013（犬HHS後ろ向き研究 n=17、死亡率65%）；Koenig A. Compend Contin Educ 2008（HHS病態生理と管理）；Nichols R. JVECC 2008（犬と猫のHHS）；Greco DS in BSAVA Manual of Endocrinology 第5版；Stojanovic V & Ihle S. JVIM 1995（犬HHS初期報告）。",
        "urgency": "emergency",
        "recommended_tests": ["blood_panel", "blood_glucose", "urinalysis", "blood_gas", "abdominal_ultrasound"],
        "onset_pattern": {"acute"},
    ...
    {
        "name": "Central (Cranial) Diabetes Insipidus",
        "name_ja": "中枢性（頭蓋性）尿崩症",
        "symptoms": {"excessive_thirst", "excessive_urination", "dehydration", "lethargy", "weight_loss"},
        "description": "Inadequate secretion of antidiuretic hormone (ADH/AVP/vasopressin) from the posterior pituitary, resulting in massive production of dilute urine (typically USG <1.005, often 1.001-1.003) and compensatory polydipsia (water intake commonly >100 mL/kg/day, sometimes >200 mL/kg/day). Distinguished from nephrogenic DI by RESPONSE to desmopressin (DDAVP) — central DI shows >50% reduction in urine output and concentration of urine, nephrogenic DI does not. Rare in dogs (estimated <0.1% of veterinary patients with PU/PD); often associated with pituitary or hypothalamic neoplasia in older dogs.",
        "description_ja": "下垂体後葉からの抗利尿ホルモン（ADH/AVP/バソプレシン）分泌不足により、大量の希釈尿（典型的にUSG <1.005、多くは1.001-1.003）と代償性多飲（飲水量しばしば>100 mL/kg/日、時に>200 mL/kg/日）を呈する疾患。腎性尿崩症との鑑別はデスモプレシン（DDAVP）への反応で行う—中枢性DIでは尿量50%以上減少・尿濃縮を示すが、腎性DIでは反応なし。犬では稀（PU/PDで来院する症例の<0.1%程度）；高齢犬では下垂体・視床下部の腫瘍に関連することが多い。",
        "pathophysiology": "ADH is synthesized in the supraoptic and paraventricular nuclei of the hypothalamus, transported axonally to the posterior pituitary (neurohypophysis), and released into circulation in response to plasma osmolality >300 mOsm/kg. ADH binds V2 receptors on renal collecting duct principal cells → activation of Gs/cAMP → translocation of aquaporin-2 (AQP2) channels to apical membrane → water reabsorption. CDI arises from destruction or dysfunction at any point along this axis: hypothalamic neurons, pituitary stalk, posterior pituitary terminals. Causes include: idiopathic (~50% of canine cases — likely autoimmune destruction), pituitary/hypothalamic neoplasia (craniopharyngioma, pituitary adenoma, pituitary carcinoma, lymphoma), trauma (head injury with stalk transection — characteristic 'triphasic response' with transient DI → SIADH → permanent DI), surgery (transsphenoidal hypophysectomy), congenital malformation (rare, breed-specific in some Labrador, Miniature Poodle lines), inflammatory (granulomatous meningoencephalitis, infectious meningitis). Severity varies: complete CDI (no measurable ADH) vs partial CDI (residual ADH but inadequate). Critical complication: severe hypernatremia and hyperosmolality if water access is restricted (e.g., during boarding, surgery, illness) — neurologic decompensation can occur within 24-48 hours.",
        "pathophysiology_ja": "ADHは視床下部の視索上核・室傍核で合成され、軸索輸送で下垂体後葉（神経下垂体）に運ばれ、血漿浸透圧>300 mOsm/kgに応じて循環に放出される。ADHは腎集合管主細胞のV2受容体に結合→Gs/cAMP活性化→アクアポリン2（AQP2）チャネルの頂膜への移動→水の再吸収。CDIはこの経路のいずれかでの障害により発生：視床下部ニューロン、下垂体茎、下垂体後葉終末。原因：特発性（犬症例の約50%—自己免疫性破壊と推定）、下垂体・視床下部腫瘍（頭蓋咽頭腫、下垂体腺腫、下垂体癌、リンパ腫）、外傷（頭部外傷で茎断裂—特徴的な『三相性反応』：一過性DI→SIADH→永続的DI）、手術（経蝶形骨洞下垂体摘出術）、先天性奇形（稀、ラブラドール・ミニチュアプードルの一部系統で品種特異的）、炎症性（肉芽腫性髄膜脳炎、感染性髄膜炎）。重症度に幅：完全CDI（測定可能なADHなし）vs 部分CDI（残存ADHあるが不十分）。重篤な合併症：水分摂取が制限されると（預け入れ、手術、疾患時など）重度高Na血症・高浸透圧→神経学的悪化が24-48時間以内に起こりうる。",
        "causes": "Idiopathic (~50% — likely autoimmune destruction of supraoptic neurons), pituitary or hypothalamic tumors (most common identifiable cause in dogs >7 years — craniopharyngioma, pituitary adenoma, pituitary carcinoma, metastatic disease, lymphoma), traumatic brain injury (skull fractures, basilar skull trauma), iatrogenic post-pituitary surgery (transsphenoidal hypophysectomy), congenital (rare; familial in Afghan Hound, Miniature Poodle, Labrador Retriever lines), inflammatory CNS disease (granulomatous meningoencephalitis, lymphoplasmacytic hypophysitis), infectious (rare). Drug-induced CDI is virtually unreported in dogs (unlike humans).",
        "causes_ja": "特発性（約50%—視索上核ニューロンの自己免疫性破壊と推定）、下垂体・視床下部腫瘍（7歳以上の犬で同定可能な最多原因—頭蓋咽頭腫、下垂体腺腫、下垂体癌、転移性疾患、リンパ腫）、外傷性脳損傷（頭蓋骨折、頭蓋底外傷）、医原性の下垂体手術後（経蝶形骨洞下垂体摘出術）、先天性（稀；アフガンハウンド・ミニチュアプードル・ラブラドールレトリーバー系統で家族性）、炎症性中枢神経系疾患（肉芽腫性髄膜脳炎、リンパ形質細胞性下垂体炎）、感染性（稀）。薬剤誘発性CDIは犬では事実上報告なし（ヒトと異なる）。",
        "treatment": "DIAGNOSTIC WORKUP — establishing diagnosis is critical and challenging because CDI is a diagnosis of exclusion (must rule out far more common causes of PU/PD first): \n\nSTEP 1 — RULE OUT COMMON PU/PD CAUSES (most CDI 'cases' turn out to be other diseases): (1) CBC, full chemistry panel (BUN/creat/glucose/Ca/P/Na/K/Cl/albumin/ALT/ALP/cholesterol/T4 in older dogs), urinalysis with specific gravity (USG <1.005 typical in CDI; USG >1.030 effectively rules out DI), urine protein:creatinine ratio. (2) Urine culture (UTI is a common cause of PU/PD via pyelonephritis-induced concentrating defect). (3) Bile acids if hepatic disease suspected. (4) ACTH stimulation test (rule out hypoadrenocorticism — can cause hyposthenuria) and low-dose dexamethasone suppression test (rule out hyperadrenocorticism — much more common cause of PU/PD than CDI). (5) Abdominal ultrasound (rule out pyelonephritis, hepatic disease, neoplasia, adrenal disease). (6) For older dogs with possible psychogenic polydipsia: 24-hour water intake measurement.\n\nSTEP 2 — MODIFIED WATER DEPRIVATION TEST (MWDT) — the historical gold standard but DANGEROUS in suspected CDI (severe hypernatremia within hours): GRADUAL water restriction over 3-5 days (decrease daily intake by 10% per day to 60-70 mL/kg/day), then formal water deprivation under hospital monitoring with q1-2h USG, body weight (stop at 5% loss), serum osmolality, plasma Na, mentation. CDI: USG remains <1.012 despite 5% body weight loss + serum osmolality >310 mOsm/kg, then DDAVP administration produces >50% increase in USG within 4-8 hours (or 1.5-fold rise in urine osmolality). NEPHROGENIC DI: same baseline pattern but NO response to DDAVP. PSYCHOGENIC POLYDIPSIA: USG concentrates to >1.020 with deprivation. STOP TEST IMMEDIATELY if: 5% body weight loss, severe lethargy, vomiting, Na >165 mEq/L. CONTRAINDICATIONS to MWDT: known azotemia, dehydration on presentation (already concentrating maximum but can't), hypercalcemia, severe debility.\n\nSTEP 3 — DDAVP THERAPEUTIC TRIAL (safer alternative to MWDT, increasingly preferred): administer DDAVP 0.5-2 μg subconjunctival or 0.5-4 μg/kg PO BID for 5-7 days while monitoring water intake and USG. Decrease in water intake >50% AND increase in USG to >1.020 within 24-72 hours strongly supports CDI. No response → nephrogenic DI or psychogenic polydipsia.\n\nSTEP 4 — IMAGING for cause identification: brain MRI (preferred — characterizes pituitary/hypothalamic mass; T1 hyperintense 'bright spot' in posterior pituitary may be lost in CDI), CT (alternative if MRI unavailable). Imaging not always positive in idiopathic CDI but essential to rule out neoplasia in older dogs.\n\nSTEP 5 — CONFIRMATORY (research/specialty centers): plasma ADH/AVP measurement during water deprivation (suppressed in CDI; assay availability limited in veterinary medicine).\n\nTREATMENT: (A) DDAVP (DESMOPRESSIN) — synthetic ADH analog: subconjunctival drops 1-4 drops (1.5 μg/drop) q12-24h (most economical, rapid onset 30-60 min, duration 8-24h); intranasal preparation 1-4 drops q12-24h (off-label but works topically on conjunctiva); oral tablets 0.05-0.2 mg/dog (or 5-20 μg/kg) PO q8-12h (more expensive, less reliable absorption); injectable 1-4 μg SC q12-24h (rarely needed; for ICU patients with severe hypernatremia). Titrate dose to maintain water intake <60-70 mL/kg/day and USG 1.012-1.025 (do NOT over-correct to USG >1.030 — risk of water intoxication and hyponatremia). (B) Treat underlying cause if identified: surgical resection of pituitary mass (specialty center, transsphenoidal approach), radiation therapy for pituitary neoplasia, immunosuppression for inflammatory CNS disease. (C) Free water access ALWAYS — never restrict water in CDI patients (hospitalization, boarding, surgery — must have continuous water access). (D) Monitor: water intake (owner log), USG (every 1-3 months at home if able, or monthly clinic check), serum Na (every 3-6 months — risk of hyponatremia from over-treatment, hypernatremia from under-treatment).",
        "treatment_ja": "診断ワークフロー—CDIは除外診断（はるかに多いPU/PDの原因をまず除外する必要があり）、診断は重要かつ困難：\n\nステップ1—一般的なPU/PD原因の除外（CDIと思われた症例の多くは別疾患）：(1)CBC、完全生化学（BUN/クレアチニン/血糖/Ca/P/Na/K/Cl/アルブミン/ALT/ALP/コレステロール/高齢犬はT4）、尿検査＋USG（CDIで典型的にUSG<1.005；USG>1.030でDI事実上除外）、尿蛋白:クレアチニン比。(2)尿培養（UTIは腎盂腎炎による濃縮障害でPU/PDの一般的原因）。(3)肝疾患疑いなら胆汁酸。(4)ACTH刺激試験（副腎皮質機能低下症の除外—低比重尿の原因）と低用量デキサメタゾン抑制試験（副腎皮質機能亢進症の除外—CDIよりはるかに多いPU/PD原因）。(5)腹部超音波（腎盂腎炎・肝疾患・腫瘍・副腎疾患の除外）。(6)高齢犬で心因性多飲を疑う場合：24時間飲水量測定。\n\nステップ2—修正水制限試験（MWDT）—歴史的ゴールドスタンダードだがCDI疑い例で危険（数時間で重度高Na血症）：3-5日間の段階的水制限（毎日摂取量を10%/日減少、60-70 mL/kg/日まで）、その後病院監視下で正式水制限—q1-2hでUSG・体重（5%減で中止）・血清浸透圧・血漿Na・意識。CDI：5%体重減少＋血清浸透圧>310 mOsm/kgでもUSG<1.012、その後DDAVP投与で4-8時間以内にUSG>50%上昇（または尿浸透圧1.5倍上昇）。腎性DI：同じベースラインだがDDAVPに無反応。心因性多飲：制限でUSG>1.020まで濃縮。即時試験中止：5%体重減少、重度無気力、嘔吐、Na>165 mEq/L。MWDT禁忌：既知の高窒素血症、来院時の脱水（既に最大濃縮中だが不能）、高Ca血症、重度衰弱。\n\nステップ3—DDAVP治療的トライアル（MWDTより安全、推奨度上昇中）：DDAVP 0.5-2 μgを結膜下、または0.5-4 μg/kg PO BID ×5-7日、飲水量とUSGを監視。24-72時間以内に飲水量>50%減少かつUSG>1.020まで上昇でCDIを強く支持。無反応→腎性DIまたは心因性多飲。\n\nステップ4—原因同定のための画像検査：頭部MRI（推奨—下垂体・視床下部腫瘤を特性化；下垂体後葉のT1高信号『bright spot』がCDIで消失することあり）、CT（MRI利用不能時の代替）。特発性CDIでは画像所見なしが多いが、高齢犬の腫瘍除外に必須。\n\nステップ5—確定診断（研究機関・専門施設）：水制限中の血漿ADH/AVP測定（CDIで抑制；獣医領域でアッセイ利用限定的）。\n\n治療：(A)DDAVP（デスモプレシン）—合成ADHアナログ：結膜下点眼1-4滴（1滴=1.5 μg）q12-24h（最も経済的、効果発現30-60分、持続8-24h）；点鼻液1-4滴q12-24h（適応外だが結膜局所投与で効く）；経口錠0.05-0.2 mg/犬（または5-20 μg/kg）PO q8-12h（高価、吸収に変動）；注射1-4 μg SC q12-24h（重度高Na血症のICU患者に稀に必要）。飲水量<60-70 mL/kg/日、USG 1.012-1.025を目標に用量調整（USG>1.030への過剰補正は水中毒・低Na血症のリスクのため避ける）。(B)同定された基礎疾患の治療：下垂体腫瘤の外科切除（専門施設、経蝶形骨洞アプローチ）、下垂体腫瘍への放射線治療、炎症性中枢神経系疾患への免疫抑制。(C)常時自由水分摂取—CDI患者で絶対に水分制限しない（入院・預け入れ・手術—連続的水分摂取が必須）。(D)モニタリング：飲水量（飼い主ログ）、USG（可能なら1-3ヶ月毎自宅、または月1回受診）、血清Na（3-6ヶ月毎—過剰治療で低Na血症、不足で高Na血症のリスク）。",
        "prevention": "Prevention is generally not possible since most CDI is idiopathic or tumor-related. Avoid unnecessary head trauma. In dogs with prior pituitary surgery, anticipate post-operative DI and have DDAVP available. Consider screening older dogs (>7 years) with progressive PU/PD with MRI if classic CDI presentation (severe PU/PD with USG <1.005 unresponsive to ACTH stim/LDDS).",
        "prevention_ja": "ほとんどのCDIは特発性または腫瘍関連のため一般的に予防不能。不必要な頭部外傷を避ける。下垂体手術既往の犬では術後DIを予測しDDAVPを準備。古典的CDI提示（重度PU/PDでUSG<1.005、ACTH刺激/LDDS無反応）の高齢犬（>7歳）はMRIスクリーニングを考慮。",
        "prognosis": "Idiopathic CDI: excellent with DDAVP therapy; near-normal life expectancy. Trauma-induced CDI: variable — may be transient (recovery within weeks if axonal damage limited), permanent if stalk transection. Tumor-associated CDI: prognosis depends on tumor type, size, treatability — pituitary adenomas may respond to surgery/radiation (median survival 1-3 years post-treatment), aggressive carcinomas/lymphomas typically <6 months without treatment. Untreated severe CDI: water intoxication risk if owner attempts to overcorrect; hypernatremic crisis if water deprivation occurs (mortality high). References: Harb MF et al. JAVMA 1996 (clinical features and treatment of CDI in dogs n=20); Foley C et al. JVIM 2009 (pituitary masses with CDI); Greco DS in Ettinger Feldman Côté Textbook of Veterinary Internal Medicine 8th ed Ch 311; Davenport DJ. Compend Contin Educ 1986 (DDAVP in dogs); Adams VJ, Watson P. Vet Rec 2009 (PU/PD differential).",
        "prognosis_ja": "特発性CDI：DDAVP療法で予後良好；ほぼ正常な余命。外科後CDI：変動—軸索損傷が限定的なら数週で回復、茎断裂なら永続的。腫瘍関連CDI：予後は腫瘍型・サイズ・治療可能性に依存—下垂体腺腫は手術/放射線に反応することあり（治療後生存期間中央値1-3年）、悪性度の高い癌/リンパ腫は治療なしで通常<6ヶ月。未治療重度CDI：飼い主の過剰補正による水中毒リスク；水分制限が起こると高Na血症クリーゼ（死亡率高）。参考文献：Harb MF et al. JAVMA 1996（犬CDIの臨床所見と治療 n=20）；Foley C et al. JVIM 2009（CDIを伴う下垂体腫瘤）；Greco DS in Ettinger Feldman Côté Textbook of Veterinary Internal Medicine 第8版 Ch 311；Davenport DJ. Compend Contin Educ 1986（犬のDDAVP）；Adams VJ, Watson P. Vet Rec 2009（PU/PD鑑別）。",
        "urgency": "urgent",
