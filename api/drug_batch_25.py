...
DRUG_INTERACTIONS_PATCH_25: dict[str, list[dict]] = {
    ...
    "alfaxalone": [
        {"drug": "Benzodiazepines", "effect": "Additive CNS/respiratory depression; reduced alfaxalone dose needed", "severity": "moderate"},
        {"drug": "Opioids", "effect": "Additive CNS depression; reduce alfaxalone dose 25-50%", "severity": "moderate"},
        {"drug": "Alpha-2 agonists", "effect": "Synergistic sedation; significantly reduce alfaxalone dose", "severity": "moderate"}
    ],
    "altrenogest": [
        {"drug": "Prostaglandins (PGF2α)", "effect": "Antagonistic—prostaglandins lyse CL, opposing progestagen effect", "severity": "major"},
        {"drug": "Oxytocin", "effect": "Progestins may reduce uterine response to oxytocin", "severity": "moderate"}
    ],
    "atenolol": [
        {"drug": "Calcium channel blockers (diltiazem)", "effect": "Additive bradycardia and AV block risk", "severity": "major"},
    ...
    "atipamezole": [
        {"drug": "Opioids", "effect": "Reversal of alpha-2 component may unmask inadequate opioid analgesia", "severity": "moderate"},
        {"drug": "Ketamine", "effect": "Reversal may unmask ketamine-induced muscle rigidity/seizures", "severity": "major"}
    ],
    "amphotericin_b": [
    ...
    "budesonide": [
        {"drug": "Ketoconazole", "effect": "Inhibits budesonide CYP3A4 metabolism; increased systemic exposure", "severity": "moderate"},
    ...
    "cabergoline": [
        ...
        {"drug": "Phenothiazines", "effect": "Dopamine antagonism reduces cabergoline efficacy", "severity": "moderate"}
    ],
    "cefovecin": [
    ...
    "cephalexin": [
        {"drug": "Aminoglycosides", "effect": "Additive nephrotoxicity risk with prolonged use", "severity": "moderate"},
    ...
    "ciprofloxacin": [
        {"drug": "Antacids (Al/Mg)", "effect": "Chelation reduces ciprofloxacin absorption by 90%", "severity": "major"},
    ...
    "epinephrine": [
        ...
        {"drug": "Halothane/Isoflurane", "effect": "Cardiac sensitization; ventricular arrhythmias", "severity": "major"},
    ...
    "fenbendazole": [
        {"drug": "Dexamethasone", "effect": "May reduce fenbendazole efficacy (immunosuppression)", "severity": "minor"},
        {"drug": "Praziquantel", "effect": "Often used in combination safely", "severity": "minor"}
    ],
    "fipronil": [
        {"drug": "No significant drug interactions", "effect": "Topical with minimal systemic absorption", "severity": "minor"}
    ],
    "flunixin": [
    ...
    "fluralaner": [
        {"drug": "No significant drug interactions", "effect": "Highly protein-bound but no clinically relevant interactions reported", "severity": "minor"}
    ],
    "fosfomycin": [
        {"drug": "Metoclopramide", "effect": "Reduces fosfomycin levels by increasing GI transit", "severity": "moderate"},
    ...
    "methimazole": [
        ...
        {"drug": "Digoxin", "effect": "Correction of hyperthyroidism increases digoxin sensitivity", "severity": "moderate"},
        {"drug": "Warfarin", "effect": "Correction of hyperthyroidism alters anticoagulant requirement", "severity": "moderate"}
    ],
    "methylene_blue": [
        {"drug": "Serotonergic drugs (SSRIs)", "effect": "Serotonin syndrome (methylene blue is MAO-A inhibitor)", "severity": "major"}
    ],
    "metronidazole": [
    ...
    "mirtazapine_oral": [
        ...
        {"drug": "Cyproheptadine", "effect": "Serotonin antagonism may reduce appetite stimulant effect", "severity": "moderate"},
        {"drug": "Tramadol", "effect": "Serotonin syndrome risk", "severity": "moderate"}
    ],
    "naloxone": [
        {"drug": "All opioids", "effect": "Complete reversal of opioid effects; may precipitate withdrawal", "severity": "moderate"}
    ],
    "nitrofurantoin": [
    ...
    "phenobarbital_oral": [
        {"drug": "Other CNS depressants", "effect": "Additive sedation and respiratory depression", "severity": "major"},
    ...
    "rifampin": [
        {"drug": "Nearly all hepatically metabolized drugs", "effect": "Potent CYP inducer; reduces levels of most drugs", "severity": "major"},
    ...
    "s_adenosylmethionine": [
        ...
        {"drug": "No clinically significant interactions", "effect": "Generally safe as hepatoprotectant supplement", "severity": "minor"}
    ],
    "selegiline": [
    ...
    "ursodiol": [
        {"drug": "Aluminum antacids", "effect": "Reduces ursodiol absorption (bile acid binding)", "severity": "moderate"},
    ...
    "cosyntropin": [
        {"drug": "Cortisol assay interference", "effect": "Exogenous steroids affect ACTH stim test interpretation", "severity": "moderate"}
    ],
    "desoxycorticosterone": [
        {"drug": "Digoxin", "effect": "DOCP-induced hypokalemia increases digoxin toxicity", "severity": "major"},
        {"drug": "Potassium-sparing diuretics", "effect": "May partially counteract DOCP effect", "severity": "moderate"}
    ],
    "darbepoetin": [
    ...
    "activated_charcoal": [
        {"drug": "All oral medications", "effect": "Reduces absorption of co-administered drugs; space 2h", "severity": "major"},
    ...
    "intralipid": [
        {"drug": "Lipophilic drugs (local anesthetics)", "effect": "Sequesters lipophilic toxins—therapeutic use", "severity": "minor"}
    ],
    "dexamethasone_sp": [
        {"drug": "NSAIDs", "effect": "Dramatically increased GI ulceration risk", "severity": "major"},
    ...
    "cisapride": [
        {"drug": "Ketoconazole/itraconazole", "effect": "QT prolongation; arrhythmia risk (CYP3A4 inhibition)", "severity": "major"},
    ...
    "doxycycline": [
        {"drug": "Antacids (Ca/Mg/Al/Fe)", "effect": "Chelation reduces absorption 50-90%; space 2h", "severity": "major"},
    ...
    "acepromazine": [
        ...
        {"drug": "Epinephrine", "effect": "Unopposed beta effect → paradoxical hypotension (use phenylephrine instead)", "severity": "major"},
    ...
    "chloramphenicol": [
        {"drug": "Phenobarbital", "effect": "Bidirectional: PB reduces chloramphenicol; chloramphenicol increases PB levels", "severity": "major"},
    ...
    "levetiracetam_oral": [
        ...
        {"drug": "No significant hepatic interactions", "effect": "Renally cleared; minimal CYP involvement", "severity": "minor"}
    ],
    "silymarin": [
        {"drug": "CYP-metabolized drugs", "effect": "Theoretical mild CYP inhibition; clinically insignificant", "severity": "minor"}
    ],
    "famotidine_injectable": [
        {"drug": "Ketoconazole", "effect": "Reduced ketoconazole absorption (needs acid pH)", "severity": "moderate"},
        {"drug": "Sucralfate", "effect": "H2 blockers may reduce sucralfate activation (needs acid)", "severity": "minor"}
    ],
    "calcium_gluconate": [
        {"drug": "Digoxin", "effect": "IV calcium can precipitate digoxin toxicity—contraindicated in digitalized patients", "severity": "major"},
    ...
    "tramadol": [
        ...
        {"drug": "Other CNS depressants", "effect": "Additive sedation and respiratory depression", "severity": "moderate"},
        {"drug": "Ondansetron", "effect": "Reduces tramadol analgesic effect (5-HT3 involved)", "severity": "moderate"}
    ],
    "fluconazole_oral": [
        {"drug": "Cyclosporine", "effect": "Increases cyclosporine levels 2-3x (CYP3A4 inhibition)", "severity": "major"},
    ...
    "itraconazole_oral": [
        ...
        {"drug": "Antacids/H2 blockers/PPIs", "effect": "Reduced itraconazole absorption (needs acid)", "severity": "major"}
    ],
    "trilostane_oral": [
        {"drug": "ACE inhibitors", "effect": "Potential hyperkalemia from aldosterone suppression", "severity": "moderate"},
    ...
    "telmisartan_feline": [
        {"drug": "ACE inhibitors", "effect": "Dual RAAS blockade; hyperkalemia and hypotension risk", "severity": "major"},
    ...
    "vincristine_injectable": [
        {"drug": "Itraconazole/ketoconazole", "effect": "Increased vincristine neurotoxicity (CYP3A4 inhibition)", "severity": "major"},
        {"drug": "Phenytoin", "effect": "Reduced phenytoin absorption", "severity": "moderate"},
        {"drug": "L-asparaginase", "effect": "Give vincristine 12-24h before L-asp (reduced clearance)", "severity": "moderate"}
    ],
    ...
    "cyclophosphamide_oral": [
        ...
        {"drug": "Phenobarbital", "effect": "Increases cyclophosphamide activation and toxicity", "severity": "moderate"},
    ...
    "pimobendan_oral": [
        {"drug": "Beta-blockers", "effect": "May partially antagonize positive inotropic effect", "severity": "moderate"},
        {"drug": "Calcium channel blockers (verapamil)", "effect": "Additive negative effects on contractility", "severity": "major"}
    ],
