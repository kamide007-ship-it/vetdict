...
DRUG_INTERACTIONS_PATCH_27: dict[str, list[dict]] = {
    "adequan_equine": [
        {
            "drug": "Anticoagulants",
            "effect": "Additive anticoagulant effect (polysulfated GAG has heparin-like activity)",
            "severity": "moderate",
        }
    ],
    "afoxolaner": [
        {
            ...
            "effect": "Isoxazoline; highly protein-bound but no clinically relevant CYP interactions",
            "severity": "minor",
        }
    ],
    "alfaprostol": [
    ...
    "flumazenil": [
        {
            ...
            "effect": "Specific reversal agent; may precipitate seizures in benzodiazepine-dependent animals",
            "severity": "moderate",
        },
        {
            "drug": "Tricyclic antidepressants",
            "effect": "Unmasking of TCA-induced seizures after BZD reversal",
            "severity": "major",
        },
    ],
    "glycopyrrolate": [
        ...
        {"drug": "Metoclopramide", "effect": "Antagonizes prokinetic GI effects", "severity": "moderate"},
        {
            ...
            "effect": "Delayed GI transit increases KCl ulceration risk",
            "severity": "moderate",
        },
    ],
    "griseofulvin": [
    ...
    "gs441524": [
        {
            "drug": "No well-documented drug interactions",
            "effect": "Novel antiviral nucleoside analog; limited pharmacokinetic data",
            "severity": "minor",
        }
    ],
    "hydrochlorothiazide": [
    ...
    "interferon_omega": [
        {
            ...
            "effect": "May antagonize immunostimulatory effects of interferon",
            "severity": "moderate",
        }
    ],
    "latanoprost": [
        {"drug": "Atropine ophthalmic", "effect": "Opposing effects on pupil size", "severity": "minor"},
        {
            ...
            "effect": "May slightly reduce prostaglandin-mediated IOP reduction",
            "severity": "minor",
        },
    ],
    "levofloxacin": [
    ...
    "lokivetmab": [
        {
            "drug": "No significant drug interactions",
            "effect": "Anti-IL-31 monoclonal antibody; no CYP metabolism",
            "severity": "minor",
        }
    ],
    "librela": [
        {
            "drug": "No significant drug interactions",
            "effect": "Anti-NGF monoclonal antibody; no hepatic metabolism",
            "severity": "minor",
        },
    ...
    "lomustine": [
        {
            ...
            "effect": "Additive/delayed bone marrow suppression (nadir 4-6 weeks)",
            "severity": "major",
        },
    ...
    "maropitant": [
        {
            "drug": "Highly protein-bound drugs",
            "effect": "Theoretical displacement; clinically minimal",
            "severity": "minor",
        }
    ],
    "medetomidine_vatinoxan": [
        {
            "drug": "Opioids",
            "effect": "Additive sedation; reduces cardiovascular depression (vatinoxan component)",
            "severity": "moderate",
        },
    ...
    "milbemycin_oxime": [
        {
            ...
            "effect": "Increased avermectin CNS penetration in MDR1-mutant dogs",
            "severity": "moderate",
        }
    ],
    "minocycline": [
        {
            "drug": "Antacids/cations",
            "effect": "Chelation reduces absorption (less than older tetracyclines)",
            "severity": "moderate",
        },
    ...
    "molnupiravir": [
        {
            "drug": "No well-documented veterinary interactions",
            "effect": "Limited veterinary pharmacokinetic data available",
            "severity": "minor",
        }
    ],
    "moxidectin": [
        {
            ...
            "effect": "Increased CNS penetration in MDR1-mutant dogs; neurotoxicity risk",
            "severity": "major",
        },
    ...
    "nitenpyram_oral": [
        {
            "drug": "No significant drug interactions",
            "effect": "Rapid-kill adulticide with minimal systemic interactions",
            "severity": "minor",
        }
    ],
    "ondansetron": [
    ...
    "ponazuril": [
        {
            "drug": "No significant drug interactions",
            "effect": "Triazine antiprotozoal with minimal systemic interactions",
            "severity": "minor",
        }
    ],
    "pradofloxacin": [
    ...
    "sarolaner_oral": [
        {
            "drug": "No significant drug interactions",
            "effect": "Isoxazoline; no clinically relevant CYP interactions at label dose",
            "severity": "minor",
        }
    ],
    "toltrazuril": [
        {
            "drug": "No significant drug interactions",
            "effect": "Anticoccidial with minimal systemic interactions",
            "severity": "minor",
        }
    ],
    "timolol_ophthalmic": [
        {
            ...
            "effect": "Additive bradycardia and hypotension from ocular absorption",
            "severity": "major",
        },
        {
    ...
    "fuzapladib": [
        {
            "drug": "No well-documented drug interactions",
            "effect": "Novel leukocyte adhesion inhibitor; limited interaction data",
            "severity": "minor",
        }
    ],
    ...
    "deslorelin": [
        {
            "drug": "No significant drug interactions",
            "effect": "GnRH agonist implant; peptide with no CYP interaction",
            "severity": "minor",
        }
    ],
    "deslorelin_implant": [
        {
            "drug": "No significant drug interactions",
            "effect": "GnRH agonist implant; minimal systemic interactions",
            "severity": "minor",
        }
    ],
    "deslorelin_reproductive": [
        {
            "drug": "No significant drug interactions",
            "effect": "GnRH agonist implant; no CYP metabolism",
            "severity": "minor",
        }
    ],
    ...
    "acriflavine": [
        {
            ...
            "effect": "Topical antiseptic for aquarium use",
            "severity": "minor",
        }
    ],
    "aquarium_salt": [
        {
            "drug": "No significant drug interactions",
            "effect": "Supportive electrolyte for fish; not a pharmaceutical",
            "severity": "minor",
        }
    ],
    "artificial_tears": [
    ...
    "chlorhexidine": [
        {
            "drug": "No significant systemic interactions",
            "effect": "Topical antiseptic with negligible absorption",
            "severity": "minor",
        }
    ],
    "chlorhexidine_topical": [
        {
            "drug": "No significant systemic interactions",
            "effect": "Topical antiseptic/shampoo; not systemically absorbed",
            "severity": "minor",
        }
    ],
    "cobalamin_injection": [
    ...
    "copper_sulfate": [
        {
            "drug": "No significant systemic interactions",
            "effect": "Aquatic antiparasitic bath treatment",
            "severity": "minor",
        }
    ],
    "cranberry_extract": [
    ...
    "critical_care_herbivore": [
        {
            "drug": "No significant drug interactions",
            "effect": "Nutritional support product; not a pharmaceutical",
            "severity": "minor",
        }
    ],
    "carnivore_care": [
    ...
    "emeraid_ic": [
        {
            "drug": "No significant drug interactions",
            "effect": "Intensive care nutritional support; not a pharmaceutical",
            "severity": "minor",
        }
    ],
    "epsom_salt": [
        {
            "drug": "No significant drug interactions",
            "effect": "Magnesium sulfate bath for fish; negligible interaction",
            "severity": "minor",
        }
    ],
    "calcium_glubionate": [
    ...
    "cyclopentolate": [
        {
            "drug": "Pilocarpine",
            "effect": "Antagonistic—opposing effects on pupil and ciliary muscle",
            "severity": "moderate",
        }
    ],
    ...
    "erythromycin_ophthalmic": [
        {
            "drug": "No significant systemic interactions",
            "effect": "Ophthalmic ointment with minimal absorption",
            "severity": "minor",
        }
    ],
    "amikacin_ophthalmic": [
    ...
    "aluminum_sucrose": [
        {
            "drug": "No significant drug interactions",
            "effect": "Phosphate binder; acts locally in GI tract",
            "severity": "minor",
        }
    ],
    "eprinomectin_topical": [
        {
            "drug": "P-glycoprotein inhibitors",
            "effect": "Theoretical increased CNS penetration in MDR1 dogs",
            "severity": "moderate",
        }
    ],
    "esafoxolaner": [
        {
            "drug": "No significant drug interactions",
            "effect": "Isoxazoline; no clinically relevant interactions at label dose",
            "severity": "minor",
        }
    ],
    "formalin_fish": [
        {
            "drug": "No significant drug interactions",
            "effect": "External aquatic parasite treatment",
            "severity": "minor",
        }
    ],
    "fipronil_spray": [
        {
            "drug": "No significant drug interactions",
            "effect": "Topical ectoparasiticide; minimal systemic absorption",
            "severity": "minor",
        }
    ],
    "imidacloprid": [
        {
            "drug": "No significant drug interactions",
            "effect": "Topical neonicotinoid with minimal systemic absorption",
            "severity": "minor",
        }
    ],
    "emodepside": [
        {
            "drug": "No significant drug interactions",
            "effect": "Topical anthelmintic with minimal interactions",
            "severity": "minor",
        }
    ],
    "ecvn_for_joint": [
    ...
    "ecvn_amino_complete": [
        {
            "drug": "No significant drug interactions",
            "effect": "Amino acid supplement; minimal pharmacological interactions",
            "severity": "minor",
        }
    ],
    "ecvn_booster_relax": [
        {
            "drug": "No significant drug interactions",
            "effect": "Nutritional supplement with adaptogenic herbs",
            "severity": "minor",
        }
    ],
    "ecvn_for_antioxidant": [
        {
            "drug": "No significant drug interactions",
            "effect": "Antioxidant supplement; minimal pharmacological interactions",
            "severity": "minor",
        }
    ],
    "ecvn_kamide_milk": [
    ...
    "ecvn_nmn_mito_assist": [
        {
            "drug": "No significant drug interactions",
            "effect": "NMN supplement; limited pharmacokinetic data",
            "severity": "minor",
        }
    ],
    ...
    "ecvn_protain": [
        {
            "drug": "No significant drug interactions",
            "effect": "Protein supplement; not a pharmaceutical",
            "severity": "minor",
        }
    ],
    "glucosamine": [{"drug": "Warfarin", "effect": "Case reports of increased INR", "severity": "moderate"}],
    "lysine": [
        {
            "drug": "No significant drug interactions",
            "effect": "Amino acid supplement for feline herpesvirus",
            "severity": "minor",
        }
    ],
}
...
DRUG_INTERACTIONS_PATCH_27B: dict[str, list[dict]] = {
    ...
    "emodepside_topical": [
        {
            "drug": "No significant drug interactions",
            "effect": "Topical anthelmintic with minimal systemic interactions",
            "severity": "minor",
        }
    ],
    "heparin_laminitis": [
    ...
    "imidacloprid_moxidectin": [
        {
            "drug": "P-glycoprotein inhibitors",
            "effect": "May increase moxidectin CNS levels in MDR1 dogs",
            "severity": "moderate",
        }
    ],
    "kanamycin_fish": [
    ...
    "ketoconazole_shampoo": [
        {
            "drug": "No significant systemic interactions",
            "effect": "Topical antifungal shampoo; negligible absorption",
            "severity": "minor",
        }
    ],
    "levamisole_fish": [
    ...
    "lotilaner_oral": [
        {
            "drug": "No significant drug interactions",
            "effect": "Isoxazoline; no clinically relevant CYP interactions",
            "severity": "minor",
        }
    ],
    "lufenuron": [
        {
            "drug": "No significant drug interactions",
            "effect": "IGR with no systemic activity in mammals",
            "severity": "minor",
        }
    ],
    "malachite_green": [
        {
            "drug": "Formalin",
            "effect": "Often used in combination for fish parasites (safe combination)",
            "severity": "minor",
        }
    ],
    "maropitant_travel": [
    ...
    "miconazole": [
        {
            "drug": "Warfarin",
            "effect": "Topical miconazole can increase INR even with minimal absorption",
            "severity": "moderate",
        }
    ],
    "miconazole_chlorhex": [
        {
            "drug": "No significant systemic interactions",
            "effect": "Topical combination; negligible systemic absorption",
            "severity": "minor",
        }
    ],
    "miconazole_topical": [
    ...
    "milbemycin_praziquantel": [
        {
            "drug": "P-glycoprotein inhibitors",
            "effect": "Increased milbemycin CNS penetration in MDR1 dogs",
            "severity": "moderate",
        }
    ],
    "natamycin_ophthalmic": [
        {
            "drug": "No significant drug interactions",
            "effect": "Ophthalmic antifungal with minimal systemic absorption",
            "severity": "minor",
        }
    ],
    "nitenpyram": [
        {
            "drug": "No significant drug interactions",
            "effect": "Rapid-acting insecticide with minimal systemic interactions",
            "severity": "minor",
        }
    ],
    "nystatin": [
        {
            "drug": "No significant systemic interactions",
            "effect": "Not absorbed from GI tract; acts locally",
            "severity": "minor",
        }
    ],
    "omega3": [{"drug": "Anticoagulants", "effect": "High doses may increase bleeding risk", "severity": "moderate"}],
    "oxytetracycline": [
    ...
    "oxytetracycline_injectable": [
        {
            "drug": "Penicillins",
            "effect": "Bacteriostatic may antagonize bactericidal activity",
            "severity": "moderate",
        },
        {
            "drug": "Nephrotoxic drugs",
            "effect": "Additive nephrotoxicity with high-dose tetracyclines",
            "severity": "moderate",
        },
    ],
    "oxytocin": [
    ...
    "penicillin_g": [
        {
            "drug": "Tetracyclines",
            "effect": "Bacteriostatic may antagonize penicillin's bactericidal effect",
            "severity": "moderate",
        },
        {"drug": "Probenecid", "effect": "Increases penicillin levels (reduced clearance)", "severity": "minor"},
        {
            "drug": "Aminoglycosides",
            "effect": "Synergistic bactericidal; do not mix in same syringe",
            "severity": "minor",
        },
    ],
    "pepcid_antacid": [
    ...
    "permethrin": [
        {
            "drug": "No significant drug interactions in dogs",
            "effect": "TOXIC TO CATS—never apply to or near cats",
            "severity": "minor",
        }
    ],
    ...
    "phenylephrine_ophthalmic": [
        {
            "drug": "MAO inhibitors",
            "effect": "Potentiated pressor response from systemic absorption",
            "severity": "moderate",
        }
    ],
    "poloxamer_407": [
        {
            "drug": "No significant drug interactions",
            "effect": "Wound care product; no systemic effects",
            "severity": "minor",
        }
    ],
    "polymyxin_b": [
    ...
    "potassium_permanganate": [
        {
            "drug": "No significant drug interactions",
            "effect": "External oxidizing bath for fish/aquatic use",
            "severity": "minor",
        }
    ],
    ...
    "prostaglandin_f2a": [
        {
            "drug": "NSAIDs",
            "effect": "Prostaglandin synthesis inhibitors may reduce PGF2α effects",
            "severity": "moderate",
        },
    ...
    "romifidine": [
        ...
        {
            "drug": "IV potentiated sulfonamides",
            "effect": "Fatal dysrhythmias (alpha-2 class in horses)",
            "severity": "major",
        },
    ...
    "sab_antivenom": [
        {
            "drug": "No significant drug interactions",
            "effect": "Fab antivenom fragments; supportive therapy",
            "severity": "minor",
        }
    ],
    "same": [
    ...
    "sardine_oil": [
        {
            "drug": "Anticoagulants",
            "effect": "High omega-3 doses may slightly increase bleeding risk",
            "severity": "minor",
        }
    ],
    "sarolaner": [
        {
            "drug": "No significant drug interactions",
            "effect": "Isoxazoline class; no CYP interactions at label dose",
            "severity": "minor",
        }
    ],
    "selamectin": [
        {
            "drug": "No significant drug interactions",
            "effect": "Topical avermectin; safe at label dose even in MDR1 dogs",
            "severity": "minor",
        }
    ],
    "selamectin_sarolaner": [
        {
            "drug": "No significant drug interactions",
            "effect": "Topical combination; no clinically relevant interactions",
            "severity": "minor",
        }
    ],
    "selenium_vitamin_e": [
        {
            "drug": "No significant drug interactions",
            "effect": "Nutritional supplement; minimal pharmacological interactions",
            "severity": "minor",
        }
    ],
    "sevoflurane": [
        {
            "drug": "Epinephrine/catecholamines",
            "effect": "Cardiac sensitization; arrhythmia risk (less than halothane)",
            "severity": "moderate",
        },
    ...
    "silver_sulfadiazine_cream": [
        {
            ...
            "effect": "Silver may inactivate papain/collagenase",
            "severity": "moderate",
        }
    ],
    "solensia": [
    ...
    "tacrolimus_ophthalmic": [
        {
            "drug": "No significant systemic interactions",
            "effect": "Ophthalmic formulation; minimal systemic absorption",
            "severity": "minor",
        }
    ],
    "tadalafil": [
    ...
    "thyroxine_monitoring": [
        {
            "drug": "No drug interactions",
            "effect": "Diagnostic monitoring; not a therapeutic agent",
            "severity": "minor",
        }
    ],
    ...
    "trichlorfon": [
        {
            "drug": "Other organophosphates",
            "effect": "Additive cholinesterase inhibition; toxicity",
            "severity": "major",
        }
    ],
    ...
    "uvb_therapy": [
        {
            "drug": "Photosensitizing drugs (tetracyclines, fluoroquinolones)",
            "effect": "Increased photosensitivity reaction risk",
            "severity": "moderate",
        }
    ],
    ...
    "vitamin_c_guinea_pig": [
        {
            "drug": "No significant drug interactions",
            "effect": "Essential dietary supplement for guinea pigs",
            "severity": "minor",
        }
    ],
    "voriconazole": [
        {
            "drug": "Cyclosporine",
            "effect": "Doubles cyclosporine levels (potent CYP3A4 inhibitor)",
            "severity": "major",
        },
    ...
    "xylazine": [
        ...
        {
            "drug": "IV potentiated sulfonamides",
            "effect": "Fatal arrhythmias in horses (alpha-2 class)",
            "severity": "major",
        },
