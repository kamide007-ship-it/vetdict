...
ANESTHESIA_PROTOCOLS["dog"] = {
    ...
    "protocols": [
        ...
        },
        {
            ...
            "drugs": [
                {"name": "Medetomidine + Butorphanol", "name_ja": "メデトミジン＋ブトルファノール", "dose": "10-20 μg/kg + 0.2-0.4 mg/kg", "route": "IM", "onset": "10-15 min", "duration": "30-60 min",
                 "notes_ja": "日本で最も一般的な鎮静プロトコル。シナジー効果で確実な鎮静。鎮静深度はMED用量で調整（軽度: 5-10、中等度: 10-20、深: 20-40 μg/kg）。拮抗: アティパメゾール（同容量IM）。", "notes": "Most common sedation protocol in Japan. Synergistic sedation. Titrate depth via MED dose (light: 5-10, moderate: 10-20, deep: 20-40 μg/kg). Reverse: atipamezole (equal volume IM)."},
                {"name": "Dexmedetomidine + Butorphanol", "name_ja": "デクスメデトミジン＋ブトルファノール", "dose": "5-10 μg/kg + 0.2-0.4 mg/kg", "route": "IM", "onset": "10-15 min", "duration": "30-60 min",
                 "notes_ja": "メデトミジンの半量で同等の鎮静。鎮静深度はDEX用量で調整（軽度: 2-5、中等度: 5-10、深: 10-20 μg/kg）。拮抗: アティパメゾール（同容量IM）。", "notes": "Half the medetomidine dose for equivalent sedation. Titrate depth via DEX dose (light: 2-5, moderate: 5-10, deep: 10-20 μg/kg). Reverse: atipamezole (equal volume IM)."},
            ...
            "notes_ja": "α2作動薬＋ブトルファノールの2剤併用は犬で最も信頼性の高い鎮静プロトコル。MED/DEXの用量調整で軽度〜深鎮静まで対応可能。ミダゾラムの追加は健常犬では逆説的興奮リスク（71%, Grint et al. 2018）があるため、鎮静目的でのルーチン追加は推奨されない。MDZは前投薬・ハイリスク患者（ASA III-V）に限定。",
            "notes": "Alpha-2 agonist + butorphanol is the most reliable sedation protocol in dogs. Adjust MED/DEX dose for light to deep sedation. Routine addition of midazolam for sedation is not recommended in healthy dogs due to paradoxical excitation risk (71%, Grint et al. 2018). MDZ reserved for premedication and high-risk patients (ASA III-V).",
            "references": [
                ...
                "Grint NJ, Burford J, Dugdale AH. Does pethidine, buprenorphine or midazolam improve the quality of sedation in dogs following medetomidine administration? J Small Anim Pract. 2018;59(12):756-763.",
        ...
        },
        {
            ...
            "drugs": [
                {"name": "Medetomidine + Butorphanol", "name_ja": "メデトミジン＋ブトルファノール", "dose": "10-20 μg/kg + 0.2-0.4 mg/kg", "route": "IM", "onset": "10-15 min", "duration": "30-60 min",
                 "notes_ja": "★推奨。麻薬指定薬なしで確実な鎮静。ブトルファノールはκ作動薬で向精神薬指定のみ。MED用量で鎮静深度を調整（5-10: 軽度、10-20: 中等度、20-40: 深鎮静 μg/kg）。拮抗: アティパメゾール（同容量IM）。心疾患には禁忌。",
                 "notes": "★Recommended. Reliable sedation without scheduled narcotics. Butorphanol is a kappa-agonist (non-narcotic in Japan). Titrate MED dose for depth (5-10: light, 10-20: moderate, 20-40: deep μg/kg). Reverse: atipamezole (equal volume IM). Contraindicated in cardiac disease."},
                {"name": "Dexmedetomidine + Butorphanol", "name_ja": "デクスメデトミジン＋ブトルファノール", "dose": "5-10 μg/kg + 0.2-0.4 mg/kg", "route": "IM", "onset": "10-15 min", "duration": "30-60 min",
                 "notes_ja": "デクスメデトミジンはメデトミジンの活性光学異性体で、半量で同等の効果。DEX用量で調整（2-5: 軽度、5-10: 中等度、10-20: 深鎮静 μg/kg）。",
                 "notes": "Active enantiomer of medetomidine; half the dose for equivalent effect. Titrate DEX dose (2-5: light, 5-10: moderate, 10-20: deep μg/kg)."},
                {"name": "Midazolam + Butorphanol", "name_ja": "ミダゾラム＋ブトルファノール", "dose": "0.2-0.3 mg/kg + 0.2-0.4 mg/kg", "route": "IM/IV", "onset": "5-15 min", "duration": "30-60 min",
                 "notes_ja": "心血管系への影響が最も少ないプロトコル。心疾患・高齢犬（ASA III-V）に限定推奨。鎮静深度はα2作動薬併用より浅い。健常犬ではミダゾラム単独/併用で逆説的興奮のリスクあり。",
                 "notes": "Least cardiovascular impact. Recommended ONLY for cardiac patients and geriatric dogs (ASA III-V). Sedation depth lighter than alpha-2 combinations. Risk of paradoxical excitation with midazolam in healthy dogs."},
            ],
            "notes_ja": "MED/DEX＋ブトルファノールの2剤が犬の非麻薬性鎮静の標準。ミダゾラムの鎮静目的でのルーチン追加は健常犬では逆説的興奮リスク（71%, Grint et al. 2018 RCT 80頭）があり推奨されない。ミダゾラムは前投薬（導入薬削減）またはハイリスク患者に限定すべき。全薬剤とも麻薬施用者免許不要。",
            "notes": "MED/DEX + butorphanol is the standard non-narcotic sedation in dogs. Routine midazolam addition for sedation is not recommended in healthy dogs due to paradoxical excitation risk (71%, Grint et al. 2018, RCT n=80). Midazolam should be reserved for premedication (to reduce induction agents) or high-risk patients. All drugs are non-narcotic in Japan.",
            "references": [
                "Hayashi K, Nishimura R, Yamaki A, et al. Comparison of sedative effects of medetomidine-midazolam, acepromazine-butorphanol, and midazolam-butorphanol in dogs. J Vet Med Sci. 1994;56(5):951-956.",
                "Grint NJ, Burford J, Dugdale AH. Does pethidine, buprenorphine or midazolam improve the quality of sedation in dogs following medetomidine administration? J Small Anim Pract. 2018;59(12):756-763.",
...
ANESTHESIA_PROTOCOLS["cat"] = {
    ...
    "protocols": [
        ...
        },
        {
            ...
            "notes_ja": "ミダゾラムの追加は全身麻酔前の前投薬として有効（導入薬の必要量を削減し、筋弛緩を改善）。鎮静目的でのルーチン追加は猫でもエビデンスが限定的であり、MED/DEX＋BTRの2剤が鎮静の標準。ブプレノルフィン・メサドンは麻薬指定であり麻薬施用者免許と管理簿が必要。ブトルファノールは向精神薬のみで管理が容易。強い外科的疼痛にはブトルファノール＋局所麻酔（リドカイン・ブピバカイン）の併用を推奨。",
            "notes": "Midazolam addition is effective as premedication before general anesthesia (reduces induction agent dose and improves muscle relaxation). Routine midazolam addition for sedation alone has limited evidence in cats; MED/DEX + BTR remains the sedation standard. Buprenorphine/methadone are scheduled narcotics requiring narcotic license. Butorphanol requires only psychotropic classification. For severe surgical pain, combine butorphanol with local anesthesia (lidocaine/bupivacaine).",
            "references": [
                "Sumiyoshi T, Hara S, Kaneda M. Evaluation of the effective preanesthetic medication method of medetomidine and butorphanol combination in cats. Jpn J Vet Anesth Surg. 2007;38(3&4):43-51.",
                "Yamashita K. ドミトールを見直す — 犬と猫の鎮静・麻酔における安全な使い方. Clinic Note. 2008;4(9):72-77.",
