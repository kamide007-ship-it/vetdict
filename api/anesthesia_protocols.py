        ...
        },
        {
            ...
            "drugs": [
                ...
                {"name": "Dexmedetomidine CRI", "name_ja": "デクスメデトミジンCRI", "dose": "0.5-2 µg/kg/hr", "route": "IV CRI", "onset": "5-10 min", "duration": "Continuous",
                 "notes_ja": "α2作動薬。鎮静・鎮痛・MAC削減（30-50%）。徐脈・末梢血管収縮あり。心疾患には慎重投与。El-Hawari et al.(2022)によりトラマドール・リドカインとの併用でさらにMAC削減効果が増強。", "notes": "α2-agonist. Sedation, analgesia, MAC reduction 30-50%. Causes bradycardia and peripheral vasoconstriction. Use cautiously in cardiac patients. El-Hawari et al. (2022) showed enhanced MAC-sparing when combined with tramadol/lidocaine."},
