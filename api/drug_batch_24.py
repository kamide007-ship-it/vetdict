...
DRUGS_BATCH_24: list[dict] = [
    {
        ...
        "species_info": {
            "dog": {
                "dose": "0.22 mg/kg PO q6-12h",
                "notes": "For intractable non-productive cough (collapsing trachea, chronic bronchitis)",
                "notes_ja": "難治性非生産性咳嗽に（気管虚脱、慢性気管支炎）",
            }
        },
    ...
    },
    {
        ...
        "species_info": {
            "horse": {
                "dose": "0.8 μg/kg PO q12h; may increase to 3.2 μg/kg",
                "notes": "FDA-approved for RAO in horses; 21-day withdrawal for food animals",
                "notes_ja": "馬のRAOでFDA承認；食用動物では21日の休薬期間",
            }
        },
    ...
    },
    {
        ...
        "species_info": {
            "cat": {
                "dose": "44-220 μg/puff via AeroKat spacer q12h",
                "notes": "Gold standard for feline asthma maintenance; AeroKat spacer required",
                "notes_ja": "猫喘息の維持療法のゴールドスタンダード；AeroKatスペーサー必須",
            },
            "dog": {
                "dose": "110-220 μg via spacer q12h",
                "notes": "For chronic bronchitis/eosinophilic bronchopneumopathy",
                "notes_ja": "慢性気管支炎/好酸球性気管支肺症に",
            },
            "horse": {
                "dose": "2000-3000 μg via equine spacer q12h",
                "notes": "For RAO maintenance; equine-specific spacer (Equine Haler)",
                "notes_ja": "RAO維持療法に；馬用スペーサー（エクインヘイラー）使用",
            },
        },
        ...
        "drug_interactions": [
            {
                "drug": "Ketoconazole",
                "effect": "Increases fluticasone systemic exposure via CYP3A4 inhibition",
                "severity": "moderate",
            }
        ],
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "25-50 mg/kg PO q12-24h with fatty meal",
                "notes": "For dermatophytosis; give with fatty food for absorption",
                "notes_ja": "皮膚糸状菌症に；脂肪食と同時投与で吸収促進",
            },
            "cat": {
                "dose": "25-50 mg/kg PO q12-24h with food",
                "notes": "6-8 week course typical; monitor CBC",
                "notes_ja": "通常6-8週間投与；CBC モニタリング",
            },
            "horse": {
                "dose": "10 mg/kg PO q24h",
                "notes": "For equine dermatophytosis (Trichophyton/Microsporum)",
                "notes_ja": "馬の皮膚糸状菌症に",
            },
        },
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "10 mg/kg PO q30 days with food",
                "notes": "Insect growth regulator; does not kill adult fleas—combine with adulticide",
                "notes_ja": "昆虫成長調節剤；成虫は殺さない—殺成虫薬と併用",
            },
            "cat": {
                "dose": "30 mg/kg PO q30 days or 10 mg/kg SC q6mo",
                "notes": "Injectable form available for cats; also studied for dermatophytosis",
                "notes_ja": "猫用注射製剤あり；皮膚糸状菌症への研究もあり",
            },
        },
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "1 mg/kg PO as needed (single dose)",
                "notes": "Kills adult fleas within 30 min; no residual—use with monthly preventive",
                "notes_ja": "30分以内に成虫を駆除；残効性なし—月次予防薬と併用",
            },
            "cat": {
                "dose": "1 mg/kg PO as needed (single dose)",
                "notes": "Safe from 4 weeks of age and 0.9 kg body weight",
                "notes_ja": "4週齢・体重0.9kgから安全",
            },
        },
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "20 mg/kg PO q30 days with food",
                "notes": "Kills fleas and ticks; chewable tablet",
                "notes_ja": "ノミ・ダニ駆除；チュアブル錠",
            },
            "cat": {
                "dose": "6 mg/kg PO q30 days with food",
                "notes": "Feline formulation available; from 8 weeks and 0.5 kg",
                "notes_ja": "猫用製剤あり；8週齢・0.5kgから",
            },
        },
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "2 mg/kg PO q30 days",
                "notes": "Kills fleas, ticks, and Sarcoptes/Demodex mites",
                "notes_ja": "ノミ、ダニ、ヒゼンダニ/ニキビダニを駆除",
            }
        },
    ...
    },
    {
        ...
        "species_info": {
            "cat": {
                "dose": "3 mg/kg topical (spot-on with praziquantel)",
                "notes": "Broad-spectrum dewormer; roundworms, hookworms, tapeworms",
                "notes_ja": "広域駆虫薬；回虫、鉤虫、条虫",
            },
            "ferret": {
                "dose": "Off-label topical at cat dose",
                "notes": "Used for roundworm and hookworm in ferrets",
                "notes_ja": "フェレットの回虫・鉤虫にオフラベル使用",
            },
        },
    ...
    },
    {
        ...
        "species_info": {
            "rabbit": {
                "dose": "2 mg/kg SC q24h",
                "notes": "Anti-nausea for GI stasis; visceral analgesia",
                "notes_ja": "消化管うっ滞の制吐に；内臓鎮痛作用",
            },
            "ferret": {
                "dose": "1 mg/kg SC/PO q24h",
                "notes": "For nausea associated with GI disease or chemotherapy",
                "notes_ja": "消化管疾患または化学療法に伴う悪心に",
            },
            "guinea_pig": {
                "dose": "2 mg/kg SC q24h",
                "notes": "Limited data; extrapolated from rabbit studies",
                "notes_ja": "データ限定的；ウサギの研究から外挿",
            },
            "bird": {
                "dose": "2 mg/kg IM q24h",
                "notes": "For avian nausea/crop stasis",
                "notes_ja": "鳥の悪心/素嚢うっ滞に",
            },
            "hedgehog": {
                "dose": "1-2 mg/kg SC q24h",
                "notes": "For nausea associated with GI disease",
                "notes_ja": "消化管疾患に伴う悪心に",
            },
        },
    ...
    },
    {
        ...
        "species_info": {
            "rabbit": {
                "dose": "0.5 mg/kg PO q8-12h",
                "notes": "Essential for GI stasis treatment; combine with metoclopramide",
                "notes_ja": "消化管うっ滞治療に不可欠；メトクロプラミドと併用",
            },
            "guinea_pig": {
                "dose": "0.5 mg/kg PO q8-12h",
                "notes": "For GI stasis and post-anesthetic ileus",
                "notes_ja": "消化管うっ滞および麻酔後イレウスに",
            },
            "chinchilla": {
                "dose": "0.5 mg/kg PO q8-12h",
                "notes": "For GI stasis; combine with syringe feeding",
                "notes_ja": "消化管うっ滞に；シリンジ給餌と併用",
            },
            "hedgehog": {
                "dose": "0.25-0.5 mg/kg PO q12h",
                "notes": "For GI motility disorders",
                "notes_ja": "消化管運動障害に",
            },
            "reptile": {
                "dose": "0.5-2 mg/kg PO q24-48h",
                "notes": "For post-brumation anorexia/ileus",
                "notes_ja": "冬眠後食欲不振/イレウスに",
            },
            "tortoise": {
                "dose": "0.5-1 mg/kg PO q24-48h",
                "notes": "For post-hibernation GI recovery",
                "notes_ja": "冬眠後消化管回復に",
            },
        },
        ...
        "drug_interactions": [
            {
                "drug": "Ketoconazole",
                "effect": "Increases cisapride levels; cardiac arrhythmia risk",
                "severity": "major",
            },
    ...
    },
    {
        ...
        "species_info": {
            "rabbit": {
                "dose": "0.02-0.05 mg/kg SC/IV q6-12h; OTM 0.1-0.2 mg/kg q8h",
                "notes": "OTM (oral transmucosal) route effective in rabbits",
                "notes_ja": "OTM（口腔粘膜経由）投与がウサギで有効",
            },
            "guinea_pig": {
                "dose": "0.05 mg/kg SC q8-12h",
                "notes": "Short duration in guinea pigs; frequent dosing needed",
                "notes_ja": "モルモットでは持続が短い；頻回投与が必要",
            },
            "hamster": {
                "dose": "0.05-0.1 mg/kg SC q8-12h",
                "notes": "Primary analgesic for hamsters",
                "notes_ja": "ハムスターの主要鎮痛薬",
            },
            "ferret": {
                "dose": "0.01-0.03 mg/kg SC/IM q8-12h",
                "notes": "Good for post-surgical pain in ferrets",
                "notes_ja": "フェレットの術後疼痛に良好",
            },
            "hedgehog": {
                "dose": "0.01-0.05 mg/kg SC q8-12h",
                "notes": "For post-surgical pain, trauma",
                "notes_ja": "術後疼痛、外傷に",
            },
            "bird": {
                "dose": "0.1-0.5 mg/kg IM q8-12h",
                "notes": "Variable efficacy across avian species",
                "notes_ja": "鳥種間で有効性にばらつき",
            },
            "reptile": {
                "dose": "0.02-0.1 mg/kg IM q24h",
                "notes": "Thermal-dependent metabolism; prolonged action",
                "notes_ja": "温度依存性代謝；作用が延長",
            },
        },
        ...
        "drug_interactions": [
            {
                "drug": "Full mu-agonists (morphine)",
                "effect": "May reduce efficacy of full agonist",
                "severity": "moderate",
            },
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                ...
                "notes": "First-line for canine TCC/bladder carcinoma; combine with misoprostol for GI protection",
                "notes_ja": "犬の移行上皮癌/膀胱癌の第一選択；GI保護にミソプロストールと併用",
            }
        },
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "2.75 mg/kg PO q48h (MWF schedule common)",
                "notes": "FDA-approved for canine MCT; also used for anal sac adenocarcinoma, thyroid carcinoma",
                "notes_ja": "犬の肥満細胞腫でFDA承認；肛門嚢腺癌、甲状腺癌にも使用",
            },
            "cat": {
                "dose": "2.5 mg/kg PO q48h",
                "notes": "Off-label for feline oral SCC, intestinal lymphoma; monitor closely",
                "notes_ja": "猫の口腔扁平上皮癌、腸管リンパ腫にオフラベル使用；厳重なモニタリング",
            },
        },
        ...
        "drug_interactions": [
            ...
            {
                "drug": "ACE inhibitors",
                "effect": "Additive hypotension; but may help proteinuria",
                "severity": "moderate",
            },
        ],
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "Loading: 25-50 mg/kg/day PO divided × 7-14 days; Maintenance: 25-50 mg/kg/week PO",
                "notes": "For canine pituitary-dependent hyperadrenocorticism; monitor ACTH stim test",
                "notes_ja": "犬の下垂体性副腎皮質機能亢進症に；ACTH刺激試験でモニタリング",
            }
        },
        ...
        "drug_interactions": [
            {
                "drug": "Phenobarbital",
                "effect": "Increases mitotane metabolism (may need higher dose)",
                "severity": "moderate",
            },
    ...
    },
    {
        ...
        "species_info": {
            "horse": {
                "dose": "5-25 mg/kg IV slow; may repeat q6-8h",
                "notes": "For exertional rhabdomyolysis (tying up); also tetanus adjunct",
                "notes_ja": "運動性横紋筋融解症（タイイングアップ）に；破傷風の補助にも",
            },
            "rabbit": {
                "dose": "Not commonly used",
                "notes": "Limited data in rabbits",
                "notes_ja": "ウサギでのデータ限定的",
            },
            "bird": {
                "dose": "Not recommended",
                "notes": "Insufficient safety data in avian species",
                "notes_ja": "鳥類での安全性データ不足",
            },
        },
        ...
        "drug_interactions": [{"drug": "CNS depressants", "effect": "Additive sedation", "severity": "moderate"}],
    },
]
