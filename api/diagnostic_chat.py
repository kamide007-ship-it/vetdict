...
EQUINE_SYMPTOM_ALIASES: dict[str, str | tuple[str, ...]] = {
    ...
    "足を引きずる": "limb_lameness_fore",
    "脚を引きずる": "limb_lameness_fore",
    "足を引きずって": "limb_lameness_fore",
    # 非負重跛行（急性の完全免重 — 蹄膿瘍/骨折/蹄葉炎の救急主訴。
    # 肢は特定できないため fore に解決し hot-hoof/膿瘍ddxファミリーへ）
    "足を着けな": "limb_lameness_fore",
    "足をつけな": "limb_lameness_fore",
    "片足を着け": "limb_lameness_fore",
    "片足をつけ": "limb_lameness_fore",
    "足を全く着け": "limb_lameness_fore",
    "non-weight bearing": "limb_lameness_fore",
    ...
    "喘鳴": "resp_stridor",
    "異常呼吸音": "resp_stridor",
    # 馬喘息（IAD/RAO）の飼い主表現: 喘鳴音・運動時の咳（Reed & Bayly 4th ed）
    "ゼーゼー": "resp_abnormal_lung_sounds",
    "ぜーぜー": "resp_abnormal_lung_sounds",
    "ヒューヒュー": "resp_abnormal_lung_sounds",
    "運動すると咳": "resp_cough_at_exercise",
    "運動後に咳": "resp_cough_at_exercise",
    "運動中に咳": "resp_cough_at_exercise",
    "運動時の咳": "resp_cough_at_exercise",
    ...
    "流涎": "dig_salivation",
    "よだれ": "dig_salivation",
    # 食道閉塞（チョーク）の主訴 — 嚥下不能は流涎として発現（dysphagia proxy）
    "飲み込め": "dig_salivation",
    "飲み込まない": "dig_salivation",
    "嚥下困難": "dig_salivation",
