...
DRUG_INTERACTIONS_PATCH_26: dict[str, list[dict]] = {
    ...
    "atropine_ophthalmic": [
        ...
        {
            "drug": "Latanoprost",
            "effect": "Opposing effects on pupil size; clinical interaction minor",
            "severity": "minor",
        },
    ],
    "bedinvetmab": [
        {
            "drug": "Other monoclonal antibodies",
            "effect": "No known interactions; biologics minimally interact with small molecules",
            "severity": "minor",
        },
    ...
    "calcium_edta": [
        {
            ...
            "effect": "CaNa2EDTA chelates zinc; supplement zinc after course",
            "severity": "moderate",
        },
    ...
    "capromorelin_oral": [
        ...
        {
            "drug": "GH-suppressing drugs (octreotide)",
            "effect": "Antagonizes ghrelin-mediated GH release",
            "severity": "moderate",
        },
    ],
    "cefpodoxime": [
    ...
    "ceftiofur": [
        {"drug": "Aminoglycosides", "effect": "Synergistic bactericidal activity", "severity": "minor"},
        {
            ...
            "effect": "May antagonize bactericidal effect (bacteriostatic competition)",
            "severity": "moderate",
        },
    ],
    "cetirizine": [
        {
            ...
            "effect": "Minimal additive sedation (less sedating than first-gen)",
            "severity": "minor",
        },
    ...
    "cloprostenol": [
        {
            "drug": "Progestins (altrenogest)",
            "effect": "Antagonistic—PGF2α lyses CL against progestin maintenance",
            "severity": "major",
        },
        {
            "drug": "NSAIDs",
            "effect": "Prostaglandin synthesis inhibitors may reduce cloprostenol-like effects",
            "severity": "moderate",
        },
    ],
    "clotrimazole": [
        {
            ...
            "effect": "Topical with negligible systemic absorption",
            "severity": "minor",
        }
    ],
    "cyclosporine_ophthalmic": [
        {
            "drug": "No significant systemic interactions",
            "effect": "Ophthalmic formulation has minimal systemic absorption",
            "severity": "minor",
        },
    ...
    "cytopoint": [
        {
            ...
            "effect": "Monoclonal antibody; does not use CYP metabolism",
            "severity": "minor",
        },
        {"drug": "Corticosteroids", "effect": "Can be used concurrently during transition", "severity": "minor"},
        {
            "drug": "Oclacitinib",
            "effect": "Can be used concurrently; may allow dose reduction of either",
            "severity": "minor",
        },
    ],
    "deferoxamine": [
        {
            "drug": "Vitamin C (high dose)",
            "effect": "May increase iron toxicity by mobilizing tissue iron",
            "severity": "moderate",
        },
    ...
    "dorzolamide": [
        {
            "drug": "Oral carbonic anhydrase inhibitors",
            "effect": "Additive carbonic anhydrase inhibition; systemic acidosis risk",
            "severity": "moderate",
        },
        {
            "drug": "High-dose aspirin",
            "effect": "Theoretical additive acidosis (salicylate mechanism)",
            "severity": "minor",
        },
    ],
    "ethanol_antidote": [
        {
            "drug": "CNS depressants",
            "effect": "Additive CNS depression; monitor respiratory function",
            "severity": "major",
        },
        {
            "drug": "Fomepizole",
            "effect": "Both compete at ADH; choose one—fomepizole preferred",
            "severity": "moderate",
        },
    ],
    "fomepizole": [
        ...
        {
            "drug": "No significant drug interactions",
            "effect": "Specific ADH inhibitor with minimal other interactions",
            "severity": "minor",
        },
    ],
    "florfenicol": [
        {
            "drug": "Chloramphenicol",
            "effect": "Same class—do not combine; additive bone marrow effects",
            "severity": "major",
        },
    ...
    "frunevetmab": [
        {
            "drug": "No significant drug interactions",
            "effect": "Anti-NGF monoclonal antibody; no CYP metabolism",
            "severity": "minor",
        },
    ...
    "ivermectin_oral": [
        {
            "drug": "P-glycoprotein substrates/inhibitors (ketoconazole, spinosad)",
            "effect": "Increased ivermectin CNS levels; neurotoxicity risk",
            "severity": "major",
        },
        {
            "drug": "Spinosad (Comfortis)",
            "effect": "Case reports of ivermectin toxicity when combined",
            "severity": "major",
        },
    ],
    "ketoprofen": [
    ...
    "mupirocin": [
        {
            "drug": "No significant systemic interactions",
            "effect": "Topical antibiotic with negligible absorption",
            "severity": "minor",
        }
    ],
    "mycophenolate": [
    ...
    "oclacitinib": [
        {
            ...
            "effect": "Additive immunosuppression; avoid long-term combination",
            "severity": "moderate",
        },
    ...
    "omega_3_fatty_acids": [
        {
            "drug": "Anticoagulants",
            "effect": "High doses may increase bleeding risk (antiplatelet effect)",
            "severity": "moderate",
        },
        {
            "drug": "NSAIDs",
            "effect": "May synergistically reduce inflammation; positive interaction",
            "severity": "minor",
        },
    ],
    "oxymorphone_injectable": [
        ...
        {
            "drug": "MAO inhibitors",
            "effect": "Potentiated opioid effects; serotonin syndrome risk",
            "severity": "major",
        },
    ...
    "phenylbutazone_equine": [
        {
            "drug": "Other NSAIDs",
            "effect": "Dramatically increased GI ulceration risk; never combine",
            "severity": "major",
        },
        {
            "drug": "Warfarin",
            "effect": "Displaces warfarin from protein binding; severe bleeding risk",
            "severity": "major",
        },
    ...
    "propofol_injectable": [
        {
            "drug": "Opioids",
            "effect": "Reduced propofol dose needed; additive respiratory depression",
            "severity": "moderate",
        },
        {
            "drug": "Benzodiazepines",
            "effect": "Synergistic sedation; reduce propofol dose 20-50%",
            "severity": "moderate",
        },
    ...
    "psyllium_husk": [
        {
            ...
            "effect": "May reduce absorption of co-administered drugs; space 2h",
            "severity": "moderate",
        }
    ],
    "ranitidine_injectable": [
        ...
        {
            "drug": "Procainamide",
            "effect": "Increases procainamide levels (reduced renal clearance)",
            "severity": "moderate",
        },
    ],
    "rutin": [
        {
            "drug": "Anticoagulants",
            "effect": "Theoretical enhanced anticoagulant effect (capillary stabilizer)",
            "severity": "minor",
        }
    ],
    "selamectin_topical": [
        {
            "drug": "No significant drug interactions",
            "effect": "Avermectin with topical application; safe in MDR1 dogs at labeled dose",
            "severity": "minor",
        }
    ],
    "silver_sulfadiazine_topical": [
        {
            ...
            "effect": "Silver may inactivate collagenase/papain",
            "severity": "moderate",
        }
    ],
    "tacrolimus_systemic": [
        {
            ...
            "effect": "Markedly increases tacrolimus levels (CYP3A4 inhibition)",
            "severity": "major",
        },
    ...
    "zonisamide_oral": [
        {
            "drug": "Phenobarbital",
            "effect": "Increases zonisamide clearance; higher dose may be needed",
            "severity": "moderate",
        },
        {
            "drug": "Carbonic anhydrase inhibitors",
            "effect": "Additive risk of kidney stones and metabolic acidosis",
            "severity": "moderate",
        },
    ],
    "topiramate": [
        ...
        {
            "drug": "Carbonic anhydrase inhibitors",
            "effect": "Additive acidosis and nephrolithiasis risk",
            "severity": "moderate",
        },
    ...
    "lomustine_oral": [
        {
            ...
            "effect": "Additive/delayed bone marrow suppression",
            "severity": "major",
        },
    ...
    "mavacoxib": [
        ...
        {"drug": "Corticosteroids", "effect": "Increased GI toxicity", "severity": "major"},
        {
            ...
            "effect": "Potential displacement; mavacoxib is >98% protein-bound",
            "severity": "moderate",
        },
    ],
    "tepoxalin_oral": [
    ...
    "flunixin_paste": [
        ...
        {
            "drug": "Corticosteroids",
            "effect": "Dramatically increased GI ulceration risk in horses",
            "severity": "major",
        },
    ...
    "alfaxalone_injectable": [
        {"drug": "Opioids", "effect": "Synergistic CNS depression; reduce alfaxalone dose", "severity": "moderate"},
        {
            ...
            "effect": "Significant dose reduction of alfaxalone needed",
            "severity": "moderate",
        },
        {
            "drug": "Benzodiazepines",
            "effect": "Additive sedation; co-induction allows lower doses",
            "severity": "moderate",
        },
    ],
    "fentanyl_patch": [
        ...
        {"drug": "MAO inhibitors", "effect": "Severe serotonin syndrome risk", "severity": "major"},
        {
            ...
            "effect": "Increased fentanyl levels; toxicity risk",
            "severity": "major",
        },
    ],
    "butorphanol_injectable": [
        {
            ...
            "effect": "Partial antagonism; may reduce analgesia from full agonist",
            "severity": "moderate",
        },
    ...
    "buprenorphine_injectable": [
        {
            "drug": "Full mu-agonists",
            "effect": "Partial agonist may precipitate withdrawal or reduce full agonist effect",
            "severity": "moderate",
        },
    ...
    "misoprostol_gastro": [
        {
            "drug": "NSAIDs",
            "effect": "Gastroprotective when co-administered; intended combination",
            "severity": "minor",
        },
    ...
    "pentosan_polysulfate": [
        {
            "drug": "Anticoagulants",
            "effect": "Additive bleeding risk (weak anticoagulant properties)",
            "severity": "moderate",
        },
    ...
    "omeprazole_oral": [
        ...
        {
            "drug": "Ketoconazole/itraconazole",
            "effect": "Reduced antifungal absorption (needs acid)",
            "severity": "major",
        },
    ...
    "dexmedetomidine_oromucosal": [
        {
            "drug": "Other CNS depressants",
            "effect": "Additive sedation; reduce doses of co-administered agents",
            "severity": "moderate",
        },
        {
            "drug": "Potentiated sulfonamides IV",
            "effect": "Fatal arrhythmias in horses (alpha-2 class effect)",
            "severity": "major",
        },
    ...
    "imidacloprid_topical": [
        {
            "drug": "No significant drug interactions",
            "effect": "Topical ectoparasiticide with minimal systemic absorption",
            "severity": "minor",
        }
    ],
    "permethrin_topical": [
        {
            ...
            "effect": "CAUTION: TOXIC TO CATS—never apply to or near cats",
            "severity": "minor",
        }
    ],
    "ms222_fish": [
        {
            "drug": "No significant drug interactions",
            "effect": "Fish-specific immersion anesthetic",
            "severity": "minor",
        }
    ],
    "eugenol_fish": [
    ...
    "oxyglobin": [
        {
            "drug": "No significant drug interactions",
            "effect": "Hemoglobin-based oxygen carrier; interferes with some lab assays",
            "severity": "minor",
        }
    ],
    ...
    "methionine_urinary": [
        {
            "drug": "Urinary alkalinizers (K citrate)",
            "effect": "Antagonistic—opposing pH effects",
            "severity": "moderate",
        }
    ],
    "potassium_citrate": [
    ...
    "propantheline": [
        {
            ...
            "effect": "Additive anticholinergic effects (dry mouth, urinary retention, tachycardia)",
            "severity": "moderate",
        },
