...
DRUGS_BATCH_67 = [
    {
        ...
        "species_info": {
            "cat": {
                ...
                "notes": "Screen FIRST: biochemistry to rule out liver disease, glucose/history to rule out diabetes (both preclude use — see exclusions), echo to confirm subclinical status. Monitor ALT/AST every 1-2 months initially, then every 6-12 months; discontinue immediately if diabetes mellitus develops (one trial cat progressed to fatal DKA). May blunt response to LIVE vaccines (killed rabies response was adequate).",
                "notes_ja": "投与前スクリーニング必須: 生化学検査で肝疾患を除外・血糖/病歴で糖尿病を除外（いずれも投与不可の除外基準）、心エコーで無症候性ステージを確認。ALT/AST は開始後1-2ヶ月毎→安定後6-12ヶ月毎に監視。治療中に糖尿病を発症したら直ちに中止（治験中1例が致死的DKAへ進行）。生ワクチンへの免疫応答を減弱させうる（不活化狂犬病ワクチンの応答は保たれた）。",
            },
            "dog": {
                "safe": False,
