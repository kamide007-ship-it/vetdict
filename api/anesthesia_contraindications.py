...
DRUG_CONTRAINDICATIONS = [
    ...
    # === Reptile-specific ===
    {
        ...
        "severity": SEVERITY_MONITOR,
        "message_ja": "ケタミンは爬虫類で腎排泄。腎門脈系を考慮し後肢注射を避ける（前肢に投与）。腎疾患時は用量減量",
        "message_en": "Ketamine is renally excreted in reptiles. Avoid hind limb injection due to renal portal system (use forelimb). Reduce dose in renal disease",
    },
]
