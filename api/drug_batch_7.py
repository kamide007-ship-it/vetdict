...
CHINCHILLA_SPECIES_PATCH: dict[str, dict[str, dict]] = {
    ...
    "cefazolin": {
        "chinchilla": {
            "safe": True,
            "dosage": "20-40 mg/kg SC/IM q8-12h",
            "dosage_ja": "20-40 mg/kg 皮下/筋注 8-12時間毎",
    ...
    "ceftriaxone": {
        "chinchilla": {
            "safe": True,
            "dosage": "20-40 mg/kg SC/IM q12-24h",
            "dosage_ja": "20-40 mg/kg 皮下/筋注 12-24時間毎",
    ...
    "fluralaner": {
        "chinchilla": {
            "safe": True,
            "dosage": "25 mg/kg PO once (off-label)",
            "dosage_ja": "25 mg/kg 経口 単回（適応外使用）",
    ...
    "toltrazuril": {
        "chinchilla": {
            "safe": True,
            "dosage": "10 mg/kg PO q24h × 3 days",
            "dosage_ja": "10 mg/kg 経口 24時間毎 × 3日",
    ...
    "fentanyl": {
        "chinchilla": {
            "safe": True,
            "dosage": "0.02-0.05 mg/kg SC/IM",
            "dosage_ja": "0.02-0.05 mg/kg 皮下/筋注",
    ...
    "morphine": {
        "chinchilla": {
            "safe": True,
            "dosage": "2-5 mg/kg SC/IM q4h",
            "dosage_ja": "2-5 mg/kg 皮下/筋注 4時間毎",
    ...
    "atipamezole": {
        "chinchilla": {
            "safe": True,
            "dosage": "Equal volume to dexmedetomidine, IM",
            "dosage_ja": "デクスメデトミジンと等量 筋注",
    ...
    "acepromazine": {
        "chinchilla": {
            "safe": True,
            "dosage": "0.5-1.0 mg/kg SC/IM",
            "dosage_ja": "0.5-1.0 mg/kg 皮下/筋注",
    ...
    "propofol": {
        "chinchilla": {
            ...
            "dosage_ja": "5-10 mg/kg 緩徐静注（効果発現まで）",
    ...
    "ursodiol": {
        "chinchilla": {
            "safe": True,
            "dosage": "15-20 mg/kg PO q24h",
            "dosage_ja": "15-20 mg/kg 経口 24時間毎",
    ...
    "amlodipine": {
        "chinchilla": {
            "safe": True,
            "dosage": "0.1-0.2 mg/kg PO q24h",
            "dosage_ja": "0.1-0.2 mg/kg 経口 24時間毎",
    ...
    "insulin": {
        "chinchilla": {
            "safe": True,
            "dosage": "0.5-2 IU/kg SC q12-24h (start low)",
            "dosage_ja": "0.5-2 IU/kg 皮下 12-24時間毎（低用量で開始）",
    ...
    "calcium_gluconate": {
        "chinchilla": {
            "safe": True,
            "dosage": "50-100 mg/kg IV slow or SC diluted",
            "dosage_ja": "50-100 mg/kg 緩徐静注 または 皮下（希釈）",
    ...
    "ketoconazole": {
        "chinchilla": {
            "safe": True,
            "dosage": "10-15 mg/kg PO q24h × 4-6 weeks",
            "dosage_ja": "10-15 mg/kg 経口 24時間毎 × 4-6週間",
    ...
    "nystatin": {
        "chinchilla": {
            "safe": True,
            "dosage": "100,000 IU/kg PO q8-12h",
            "dosage_ja": "100,000 IU/kg 経口 8-12時間毎",
    ...
    "levetiracetam": {
        "chinchilla": {
            "safe": True,
            "dosage": "20-40 mg/kg PO q8-12h",
            "dosage_ja": "20-40 mg/kg 経口 8-12時間毎",
    ...
    "chlorhexidine": {
        "chinchilla": {
            "safe": True,
            "dosage": "0.05% solution topical",
            "dosage_ja": "0.05%溶液 局所使用",
    ...
    "oxytocin": {
        "chinchilla": {
            "safe": True,
            "dosage": "0.5-3 IU/kg SC/IM",
            "dosage_ja": "0.5-3 IU/kg 皮下/筋注",
    ...
    "aluminum_hydroxide": {
        "chinchilla": {
            "safe": True,
            "dosage": "30 mg/kg PO q8h with food",
            "dosage_ja": "30 mg/kg 経口 8時間毎（食事と共に）",
