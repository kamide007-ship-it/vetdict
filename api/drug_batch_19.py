...
DRUGS_BATCH_19 = [
    {
        ...
        "species_info": {
            "dog": {
                "dose": "0.4-0.6 mg/kg PO q12h×14日、以後q24h",
                "notes_ja": "犬アトピー性皮膚炎の第一選択。即効性（4時間以内）。12ヶ月齢以上",
                "notes": "First-line canine atopic dermatitis. Rapid onset (<4h). Dogs ≥12 months old",
            }
        },
        ...
        "drug_interactions": [
            {
                "drug": "ciclosporin",
                "severity": "moderate",
                "description_ja": "免疫抑制の相加。併用エビデンス限定",
                "description": "Additive immunosuppression. Limited combination data",
            },
            {
                "drug": "corticosteroids",
                "severity": "moderate",
                "description_ja": "免疫抑制増強。短期併用のみ",
                "description": "Enhanced immunosuppression. Short-term overlap only",
            },
        ],
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "5 mg/kg PO q24h（空腹時）; 4-6週で効果判定",
                "notes_ja": "アトピー性皮膚炎・肛門周囲瘻・IMHA/ITP（プレドニゾロン併用）",
                "notes": "Atopic dermatitis, perianal fistula, IMHA/ITP (with prednisolone)",
            },
            "cat": {
                "dose": "7 mg/kg PO q24h",
                "notes_ja": "猫のアレルギー性皮膚炎・好酸球性肉芽腫症候群・IBD",
                "notes": "Feline allergic dermatitis, eosinophilic granuloma complex, IBD",
            },
            "horse": {
                "dose": "2-5 mg/kg PO q12-24h",
                "notes_ja": "免疫介在性角膜炎",
                "notes": "Immune-mediated keratitis",
            },
        ...
        "drug_interactions": [
            {
                "drug": "ketoconazole",
                "severity": "major",
                "description_ja": "シクロスポリン血中濃度上昇（意図的に用量削減に利用可）",
                "description": "Increased CsA levels (intentionally used for dose reduction)",
            },
            {
                "drug": "nsaids",
                "severity": "moderate",
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "22-30 mg/kg PO q12h",
                "notes_ja": "膿皮症第一選択。UTI・軟部組織感染。3-4週間（深在性膿皮症は6-8週）",
                "notes": "First-line pyoderma. UTI, soft tissue infections. 3-4 weeks (deep: 6-8 weeks)",
            },
            "cat": {
                "dose": "15-25 mg/kg PO q12h",
                "notes_ja": "皮膚感染・UTI。猫は味を嫌がる場合あり",
                "notes": "Skin infections, UTI. Cats may dislike taste",
            },
            "horse": {
                "dose": "30 mg/kg PO q8h",
                "notes_ja": "軟部組織感染。経口バイオアベイラビリティ低い",
                "notes": "Soft tissue infections. Low oral bioavailability",
            },
            "rabbit": {
                "dose": "15-25 mg/kg PO q8-12h",
                "notes_ja": "皮膚感染。腸内細菌叢への影響は少ない",
                "notes": "Skin infections. Less GI microbiome disruption",
            },
            "guinea_pig": {
                "dose": "25 mg/kg PO q12h",
                "notes_ja": "皮膚感染。ペニシリン系より安全",
                "notes": "Skin infections. Safer than penicillins",
            },
            "ferret": {
                "dose": "15-25 mg/kg PO q8-12h",
                "notes_ja": "皮膚・軟部組織感染",
            ...
            "bird": {
                "dose": "35-50 mg/kg PO q6-8h",
                "notes_ja": "グラム陽性菌感染",
                "notes": "Gram-positive infections",
            },
        },
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "8 mg/kg SC 1回（効果14日間）",
                "notes_ja": "膿皮症・UTI・創傷感染。経口投与困難な場合。注射後14日間撤回不可",
                "notes": "Pyoderma, UTI, wound infections. When oral dosing difficult. Cannot withdraw after injection",
            },
            "cat": {
                "dose": "8 mg/kg SC 1回（効果14日間）",
                "notes_ja": "猫の皮膚感染・UTI。投薬困難な猫に有用。腎排泄→腎不全で半減期延長",
                "notes": "Feline skin infections, UTI. Useful for difficult-to-medicate cats. Renal excretion",
            },
            "rabbit": {
                "dose": "8 mg/kg SC（14日間効果）",
                "notes_ja": "投薬困難なウサギに有用",
                "notes": "Useful for difficult-to-medicate rabbits",
            },
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "患部に薄く塗布 q8-12h × 7-14日",
                "notes_ja": "表在性膿皮症・MRSA局所感染・皮膚創傷感染",
                "notes": "Surface pyoderma, localized MRSA, wound infections",
            },
            "cat": {
                "dose": "患部に薄く塗布 q8-12h",
                "notes_ja": "猫の局所皮膚感染。PEG含有製剤は猫で経口毒性→舐めさせない",
                "notes": "Localized skin infections. PEG-containing formulations toxic if ingested by cats",
            },
        },
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "患部に1-2mm厚で塗布 q12-24h",
                "notes_ja": "熱傷・広範囲創傷・皮膚移植部位",
                "notes": "Burns, extensive wounds, skin graft sites",
            },
            "cat": {
                "dose": "患部に塗布 q12-24h",
                "notes_ja": "熱傷・創傷。舐め防止にカラー装着",
                "notes": "Burns, wounds. E-collar to prevent licking",
            },
            ...
            "reptile": {
                "dose": "患部に塗布 q24h",
                "notes_ja": "爬虫類の火傷・皮膚感染",
                "notes": "Reptilian burns, skin infections",
            },
        },
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "2-4%シャンプー: 週2-3回; 0.05%溶液: 洗浄用",
                "notes_ja": "膿皮症・マラセチア皮膚炎の局所療法。2%+ミコナゾール2%併用シャンプーが効果的",
                "notes": "Pyoderma, Malassezia dermatitis. 2% + miconazole 2% combination shampoo effective",
            },
            "cat": {
                "dose": "2%シャンプー/溶液",
                "notes_ja": "皮膚感染の局所療法。猫は4%で口腔刺激性あり→2%推奨",
                "notes": "Topical for skin infections. Cats: use 2% (4% causes oral irritation)",
            },
            "horse": {
                "dose": "2-4%溶液/スクラブ",
                "notes_ja": "術前皮膚消毒・創傷洗浄",
                "notes": "Preoperative skin antisepsis, wound irrigation",
            },
            "rabbit": {
                "dose": "0.05-2%溶液",
                "notes_ja": "創傷洗浄・皮膚感染",
                "notes": "Wound irrigation, skin infections",
            },
            "bird": {
                "dose": "0.05%希釈溶液",
                "notes_ja": "創傷洗浄。高濃度は毒性あり",
                "notes": "Wound irrigation. High concentrations toxic",
            },
            "reptile": {
                "dose": "0.05-0.5%溶液",
                "notes_ja": "創傷洗浄・シェルロット",
                "notes": "Wound irrigation, shell rot",
            },
        },
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "2%シャンプー/クリーム/ローション q12-24h",
                "notes_ja": "マラセチア皮膚炎・皮膚糸状菌症の局所治療。クロルヘキシジンとの併用が効果的",
                "notes": "Malassezia dermatitis, dermatophytosis topical. Effective with chlorhexidine",
            },
            "cat": {
                "dose": "2%クリーム/ローション q12-24h",
                "notes_ja": "猫の皮膚糸状菌症局所治療",
                "notes": "Feline dermatophytosis topical",
            },
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "EPA 40-70 mg/kg/day + DHA 25-45 mg/kg/day",
                "notes_ja": "アトピー性皮膚炎補助・OA・CKD・心疾患。効果発現に6-8週",
                "notes": "Atopic dermatitis adjunct, OA, CKD, cardiac disease. 6-8 weeks for effect",
            },
            "cat": {
                "dose": "EPA 30-40 mg/kg/day + DHA 20-25 mg/kg/day",
                "notes_ja": "CKD（IRIS推奨）・アトピー・OA。魚油カプセルで投与",
                "notes": "CKD (IRIS recommended), atopy, OA. Fish oil capsules",
            },
            "horse": {
                "dose": "フラキシードオイル 100-200 mL/day",
                "notes_ja": "皮膚の健康維持・炎症性疾患補助",
                "notes": "Skin health, inflammatory disease adjunct",
            },
            "bird": {
                "dose": "フラキシードオイル 0.1-0.5 mL/kg/day",
                "notes_ja": "羽毛の健康維持・皮膚疾患",
                "notes": "Feather health, skin disease",
            },
        },
        ...
        "drug_interactions": [
            {
                "drug": "warfarin",
                "severity": "minor",
                "description_ja": "出血リスクの軽度増加",
                "description": "Mildly increased bleeding risk",
            }
        ],
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "グルコサミン 20 mg/kg/day + コンドロイチン 15 mg/kg/day",
                "notes_ja": "OA補助療法。NSAIDsとの併用で相乗効果。効果発現に4-8週",
                "notes": "OA adjunct. Synergistic with NSAIDs. 4-8 weeks for effect",
            },
            "cat": {
                "dose": "グルコサミン 125-250 mg/cat/day",
                "notes_ja": "猫のOA補助。FISS猫では軟骨保護の報告",
                "notes": "Feline OA adjunct",
            },
            "horse": {
                "dose": "グルコサミン 10-20 mg/kg/day PO",
                "notes_ja": "OA・関節軟骨保護",
                "notes": "OA, articular cartilage protection",
            },
            "rabbit": {
                "dose": "グルコサミン 20 mg/kg/day",
                "notes_ja": "スナッフル後の関節炎",
                "notes": "Post-snuffles arthritis",
            },
        },
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "製品に依存; E. faecium SF68: 1×10^8 CFU/day",
                "notes_ja": "急性胃腸炎・抗生物質関連下痢・IBD補助。Enterococcus faecium SF68に最もエビデンスあり",
                "notes": "Acute GI, antibiotic-associated diarrhea, IBD adjunct. Best evidence for E. faecium SF68",
            },
            "cat": {
                "dose": "製品に依存; E. faecium SF68: 1×10^8 CFU/day",
                "notes_ja": "急性胃腸炎・ストレス関連下痢。猫用製品を使用",
                "notes": "Acute GI, stress-related diarrhea. Use feline-specific products",
            },
            "horse": {
                "dose": "Saccharomyces boulardii 10-25 g/day",
                "notes_ja": "抗生物質関連下痢・子馬の下痢",
                "notes": "Antibiotic-associated diarrhea, foal diarrhea",
            },
            "rabbit": {
                "dose": "S. boulardii, E. faecium; 製品に依存",
                "notes_ja": "GI stasis後・抗生物質後の腸内環境回復",
                "notes": "Post-GI stasis, post-antibiotic microbiome restoration",
            },
            "guinea_pig": {
                "dose": "製品に依存",
                "notes_ja": "抗生物質後の腸内環境回復",
                "notes": "Post-antibiotic recovery",
            },
            "chinchilla": {"dose": "製品に依存", "notes_ja": "抗生物質後", "notes": "Post-antibiotic"},
            "bird": {
                "dose": "Lactobacillus spp.; 飲水添加",
                "notes_ja": "抗生物質後・ストレス後",
                "notes": "Post-antibiotic, post-stress",
            },
        },
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "250-1500 μg SC/IM q7日×6週、以後月1回",
                "notes_ja": "EPI・IBD・慢性腸疾患でのB12欠乏。血清コバラミン<300 ng/Lで補充",
                "notes": "EPI, IBD, chronic enteropathy B12 deficiency. Supplement if serum <300 ng/L",
            },
            "cat": {
                "dose": "250 μg SC q7日×6週、以後月1回",
                "notes_ja": "猫の慢性腸疾患・三臓器炎でのB12欠乏。予後因子としても重要",
                "notes": "Chronic enteropathy, triaditis B12 deficiency. Also prognostic marker",
            },
            "rabbit": {"dose": "250 μg SC q7日", "notes_ja": "慢性GI疾患", "notes": "Chronic GI disease"},
            "ferret": {
                "dose": "250 μg SC q7日",
                "notes_ja": "IBDに伴うB12欠乏",
                "notes": "IBD-associated B12 deficiency",
            },
        },
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "1.5-3.5 ng/kg PO q24h",
                "notes_ja": "CKDステージ3-4の二次性上皮小体機能亢進症。iCa・リン・PTHモニタリング必須",
                "notes": "CKD stage 3-4 secondary hyperparathyroidism. Monitor iCa, phosphorus, PTH",
            },
            "cat": {
                "dose": "1.5-3.5 ng/kg PO q24h",
                "notes_ja": "猫のCKDに伴う二次性副甲状腺機能亢進症",
                "notes": "CKD secondary hyperparathyroidism",
            },
            "reptile": {
                "dose": "データ限定的; UVB照射が第一選択",
                "notes_ja": "MBDにはUVB照射が優先。カルシトリオールは補助",
                "notes": "UVB lighting preferred for MBD. Calcitriol is adjunctive",
            },
            "bird": {
                "dose": "データ限定的",
                "notes_ja": "代謝性骨疾患の補助",
                "notes": "Metabolic bone disease adjunct",
            },
        },
        ...
        "drug_interactions": [
            {
                "drug": "thiazide_diuretics",
                "severity": "moderate",
                "description_ja": "高カルシウム血症リスク",
                "description": "Hypercalcemia risk",
            }
        ],
    },
    {
        ...
        "species_info": {
            "cat": {
                "dose": "0.5 mg/kg 局所（スポットオン）; ブロードライン配合",
                "notes_ja": "猫のフィラリア予防・消化管寄生虫・外部寄生虫。ブロードライン（fipronil+S-methoprene+eprinomectin+praziquantel）配合",
                "notes": "Feline heartworm prevention, GI parasites, ectoparasites. Component of Broadline",
            },
            "horse": {
                "dose": "0.5 mg/kg 経皮投与（背線上）",
                "notes_ja": "牛用製品。馬でのオフラベル使用報告あり",
                "notes": "Cattle product. Off-label equine use reported",
            },
        },
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "5-10 mg/kg PO/SC 1回; エキノコックス: 5 mg/kg PO q24h×3日",
                "notes_ja": "条虫（瓜実条虫・エキノコックス）。ドロンタール配合（+ピランテル）",
                "notes": "Cestodes (Dipylidium, Echinococcus). Drontal combination (+pyrantel)",
            },
            "cat": {
                "dose": "5 mg/kg PO/SC 1回",
                "notes_ja": "条虫駆除。ドロンタール猫用（+ピランテル）",
                "notes": "Cestode treatment. Drontal for cats (+pyrantel)",
            },
            "horse": {
                "dose": "1-1.5 mg/kg PO 1回",
                "notes_ja": "馬の条虫（Anoplocephala perfoliata）",
                "notes": "Equine tapeworm (A. perfoliata)",
            },
            "rabbit": {
                "dose": "5-10 mg/kg PO/SC 1回; 14日後繰返し",
                "notes_ja": "ウサギの条虫",
                "notes": "Rabbit cestodes",
            },
            "bird": {"dose": "5-10 mg/kg PO 1回", "notes_ja": "鳥類の条虫", "notes": "Avian cestodes"},
            "reptile": {
                "dose": "5-8 mg/kg PO 1回; 14日後繰返し",
                "notes_ja": "爬虫類の条虫",
                "notes": "Reptilian cestodes",
            },
            "fish": {
                "dose": "2-10 mg/L 浴水 3-24h; PO 50 mg/kg 1回",
                "notes_ja": "魚の吸虫（ギロダクチルス・ダクチロギルス）",
                "notes": "Fish trematodes (Gyrodactylus, Dactylogyrus)",
            },
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "5-10 mg/kg PO 1回; 子犬: 2週齢から2週間隔で投与",
                "notes_ja": "回虫・鉤虫。子犬の定期駆虫（2/4/6/8週齢）。安全性高い",
                "notes": "Roundworms, hookworms. Puppy deworming schedule (2/4/6/8 weeks). Very safe",
            },
            "cat": {
                "dose": "5-10 mg/kg PO 1回",
                "notes_ja": "回虫・鉤虫。子猫の定期駆虫",
                "notes": "Roundworms, hookworms. Kitten deworming",
            },
            "horse": {
                "dose": "6.6 mg/kg PO 1回",
                "notes_ja": "大型円虫・小型円虫。子馬の駆虫プログラム",
                "notes": "Large/small strongyles. Foal deworming program",
            },
            "rabbit": {
                "dose": "5-10 mg/kg PO 1回; 14日後繰返し",
                "notes_ja": "蟯虫（Passalurus ambiguus）",
                "notes": "Pinworm (Passalurus ambiguus)",
            },
        ...
        "drug_interactions": [
            {
                "drug": "levamisole",
                "severity": "major",
                "description_ja": "毒性増強（同一作用点）",
                "description": "Enhanced toxicity (same site of action)",
            },
            {
                "drug": "piperazine",
                "severity": "major",
                "description_ja": "拮抗作用",
                "description": "Antagonistic effects",
            },
        ],
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "50 mg/kg PO q24h × 3-5日; ジアルジア: 50 mg/kg × 5日",
                "notes_ja": "回虫・鉤虫・鞭虫・ジアルジア・肺虫（Oslerus/Crenosoma）。安全マージン広い",
                "notes": "Roundworms, hookworms, whipworms, Giardia, lungworms. Wide safety margin",
            },
            "cat": {
                "dose": "50 mg/kg PO q24h × 3-5日",
                "notes_ja": "回虫・鉤虫・ジアルジア・肺虫（Aelurostrongylus）",
                "notes": "Roundworms, hookworms, Giardia, lungworm (Aelurostrongylus)",
            },
            "horse": {
                "dose": "5-10 mg/kg PO 1回; 子馬: 50 mg/kg（回虫）",
                "notes_ja": "小型円虫・回虫。子馬は高用量で回虫駆除",
                "notes": "Small strongyles, ascarids. Higher dose for foal ascarids",
            },
            "rabbit": {
                "dose": "20-50 mg/kg PO q24h × 5日",
                "notes_ja": "蟯虫・E. cuniculi（20 mg/kg × 28日）",
                "notes": "Pinworm, E. cuniculi (20 mg/kg × 28 days)",
            },
            "guinea_pig": {"dose": "20-50 mg/kg PO q24h × 5日", "notes_ja": "消化管寄生虫", "notes": "GI parasites"},
            "chinchilla": {
                "dose": "20-50 mg/kg PO q24h × 5日",
                "notes_ja": "消化管寄生虫・ジアルジア",
                "notes": "GI parasites, Giardia",
            },
            "hamster": {"dose": "20-50 mg/kg PO q24h × 5日", "notes_ja": "蟯虫", "notes": "Pinworm"},
            "hedgehog": {
                "dose": "20-50 mg/kg PO q24h × 5日",
                "notes_ja": "消化管寄生虫・肺虫",
                "notes": "GI parasites, lungworms",
            },
            "ferret": {"dose": "20-50 mg/kg PO q24h × 5日", "notes_ja": "消化管寄生虫", "notes": "GI parasites"},
            "bird": {
                "dose": "20-50 mg/kg PO q24h × 3-5日",
                "notes_ja": "回虫・毛細線虫",
                "notes": "Roundworms, Capillaria",
            },
            "reptile": {
                "dose": "50-100 mg/kg PO 1回; 14日後繰返し",
                "notes_ja": "線虫。原虫には効果なし",
                "notes": "Nematodes. Ineffective against protozoa",
            },
            "fish": {
                "dose": "2-5 mg/L 浴水 24-48h; PO 25-50 mg/kg",
                "notes_ja": "内部寄生虫（カマラヌス等）",
                "notes": "Internal parasites (Camallanus etc.)",
            },
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "10-15 mg/kg PO q12h; IBD: 10 mg/kg PO q12h",
                "notes_ja": "嫌気性菌感染・ジアルジア・IBD（免疫調節作用）。15 mg/kg超で神経毒性リスク",
                "notes": "Anaerobes, Giardia, IBD (immunomodulatory). Neurotoxicity risk >15 mg/kg",
            },
            "cat": {
                "dose": "10-15 mg/kg PO q12h",
                "notes_ja": "ジアルジア・IBD・嫌気性菌感染。苦味→投薬困難な場合あり",
                "notes": "Giardia, IBD, anaerobic infections. Bitter taste, compounding may help",
            },
            "horse": {
                "dose": "15-25 mg/kg PO q6-8h",
                "notes_ja": "嫌気性菌感染・クロストリジウム腸炎",
                "notes": "Anaerobic infections, clostridial enteritis",
            },
            "rabbit": {
                "dose": "20 mg/kg PO q12h",
                "notes_ja": "ジアルジア・嫌気性菌感染。腸内細菌叢への影響注意",
                "notes": "Giardia, anaerobic infections. Monitor GI flora",
            },
            "guinea_pig": {
                "dose": "20-40 mg/kg PO q12h",
                "notes_ja": "ジアルジア・嫌気性菌感染",
                "notes": "Giardia, anaerobic infections",
            },
            "chinchilla": {"dose": "10-20 mg/kg PO q12h", "notes_ja": "ジアルジア", "notes": "Giardia"},
            "ferret": {
                "dose": "15-20 mg/kg PO q12h",
                "notes_ja": "ヘリコバクター（3剤併用）・ジアルジア",
                "notes": "Helicobacter (triple therapy), Giardia",
            },
            "bird": {
                "dose": "20-50 mg/kg PO q12h",
                "notes_ja": "トリコモナス（カナリア口病）",
                "notes": "Trichomoniasis (canker)",
            },
            "reptile": {
                "dose": "20-40 mg/kg PO q48h",
                "notes_ja": "アメーバ症・嫌気性菌感染。48時間間隔",
                "notes": "Amebiasis, anaerobic infections. 48h interval",
            },
            "fish": {
                "dose": "5-10 mg/L 浴水 24h; PO 25-50 mg/kg",
                "notes_ja": "ヘキサミタ・スピロヌクレウス",
                "notes": "Hexamita, Spironucleus",
            },
            "hedgehog": {
                "dose": "20-25 mg/kg PO q12h",
                "notes_ja": "ジアルジア・嫌気性菌",
                "notes": "Giardia, anaerobes",
            },
        ...
        "drug_interactions": [
            {
                "drug": "phenobarbital",
                "severity": "moderate",
                "description_ja": "メトロニダゾール代謝促進→効果減弱",
                "description": "Increased metronidazole metabolism",
            },
            {
                "drug": "warfarin",
                "severity": "moderate",
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "5.5-11 mg/kg PO q12h; 深部感染: 11 mg/kg q12h",
                "notes_ja": "口腔感染・骨髄炎・膿皮症・トキソプラズマ。骨組織への移行性良好",
                "notes": "Dental infections, osteomyelitis, pyoderma, toxoplasmosis. Good bone penetration",
            },
            "cat": {
                "dose": "5.5-11 mg/kg PO q12h; トキソプラズマ: 12.5 mg/kg q12h",
                "notes_ja": "トキソプラズマ症・口腔感染・膿皮症。食道狭窄予防にwater chaser",
                "notes": "Toxoplasmosis, dental infections. Give with water to prevent esophageal stricture",
            },
            "rabbit": {
                "dose": "使用注意（致死性腸炎リスク）",
                "notes_ja": "ウサギではClostridium関連腸炎リスク→経口投与は原則避ける",
                "notes": "CAUTION: Risk of fatal Clostridium enteritis in rabbits. Avoid oral use",
            },
            "ferret": {
                "dose": "5.5-11 mg/kg PO q12h",
                "notes_ja": "骨感染・口腔感染",
                "notes": "Bone infections, dental infections",
            },
        ...
        "drug_interactions": [
            {
                "drug": "erythromycin",
                "severity": "major",
                "description_ja": "同一結合部位で拮抗",
                "description": "Antagonism at same binding site",
            },
            {
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "5-20 mg/kg PO/IM q24h",
                "notes_ja": "UTI・呼吸器・皮膚・骨感染。成長期の犬では関節軟骨障害リスク",
                "notes": "UTI, respiratory, skin, bone infections. Cartilage damage risk in growing dogs",
            },
            "cat": {
                "dose": "5 mg/kg PO q24h（5mg/kg超は禁忌→網膜毒性）",
                "notes_ja": "猫は5mg/kg/dayを超えない！急性網膜変性・失明リスク",
                "notes": "NEVER exceed 5 mg/kg/day in cats! Acute retinal degeneration/blindness risk",
            },
            "horse": {
                "dose": "5-7.5 mg/kg PO/IV q24h",
                "notes_ja": "呼吸器感染・胸膜肺炎。子馬は関節軟骨障害→成長期は避ける",
                "notes": "Respiratory infections, pleuropneumonia. Avoid in growing foals (cartilage)",
            },
            "rabbit": {
                "dose": "5-20 mg/kg PO/SC q12-24h",
                "notes_ja": "パスツレラ・UTI・呼吸器感染",
                "notes": "Pasteurella, UTI, respiratory infections",
            },
            "guinea_pig": {
                "dose": "5-10 mg/kg PO/SC q12h",
                "notes_ja": "UTI・呼吸器感染",
                "notes": "UTI, respiratory infections",
            },
            "ferret": {
            ...
            "bird": {
                ...
                "notes_ja": "グラム陰性菌感染・慢性感染。飲水投与可",
                "notes": "Gram-negative, chronic infections. Can add to drinking water",
            },
            "reptile": {
                "dose": "5-10 mg/kg PO/IM q24h",
                "notes_ja": "細菌感染。POTZ内で投与",
                "notes": "Bacterial infections. Dose within POTZ",
            },
            "hedgehog": {
                "dose": "5-10 mg/kg PO q12h",
                "notes_ja": "UTI・呼吸器感染",
        ...
        "drug_interactions": [
            {
                "drug": "sucralfate",
                "severity": "major",
                "description_ja": "エンロフロキサシン吸収を著明に低下（2時間空ける）",
                "description": "Markedly decreased absorption (separate by 2h)",
            },
            {
                "drug": "theophylline",
                "severity": "moderate",
                "description_ja": "テオフィリン血中濃度上昇",
                "description": "Increased theophylline levels",
            },
            {
                "drug": "nsaids",
                "severity": "moderate",
                "description_ja": "CNS刺激増強→痙攣リスク",
                "description": "Enhanced CNS stimulation, seizure risk",
            },
        ],
    },
    {
        ...
        "species_info": {
            "dog": {
                ...
                "notes_ja": "UTI・皮膚感染・口腔感染・呼吸器感染。βラクタマーゼ産生菌に有効",
                "notes": "UTI, skin, dental, respiratory infections. Effective against β-lactamase producers",
            },
            "cat": {
                "dose": "12.5-25 mg/kg PO q12h",
                "notes_ja": "上部呼吸器感染・UTI・口内炎",
                "notes": "URI, UTI, stomatitis",
            },
            "rabbit": {
                "dose": "12.5-20 mg/kg PO q12h",
                "notes_ja": "パスツレラ・UTI。経口βラクタムはウサギで比較的安全",
                "notes": "Pasteurella, UTI. Oral β-lactams relatively safe in rabbits",
            },
            "guinea_pig": {
                "dose": "12.5-25 mg/kg PO q12h",
                "notes_ja": "UTI・呼吸器感染。ペニシリン注射は禁忌だが経口は比較的安全",
                "notes": "UTI, respiratory. Injectable penicillin contraindicated but oral relatively safe",
            },
            "ferret": {
                "dose": "12.5-25 mg/kg PO q12h",
                "notes_ja": "ヘリコバクター（3剤併用）・呼吸器感染",
                "notes": "Helicobacter (triple therapy), respiratory infections",
            },
            "bird": {
                "dose": "125 mg/kg PO q12h",
                "notes_ja": "グラム陽性・陰性菌感染",
                "notes": "Gram-positive and negative infections",
            },
            "hedgehog": {
                "dose": "12.5-25 mg/kg PO q12h",
                "notes_ja": "呼吸器・皮膚感染",
                "notes": "Respiratory, skin infections",
            },
            "hamster": {
                "dose": "20 mg/kg PO q12h",
                "notes_ja": "細菌感染。注意：注射は腸炎リスク",
                "notes": "Bacterial infections. CAUTION: injectable may cause enteritis",
            },
        ...
        "drug_interactions": [
            {
                ...
                "description": "Delayed methotrexate excretion",
            }
        ],
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "5-10 mg/kg PO q12h",
                "notes_ja": "リケッチア（エーリキア・アナプラズマ）・ボレリア・ブルセラ・呼吸器感染・歯周病",
                "notes": "Rickettsial (Ehrlichia, Anaplasma), Borrelia, Brucella, respiratory, periodontal",
            },
            "cat": {
                "dose": "5-10 mg/kg PO q12h; ヘモプラズマ: 10 mg/kg q12h × 28日",
                "notes_ja": "ヘモプラズマ・クラミジア・バルトネラ・上部呼吸器感染。水で流して食道狭窄予防",
                "notes": "Hemoplasma, Chlamydia, Bartonella, URI. Follow with water to prevent esophageal stricture",
            },
            "horse": {
                "dose": "10 mg/kg PO q12h",
                "notes_ja": "子馬のR. equi（+アジスロマイシン）・ピロプラズマ・EPM補助",
                "notes": "Foal R. equi (+azithromycin), piroplasmosis, EPM adjunct",
            },
            "rabbit": {
            ...
            "bird": {
                ...
                "notes_ja": "クラミジア症（オウム病）第一選択。45日間",
                "notes": "Chlamydiosis (psittacosis) first-line. 45 days treatment",
            },
            "reptile": {
                "dose": "2.5-10 mg/kg PO q24-48h",
                "notes_ja": "マイコプラズマ・呼吸器感染",
                "notes": "Mycoplasma, respiratory infections",
            },
            "ferret": {
                "dose": "5-10 mg/kg PO q12h",
                "notes_ja": "ヘリコバクター併用・呼吸器感染",
                "notes": "Helicobacter combination, respiratory infections",
            },
        ...
        "drug_interactions": [
            {
                "drug": "antacids",
                "severity": "major",
                "description_ja": "吸収を著明に低下（2時間空ける）",
                "description": "Markedly decreased absorption (separate by 2h)",
            },
            {
                "drug": "phenobarbital",
                "severity": "moderate",
                "description_ja": "ドキシサイクリン代謝促進",
                "description": "Increased doxycycline metabolism",
            },
            {
                "drug": "sucralfate",
                "severity": "major",
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "5-10 mg/kg PO q24h × 3日、以後q48-72h",
                "notes_ja": "バベシア（+アトバコン）・呼吸器感染・パピローマ。長い組織半減期",
                "notes": "Babesia (+atovaquone), respiratory, papilloma. Long tissue half-life",
            },
            "cat": {
                "dose": "5-10 mg/kg PO q24h × 3日、以後q48-72h",
                "notes_ja": "バルトネラ・上部呼吸器感染複合・トキソプラズマ代替",
                "notes": "Bartonella, URI complex, toxoplasmosis alternative",
            },
            "horse": {
                "dose": "10 mg/kg PO q24h × 5日、以後q48h",
                "notes_ja": "子馬のR. equi肺炎（+リファンピシン）",
                "notes": "Foal R. equi pneumonia (+rifampin)",
            },
            "rabbit": {
            ...
            "bird": {
                ...
                "notes_ja": "クラミジア症の代替（ドキシサイクリンが第一選択）",
                "notes": "Chlamydiosis alternative (doxycycline is first-line)",
            },
            "reptile": {
                "dose": "10 mg/kg PO q48-72h",
                "notes_ja": "呼吸器感染・マイコバクテリア",
                "notes": "Respiratory infections, mycobacteria",
            },
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "0.01-0.05 mg/kg IV/IM; 最大用量3mg（体重不問）",
                "notes_ja": "前投薬・鎮静。低用量で十分。用量反応プラトーあり。短頭種は減量",
                "notes": "Premedication, sedation. Low doses sufficient. Dose-response plateau. Reduce in brachycephalics",
            },
            "cat": {
                "dose": "0.01-0.05 mg/kg IV/IM",
                "notes_ja": "猫の鎮静。低用量で十分",
                "notes": "Feline sedation. Low doses sufficient",
            },
            "horse": {
                "dose": "0.02-0.05 mg/kg IV/IM",
                "notes_ja": "鎮静。陰茎脱出リスク（種牡馬で注意）",
                "notes": "Sedation. Penile prolapse risk (caution in stallions)",
            },
            "ferret": {
                "dose": "0.1-0.25 mg/kg IM",
                "notes_ja": "フェレットの鎮静前投薬",
                "notes": "Ferret sedation premedication",
            },
        },
        ...
        "drug_interactions": [
            {
                "drug": "epinephrine",
                "severity": "moderate",
                "description_ja": "α遮断作用により逆説的低血圧（epinephrine reversal）",
                "description": "Paradoxical hypotension due to alpha blockade (epinephrine reversal)",
            },
            {
                "drug": "opioids",
                "severity": "moderate",
                "description_ja": "鎮静・呼吸抑制の相加",
    ...
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "てんかん重積: 0.5-1 mg/kg IV; 鎮静前投薬: 0.2-0.5 mg/kg IV",
                "notes_ja": "てんかん重積の第一選択。麻酔導入時のco-induction。筋弛緩",
                "notes": "First-line status epilepticus. Co-induction agent. Muscle relaxation",
            },
            "cat": {
                "dose": "てんかん重積: 0.5-1 mg/kg IV; 食欲刺激: 0.05-0.15 mg/kg IV",
                "notes_ja": "てんかん重積・食欲刺激（IV）。経口投与は肝壊死リスク→経口ならオキサゼパム",
                "notes": "Status epilepticus, appetite stimulation (IV). Oral use risks hepatic necrosis → use oxazepam PO",
            },
            "horse": {
                "dose": "0.02-0.1 mg/kg IV",
                "notes_ja": "新生子馬の痙攣。成馬は倒れるリスク→通常α2と併用",
                "notes": "Neonatal seizures. Adults may recumbent → usually with α2 agonist",
            },
            "rabbit": {
                "dose": "1-3 mg/kg IV/IM/IN",
                "notes_ja": "痙攣管理・鎮静補助",
                "notes": "Seizure management, sedation adjunct",
            },
            "bird": {"dose": "0.5-1 mg/kg IM/IV", "notes_ja": "痙攣管理", "notes": "Seizure management"},
            "reptile": {
                "dose": "0.5-1 mg/kg IM",
                "notes_ja": "痙攣管理・筋弛緩",
                "notes": "Seizure management, muscle relaxation",
            },
        },
        ...
        "drug_interactions": [
            {
                "drug": "opioids",
                "severity": "moderate",
                "description_ja": "呼吸抑制の相加",
                "description": "Additive respiratory depression",
            },
            {
                "drug": "cimetidine",
                "severity": "moderate",
                "description_ja": "ジアゼパム代謝遅延",
                "description": "Delayed diazepam metabolism",
            },
        ],
    },
    {
        ...
        "species_info": {
            "dog": {
                "dose": "初回0.2 mg/kg PO/SC, 以後0.1 mg/kg PO q24h",
                "notes_ja": "OA・術後疼痛・炎症。消化管保護のため食事と一緒に投与",
                "notes": "OA, post-op pain, inflammation. Give with food for GI protection",
            },
            "cat": {
                "dose": "初回0.1 mg/kg SC, 以後0.05 mg/kg PO q24h",
                "notes_ja": "猫のOA疼痛に長期低用量が認可（一部の国）。腎機能モニタリング必須",
                "notes": "Long-term low-dose approved for feline OA in some countries. Monitor renal function",
            },
            "horse": {
                "dose": "0.6 mg/kg IV/PO q24h",
                "notes_ja": "筋骨格疼痛・軟部組織炎症",
                "notes": "Musculoskeletal pain, soft tissue inflammation",
            },
            "rabbit": {
                "dose": "0.3-0.6 mg/kg PO/SC q24h",
                "notes_ja": "術後疼痛・慢性疼痛",
                "notes": "Post-op pain, chronic pain",
            },
            ...
            "bird": {
                ...
                "notes_ja": "鳥類の疼痛管理",
                "notes": "Avian pain management",
            },
            "reptile": {
                "dose": "0.1-0.3 mg/kg PO/IM q24-48h",
                "notes_ja": "爬虫類の疼痛管理",
                "notes": "Reptilian pain management",
            },
        ...
        "drug_interactions": [
            ...
            },
            {
                "drug": "ace_inhibitors",
                "severity": "moderate",
                "description_ja": "降圧効果減弱・腎機能悪化",
                "description": "Attenuated antihypertensive effect, worsened renal function",
            },
            {
                "drug": "furosemide",
                "severity": "moderate",
                "description_ja": "利尿効果減弱",
                "description": "Attenuated diuretic effect",
            },
        ],
    },
]
