...
const I18N={
  ja:{
    ...
    heroTrustRef:"90+学術文献に基づく",heroTrustTests:"2,700+自動テスト検証済み",heroTrustOss:"オープンソース開発",
    ...
    heroLead:"臨床症状から鑑別疾患リストを即座に生成。<br/>7,000+疾患・220+薬品・124麻酔プロトコル・21動物種対応の臨床意思決定支援プラットフォーム。",
  ...
  en:{
    ...
    heroTrustRef:"Based on 90+ academic references",heroTrustTests:"Verified by 2,700+ automated tests",heroTrustOss:"Open-source development",
    ...
    heroLead:"Instantly generate differential diagnosis lists from clinical signs.<br/>7,000+ diseases \u00b7 220+ drugs \u00b7 124 anesthesia protocols \u00b7 21 species \u2014 a clinical decision support platform for veterinary professionals.",
