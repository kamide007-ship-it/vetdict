...
- 熱傷（Thermal Burns）[snake_0023] / 化学熱傷（Burns (Chemical)）[snake_0131] / 熱傷（ヘビ）（Burns）[snake_0236]
- 皮膚糸状菌症（Dermatophytosis (Fungal Skin Infection)）[snake_0024] / 皮膚糸状菌症（ヘビ）（Dermatophytosis）[snake_0160]
...
- 敗血症（Septicemia (Blood Poisoning)）[snake_0037] / 敗血症（ヘビ）（Septicemia）[snake_0234]
- 排卵後卵停滞（スラグ残留）（Post-ovulatory Egg Stasis (Slug Retention)）[snake_0044] / 排卵後卵停滞（ヘビ）（Post-Ovulatory Egg Stasis）[snake_0185]
- 高体温症（Hyperthermia (Heat Stroke)）[snake_0062] / 高体温症（ヘビ）（Hyperthermia）[snake_0231]
...
- 鉛中毒（Lead Toxicosis）[snake_0108] / 鉛中毒（ヘビ）（Lead Poisoning）[snake_0232]
...
### 疾患ファミリー候補（上位15）
- stem=`defici` × 9件
    - ビタミン欠乏症（一般）（Vitamin Deficiency (General)）[snake_0035]
    - ビタミンA欠乏症（Vitamin A Deficiency）[snake_0114]
    - ビタミンD3欠乏症（Vitamin D3 Deficiency）[snake_0115]
    - チアミン欠乏症（Thiamine Deficiency）[snake_0116]
    - ビオチン欠乏症（Biotin Deficiency）[snake_0117]
    - タンパク質欠乏・栄養不良（Protein Deficiency / Malnutrition）[snake_0120]
...
- stem=`hepati` × 9件
    ...
    - 肝ウイルス感染症（ヘビ）（Hepatic Viral Infection）[snake_0243]
    - 肝寄生虫疾患（ヘビ）（Hepatic Parasitic Disease）[snake_0244]
    - 肝線維症（ヘビ）（Hepatic Fibrosis）[snake_0245]
    - 肝代謝障害（ヘビ）（Hepatic Metabolic Disorder）[snake_0246]
- stem=`absces` × 6件
    - 口腔膿瘍（Oral Abscess）[snake_0011]
    - 皮下膿瘍（Subcutaneous Abscess）[snake_0038]
    - スペクタクル下膿瘍（Subspectacular Abscess）[snake_0039]
...
- stem=`dermat` × 5件
    - 皮膚糸状菌症（Dermatophytosis (Fungal Skin Infection)）[snake_0024]
    - 細菌性皮膚炎（Bacterial Dermatitis）[snake_0025]
    - 光線過敏性皮膚炎（Photosensitization Dermatitis）[snake_0136]
    - 皮膚糸状菌症（ヘビ）（Dermatophytosis）[snake_0160]
...
- stem=`respir` × 5件
    ...
    - ニドウイルス呼吸器疾患（ヘビ）（Nidovirus Respiratory Disease）[snake_0144]
    - 呼吸器感染症（ヘビ）（Respiratory Infection）[snake_0154]
    - 上部気道疾患（ヘビ）（Upper Respiratory Tract Disease）[snake_0202]
- stem=`toxico` × 5件
    - 中毒症（Toxicosis (Poisoning)）[snake_0061]
    - 亜鉛中毒（Zinc Toxicosis）[snake_0107]
    - 鉛中毒（Lead Toxicosis）[snake_0108]
    - イベルメクチン中毒（Ivermectin Toxicosis）[snake_0109]
    - メトロニダゾール中毒（Metronidazole Toxicosis）[snake_0110]
- stem=`bacter` × 4件
    - 細菌性皮膚炎（Bacterial Dermatitis）[snake_0025]
    - 慢性細菌性肺炎（Bacterial Pneumonia (Chronic)）[snake_0139]
    - 肝細菌感染症（ヘビ）（Hepatic Bacterial Infection）[snake_0242]
    - 消化管細菌感染（ヘビ）（Gastrointestinal Bacterial Infection）[snake_0247]
- stem=`fractu` × 4件
...
- 内部線虫（回虫）感染（Internal Nematodes (Roundworms)）[snake_0015] — ja:168字 / en:489字
- マダニ寄生（Tick Infestation）[snake_0017] — ja:80字 / en:470字
...
- 熱傷（Thermal Burns）[snake_0023] — ja:77字 / en:193字
...
- 高体温症（Hyperthermia (Heat Stroke)）[snake_0062] — ja:81字 / en:232字
- 骨髄炎（Osteomyelitis）[snake_0065] — ja:52字 / en:190字
- クラミジア症（Chlamydiosis）[snake_0074] — ja:161字 / en:190字
- エロモナス感染症（Aeromonas Infection）[snake_0076] — ja:162字 / en:196字
- シトロバクター感染症（Citrobacter Infection）[snake_0077] — ja:165字 / en:196字
- マイコプラズマ症（Mycoplasmosis）[snake_0078] — ja:163字 / en:149字
- 丹毒（Erysipelas）[snake_0080] — ja:157字 / en:196字
- 鉤虫感染症（カリケファルス）（Hookworm Infection (Kalicephalus)）[snake_0084] — ja:172字 / en:204字
...
- 種別投与量なしの薬品リンク（旧・未ガード）: **84** 疾患 → ガード後残存: **0**
- 犬猫論文の他種への自動紐付け（旧・未ガード）: **9** 疾患 → ガード後残存: **0**

### 種に投与量データが無い薬品リンク（上位20）
- サンシャインウイルス感染症（Sunshine Virus (Reptile Sunshinevirus)）[snake_0005] → アモキシシリン・クラブラン酸
- ヘビヘルペスウイルス感染症（Ophidian Herpesvirus Infection）[snake_0006] → アモキシシリン・クラブラン酸
- 上部呼吸器感染症（Upper Respiratory Infection (URI)）[snake_0007] → アモキシシリン・クラブラン酸
...
- 敗血症（Septicemia (Blood Poisoning)）[snake_0037] → アモキシシリン・クラブラン酸, 活性炭
- 結膜炎・眼周囲腫脹（Conjunctivitis / Periocular Swelling）[snake_0041] → アモキシシリン・クラブラン酸
...
- 外傷・咬傷（Trauma / Bite Wounds）[snake_0058] → メサドン

### 犬猫論文が他種に自動紐付け（上位20）
- 皮膚糸状菌症（Dermatophytosis (Fungal Skin Infection)）[snake_0024] → key: dermatophytosis
- リンパ腫（Lymphoma）[snake_0053] → key: lymphoma
- パスツレラ症（Pasteurellosis）[snake_0079] → key: pasteurellosis
- 溶血性貧血（Hemolytic Anemia）[snake_0128] → key: immune-mediated hemolytic anemia
- 皮膚糸状菌症（ヘビ）（Dermatophytosis）[snake_0160] → key: dermatophytosis
- 尿路結石症（ヘビ）（Urolithiasis）[snake_0182] → key: urolithiasis
- 膵炎（ヘビ）（Pancreatitis）[snake_0200] → key: feline pancreatitis
- 心筋症（ヘビ）（Cardiomyopathy）[snake_0223] → key: hypertrophic cardiomyopathy (hcm)
- 貧血（ヘビ）（Anemia）[snake_0226] → key: immune-mediated hemolytic anemia
