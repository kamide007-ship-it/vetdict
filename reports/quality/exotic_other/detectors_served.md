...
- 肥満症（エキゾチック哺乳類）（Obesity (Exotic Mammal)）[exotic_other_0044] / 肥満症（プレーリードッグ）（Obesity (Prairie Dog)）[exotic_other_0062] / 肥満（エキゾチック）（その他）（Obesity (Exotic)）[exotic_other_0171] / 肥満（その他）（Obesity）[exotic_other_0229]
