...
- 腸管寄生虫症（豚）（Intestinal Parasitism (Porcine)）[exotic_other_0013] / 腸管寄生虫症（エキゾチック哺乳類）（Intestinal Parasitism (Exotic Mammal)）[exotic_other_0024] / 腸管寄生虫症（スカンク）（Intestinal Parasitism (Skunk)）[exotic_other_0066]
- 代謝性骨疾患（エキゾチック哺乳類）（Metabolic Bone Disease (Exotic Mammal)）[exotic_other_0015] / 代謝性骨疾患（スカンク）（Metabolic Bone Disease (Skunk)）[exotic_other_0065]
...
- 肥満症（エキゾチック哺乳類）（Obesity (Exotic Mammal)）[exotic_other_0044] / 肥満症（プレーリードッグ）（Obesity (Prairie Dog)）[exotic_other_0062]
- ペスト（プレーリードッグ）（Plague (Prairie Dog)）[exotic_other_0047] / ペスト（その他）（Plague (Yersinia pestis)）[exotic_other_0155]
- トキソプラズマ症（有袋類）（Toxoplasmosis (Wallaby/Marsupial)）[exotic_other_0052] / トキソプラズマ症（その他）（Toxoplasmosis）[exotic_other_0150]
- 尿路結石症（エキゾチック哺乳類）（Urolithiasis (Exotic Mammal)）[exotic_other_0053] / ヤギ尿路結石症（Urolithiasis (Goat)）[exotic_other_0109]
- 心疾患（エキゾチック哺乳類）（Heart Disease (Exotic Mammal)）[exotic_other_0057] / 心疾患（プレーリードッグ）（Heart Disease (Prairie Dog)）[exotic_other_0063]
- 脱水（タランチュラ）（Dehydration (Tarantula)）[exotic_other_0067] / 脱水（その他）（Dehydration）[exotic_other_0240]
- ヤギコクシジウム症（Coccidiosis (Goat)）[exotic_other_0112] / コクシジウム症（その他）（Coccidiosis）[exotic_other_0207]
...
- stem=`heart` × 5件
    - 心疾患（エキゾチック哺乳類）（Heart Disease (Exotic Mammal)）[exotic_other_0057]
    - 心疾患（プレーリードッグ）（Heart Disease (Prairie Dog)）[exotic_other_0063]
    - フェレット心疾患（心筋症）（Ferret Heart Disease (Cardiomyopathy)）[exotic_other_0138]
    - 桑実心臓病（ビタミンE/セレン欠乏症）（Mulberry Heart Disease (Vitamin E/Selenium Deficiency)）[exotic_other_0141]
    - うっ血性心不全（その他）（Congestive Heart Failure）[exotic_other_0226]
...
- 直腸脱（エキゾチック哺乳類）（Rectal Prolapse (Exotic Mammal)）[exotic_other_0025] — ja:563字 / en:533字
- 不正咬合（エキゾチック哺乳類）（Dental Malocclusion (Exotic Mammal)）[exotic_other_0026] — ja:195字 / en:158字
- 乳腺腫瘍（エキゾチック哺乳類）（Mammary Tumors (Exotic Mammal)）[exotic_other_0030] — ja:665字 / en:481字
- 犬ジステンパー（アライグマ・スカンク）（Canine Distemper (Raccoon/Skunk)）[exotic_other_0032] — ja:718字 / en:595字
- 狂犬病（エキゾチック哺乳類）（Rabies (Exotic Mammal)）[exotic_other_0033] — ja:311字 / en:238字
...
- 肥満症（エキゾチック哺乳類）（Obesity (Exotic Mammal)）[exotic_other_0044] — ja:725字 / en:1003字
- リンパ腫（エキゾチック哺乳類）（Lymphoma (Exotic Mammal)）[exotic_other_0045] — ja:665字 / en:481字
...
- 副腎疾患（エキゾチック哺乳類）（Adrenal Disease (Exotic Mammal)）[exotic_other_0056] — ja:344字 / en:650字
...
- 代謝性骨疾患（スカンク）（Metabolic Bone Disease (Skunk)）[exotic_other_0065] — ja:592字 / en:502字
- 腸管寄生虫症（スカンク）（Intestinal Parasitism (Skunk)）[exotic_other_0066] — ja:307字 / en:193字

## T108 出典 / 薬品リンク整合性（キーワード自動マッチの誤紐付け）
- 参照コーパス: 薬品 **610** 件 / 出典キー **30** 件（薬品ロードOK・出典ロードOK）
- 種別投与量なしの薬品リンク（旧・未ガード）: **198** 疾患 → ガード後残存: **0**
...
- 消化管うっ滞（Gastrointestinal Stasis）[exotic_other_0021] → メロキシカム, メトクロプラミド, シサプリド
...
- 貧血（その他）（Anemia）[exotic_other_0239] → key: immune-mediated hemolytic anemia
