...
class TestChatClinicalAccuracyAuditRound19:
...
class TestBatch52ReferencedDrugs:
    """Sweep #21 (parallel-session batch 52): octreotide / decoquinate were referenced with doses
