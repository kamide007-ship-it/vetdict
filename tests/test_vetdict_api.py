...
class TestAnalyzeSymptomsValidation:
    ...
    def test_non_string_symptom_ids_return_400(self, client):
        resp = client.post('/api/analyze-symptoms',
    ...
    def test_vaccines_list_of_strings_forwarded(self, monkeypatch, client):
        captured = {}
    ...
    def test_non_string_vaccine_ids_return_400(self, client):
        resp = client.post('/api/analyze-symptoms',
