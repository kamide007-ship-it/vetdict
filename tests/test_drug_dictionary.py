...
class TestBatch49AndSweep16Parallel:
    """2026-08 audit (16th sweep, parallel session): referenced-but-absent drugs
    (shipped as batch 49 — sibling sessions claimed the 47/48 slots first) +
    duplicate-card consolidation + katakana variant aliases."""

    def test_batch49_drugs_present_with_bilingual_dosing(self):
