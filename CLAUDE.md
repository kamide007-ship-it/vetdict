...
api/
  ...
  anesthesia_protocols.py — 鎮静・麻酔プロトコルデータ (21種, 119プロトコル)
...
- **鎮静・麻酔プロトコル**: 119 (全21種対応、犬猫各11プロトコル、馬11プロトコル、ASA分類付き)
...
- `api/anesthesia_protocols.py`: 全21種の鎮静・麻酔プロトコルデータ（119プロトコル）
