...
api/
  ...
  anesthesia_protocols.py — 鎮静・麻酔プロトコルデータ (21種, 171プロトコル)
...
- **鎮静・麻酔プロトコル**: 171 (全21種対応、犬猫馬各11プロトコル、15種が全8カテゴリ完備、ASA分類付き)
...
- `api/anesthesia_protocols.py`: 全21種の鎮静・麻酔プロトコルデータ（171プロトコル）
