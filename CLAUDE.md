...
api/
  ...
  anesthesia_protocols.py — 鎮静・麻酔プロトコルデータ (21種, 99プロトコル)
...
- **鎮静・麻酔プロトコル**: 99 (全21種対応、犬猫各11プロトコル、馬8プロトコル、ASA分類付き)
...
- `api/anesthesia_protocols.py`: 全21種の鎮静・麻酔プロトコルデータ（99プロトコル）
